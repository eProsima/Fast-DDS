...
<div class="badges" align="center">
    ...
    <a href="https://github.com/eProsima/Fast-DDS/actions/workflows/nightly-ubuntu-3.4.x.yml"><img alt="Fast DDS Ubuntu CI (nightly 3.4.x)" src="https://github.com/eProsima/Fast-DDS/actions/workflows/nightly-ubuntu-3.4.x.yml/badge.svg"/></a>
    <a href="https://github.com/eProsima/Fast-DDS/actions/workflows/nightly-windows-3.4.x.yml"><img alt="Fast DDS Windows CI (nightly 3.4.x)" src="https://github.com/eProsima/Fast-DDS/actions/workflows/nightly-windows-3.4.x.yml/badge.svg"/></a>
    <a href="https://github.com/eProsima/Fast-DDS/actions/workflows/nightly-mac-3.4.x.yml"><img alt="Fast DDS MacOS CI (nightly 3.4.x)" src="https://github.com/eProsima/Fast-DDS/actions/workflows/nightly-mac-3.4.x.yml/badge.svg"/></a>
