...
$(FASTRTPS_TARGET_DEBUG): $(FASTRTPS_OBJS_DEBUG)
	$(LN) $(LDFLAGS) -shared -o $(FASTRTPS_TARGET_DEBUG) $(FASTRTPS_OBJS_DEBUG) $(LIBRARY_PATH) $(FASTRTPS_LIBS_DEBUG)
...
$(FASTRTPS_TARGET): $(FASTRTPS_OBJS_RELEASE)
	$(LN) $(LDFLAGS) -shared -o $(FASTRTPS_TARGET)  $(FASTRTPS_OBJS_RELEASE)  $(LIBRARY_PATH) $(FASTRTPS_LIBS)
