...
FASTRTPS_LIBS_DEBUG= $(LIBS_DEBUG) -lboost_system -lboost_thread -lboost_date_time
FASTRTPS_LIBS= $(LIBS) -lboost_system -lboost_thread -lboost_date_time

FASTRTPS_CFLAGS += $(CFLAGS) -std=c++0x -Wno-unknown-pragmas -Wno-unused-variable
...
FASTRTPS_SRC_CPPFILES= \
		  ...
		  $(BASEDIR)/src/cpp/rtps/history/ReaderHistory.cpp \
		  \
...
$(FASTRTPS_TARGET_DEBUG): $(FASTRTPS_OBJS_DEBUG)
	$(LN) $(LDFLAGS) -shared -o $(FASTRTPS_TARGET_DEBUG) $(LIBRARY_PATH) $(FASTRTPS_OBJS_DEBUG) $(FASTRTPS_LIBS_DEBUG)
...
$(FASTRTPS_TARGET): $(FASTRTPS_OBJS_RELEASE)
	$(LN) $(LDFLAGS) -shared -o $(FASTRTPS_TARGET) $(LIBRARY_PATH) $(FASTRTPS_LIBS) $(FASTRTPS_OBJS_RELEASE)
