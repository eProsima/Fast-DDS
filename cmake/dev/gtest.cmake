...
macro(add_gtest test)
    ...
    if(GTEST_INDIVIDUAL)
        foreach(GTEST_SOURCE_FILE ${GTEST_SOURCE_FILES})
            ...
            foreach(GTEST_NAME ${GTEST_NAMES})
                ...
                foreach(property ${GTEST_ENVIRONMENTS})
                    set_tests_properties(${GTEST_GROUP_NAME}.${GTEST_NAME} PROPERTIES ENVIRONMENT "${property}")
                endforeach()
            endforeach()
        endforeach()
    else()
        ...
        foreach(property ${GTEST_ENVIRONMENTS})
            set_tests_properties(${test} PROPERTIES ENVIRONMENT "${property}")
        endforeach()
    endif()
endmacro()
    ...
    if(GTEST_INDIVIDUAL)
        foreach(GTEST_SOURCE_FILE ${GTEST_SOURCE_FILES})
            ...
            foreach(GTEST_NAME ${GTEST_NAMES})
                ...
                foreach(property ${GTEST_ENVIRONMENTS})
                    set_tests_properties(${GTEST_GROUP_NAME}_${memorymode}.${GTEST_NAME} PROPERTIES ENVIRONMENT "${property}")
                endforeach()
            endforeach()
        endforeach()
    else()
