...
# Run 'AllocationTestExample' under callgrind using the correct parameters:
...
valgrind --tool=callgrind --dump-before=callgrind_dump* --zero-before=callgrind_zero_count* --callgrind-out-file=callgrind.out.$str ./AllocationTestExample $*
