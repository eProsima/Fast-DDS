...
#error Generated Benchmark is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 * @ingroup BENCHMARK
 */
class BenchMarkPubSubType : public eprosima::fastrtps::TopicDataType {
public:
