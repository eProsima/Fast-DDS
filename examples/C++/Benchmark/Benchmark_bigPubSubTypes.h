...
#error Generated Benchmark_big is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
public:
    ...
    eProsima_user_DllExport virtual ~BenchMarkBigPubSubType();
...
#endif // _BENCHMARK_BIG_PUBSUBTYPES_H_