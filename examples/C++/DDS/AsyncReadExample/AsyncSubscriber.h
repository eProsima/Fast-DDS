 ...
 */
class AsyncSubscriber : public eprosima::fastdds::dds::DataReaderListener
{
public:
...
private:
    ...
    void asynchronous_read_routine_();

    //! Protects data available condition variable
    std::mutex data_available_mutex_;

    //! Waits to data available
    std::condition_variable data_available_cv_;

    //! Thread that reads data from reader
