...
<<<<<<< HEAD:examples/C++/DDS/BasicConfigurationExample/BasicConfigurationSubscriber.cpp
=======
        ...
        default:
            break;
>>>>>>> 2653efb95 (TCP support for Discovery server CLI and env var (#4097)):examples/cpp/dds/DiscoveryServerExample/DiscoveryServerSubscriber.cpp
    }
