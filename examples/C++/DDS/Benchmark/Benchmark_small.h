...
#ifndef _Benchmark_small_H_
#define _Benchmark_small_H_
...
public:
     ...
     */
    eProsima_user_DllExport BenchMarkSmall(const BenchMarkSmall &x);
    
    /*!
     * @brief Move constructor.
     * @param x Reference to the object BenchMarkSmall that will be copied.
     */
    eProsima_user_DllExport BenchMarkSmall(BenchMarkSmall &&x);
    
    /*!
     * @brief Copy assignment.
     * @param x Reference to the object BenchMarkSmall that will be copied.
     */
    eProsima_user_DllExport BenchMarkSmall& operator=(const BenchMarkSmall &x);
    
    /*!
     * @brief Move assignment.
     * @param x Reference to the object BenchMarkSmall that will be copied.
     */
    eProsima_user_DllExport BenchMarkSmall& operator=(BenchMarkSmall &&x);
    
    /*!
     * @brief This function copies the value in member array
     * @param _array New value to be copied in member array
     */
    inline eProsima_user_DllExport void array(const std::array<char, 16384> &_array)
    {
        m_array = _array;
    }
     ...
     */
    inline eProsima_user_DllExport void array(std::array<char, 16384> &&_array)
    {
     ...
     */
    inline eProsima_user_DllExport const std::array<char, 16384>& array() const
    {
        return m_array;
    }
     ...
     */
    inline eProsima_user_DllExport std::array<char, 16384>& array()
    {
        return m_array;
    }
    /*!
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const BenchMarkSmall& data, size_t current_alignment = 0);
...
private:
    std::array<char, 16384> m_array;
    uint32_t m_index;
};

#endif // _Benchmark_small_H_