...
#endif // if !defined(GEN_API_VER) || (GEN_API_VER != 1)
...
public:
    ...
    eProsima_user_DllExport virtual void deleteData(
            void* data) override;
    eProsima_user_DllExport virtual bool is_bounded() const override;
    eProsima_user_DllExport virtual bool is_plain() const override;
    MD5 m_md5;
