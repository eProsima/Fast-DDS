...
#ifndef _LOANABLEHELLOWORLD_H_
#define _LOANABLEHELLOWORLD_H_
...
public:
     ...
     */
    eProsima_user_DllExport LoanableHelloWorld(const LoanableHelloWorld &x);

    /*!
     * @brief Move constructor.
     * @param x Reference to the object LoanableHelloWorld that will be copied.
     */
    eProsima_user_DllExport LoanableHelloWorld(LoanableHelloWorld &&x);

    /*!
     * @brief Copy assignment.
     * @param x Reference to the object LoanableHelloWorld that will be copied.
     */
    eProsima_user_DllExport LoanableHelloWorld& operator=(const LoanableHelloWorld &x);

    /*!
     * @brief Move assignment.
     * @param x Reference to the object LoanableHelloWorld that will be copied.
     */
    eProsima_user_DllExport LoanableHelloWorld& operator=(LoanableHelloWorld &&x);
     ...
     */
    eProsima_user_DllExport void message(const std::array<char, 256> &_message);

    /*!
     * @brief This function moves the value in member message
     * @param _message New value to be moved in member message
     */
    eProsima_user_DllExport void message(std::array<char, 256> &&_message);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const LoanableHelloWorld& data, size_t current_alignment = 0);
