...
public:
     ...
     */
    eProsima_user_DllExport void wasFast(char _wasFast);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const FlowControlExample& data, size_t current_alignment = 0);
