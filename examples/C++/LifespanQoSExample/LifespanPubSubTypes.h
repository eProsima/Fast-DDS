...
#error Generated Lifespan is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 * @ingroup LIFESPAN
 */
class LifespanPubSubType : public eprosima::fastrtps::TopicDataType {
public:
