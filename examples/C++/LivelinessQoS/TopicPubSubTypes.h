...
#ifndef _TOPIC_PUBSUBTYPES_H_
#define _TOPIC_PUBSUBTYPES_H_
...
#error Generated Topic is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 * @ingroup TOPIC
 */
class TopicPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef Topic type;

    eProsima_user_DllExport TopicPubSubType();

    eProsima_user_DllExport virtual ~TopicPubSubType();
