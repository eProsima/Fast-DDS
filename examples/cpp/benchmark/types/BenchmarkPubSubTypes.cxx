...
BenchMarkPubSubType::BenchMarkPubSubType()
{
    ...
    uint32_t key_length = BenchMark_max_key_cdr_typesize > 16 ? BenchMark_max_key_cdr_typesize : 16;
...
bool BenchMarkPubSubType::serialize(
...
bool BenchMarkPubSubType::deserialize(
        SerializedPayload_t& payload,
        void* data)
{
    try
...
uint32_t BenchMarkPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
        ...
        bool force_md5)
{
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(key_buffer_),
            BenchMark_max_key_cdr_typesize);
    ...
    if (force_md5 || BenchMark_max_key_cdr_typesize > 16)
    {
        md5_.init();
...
void BenchMarkPubSubType::register_type_object_representation()
{
    register_BenchMark_type_identifier(type_identifiers_);
}
