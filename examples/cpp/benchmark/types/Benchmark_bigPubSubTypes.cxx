...
BenchMarkBigPubSubType::BenchMarkBigPubSubType()
{
    ...
    uint32_t key_length = BenchMarkBig_max_key_cdr_typesize > 16 ? BenchMarkBig_max_key_cdr_typesize : 16;
...
uint32_t BenchMarkBigPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void BenchMarkBigPubSubType::register_type_object_representation()
{
    register_BenchMarkBig_type_identifier(type_identifiers_);
}
