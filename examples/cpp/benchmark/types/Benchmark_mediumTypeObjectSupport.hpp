...
/*!
 * @file Benchmark_mediumTypeObjectSupport.hpp
...
/**
 * @brief Register BenchMarkMedium related TypeIdentifier.
 ...
 */
eProsima_user_DllExport void register_BenchMarkMedium_type_identifier(
