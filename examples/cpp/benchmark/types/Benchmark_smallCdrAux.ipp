...
eProsima_user_DllExport bool is_BenchMarkSmall_cdr_plain(
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const BenchMarkSmall* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_BenchMarkSmall_cdr_plain(data_representation) &&
                sizeof(BenchMarkSmall) == BenchMarkSmall_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(BenchMarkSmall));

            scdr.jump((array_size -1) * sizeof(BenchMarkSmall));
        }
        else
        {
