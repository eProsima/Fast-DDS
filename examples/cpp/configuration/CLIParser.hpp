...
public:
    ...
    struct publisher_config : public entity_config
    {
        ...
        uint32_t ack_keep_duration = 100;
        uint32_t strength = 0;
            ...
            uint8_t return_code)
    {
        ...
        std::cout << "  -k, --keep-all                      Set History QoS as keep all"                << std::endl;
        std::cout << "      --keep-last <num>               Set History QoS as keep last <num>"         << std::endl;
        ...
        std::cout << "                                      [1 <= <num> <= 4294967]"                    << std::endl;
        std::cout << "                                      (Default: 100)"                             << std::endl;
        std::cout << "      --liveliness <num>              Set liveliness lease duration in "          << std::endl;
        ...
        std::cout << "                                      Single or double quotes required for"       << std::endl;
        std::cout << "                                      multiple partitions. No partitions used if" << std::endl;
            ...
            else if (arg == "--disable-positive-ack")
            {
                ...
                else
                {
                    EPROSIMA_LOG_ERROR(CLI_PARSER,
                            "disable-positive-ack argument is only valid for publisher entity");
                    print_help(EXIT_FAILURE);
                }
            }
