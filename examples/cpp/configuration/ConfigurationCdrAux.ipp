...
eProsima_user_DllExport bool is_Configuration_cdr_plain(
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_Configuration_cdr_plain(data_representation) &&
                sizeof(Configuration) == Configuration_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(Configuration));

            scdr.jump((array_size -1) * sizeof(Configuration));
        }
        else
        {
