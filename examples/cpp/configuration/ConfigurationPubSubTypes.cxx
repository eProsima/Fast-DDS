...
ConfigurationPubSubType::ConfigurationPubSubType()
{
    ...
    uint32_t type_size =
        ...
        static_cast<uint32_t>(Configuration::getMaxCdrSerializedSize());
#else
        Configuration_max_cdr_typesize;
#endif
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    m_typeSize = type_size + 4; /*encapsulation*/
    m_isGetKeyDefined = false;
    uint32_t keyLength = Configuration_max_key_cdr_typesize > 16 ? Configuration_max_key_cdr_typesize : 16;
    ...
    return [data, data_representation]() -> uint32_t
           {
               ...
               return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<Configuration*>(data))) +
                      4u /*encapsulation*/;
#else
               try
               {
...
void ConfigurationPubSubType::deleteData(
        void* data)
{
