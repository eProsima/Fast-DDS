...
BenchMarkMediumPubSubType::BenchMarkMediumPubSubType()
{
    ...
    uint32_t type_size = BenchMarkMedium_max_cdr_typesize;
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    m_typeSize = type_size + 4; /*encapsulation*/
    m_isGetKeyDefined = false;
    uint32_t keyLength = BenchMarkMedium_max_key_cdr_typesize > 16 ? BenchMarkMedium_max_key_cdr_typesize : 16;
    ...
    return [data, data_representation]() -> uint32_t
           {
               ...
               return static_cast<uint32_t>(calculator.calculate_serialized_size(
                           *static_cast<BenchMarkMedium*>(data), current_alignment)) +
                       4u /*encapsulation*/;
           };
}
        ...
        bool force_md5)
{
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
            BenchMarkMedium_max_key_cdr_typesize);

    // Object that serializes the data.
    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
    eprosima::fastcdr::serialize_key(ser, *p_type);
    if (force_md5 || BenchMarkMedium_max_key_cdr_typesize > 16)
    {
        m_md5.init();
