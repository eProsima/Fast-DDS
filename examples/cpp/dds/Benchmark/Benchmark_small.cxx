...
size_t BenchMarkSmall::calculate_serialized_size(
...
,
            current_alignment);
                ...
                current_alignment += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(0), data.m_array, current_alignment);
...
eprosima::fastcdr::EncodingAlgorithmFlag::PLAIN_CDR
    ...
    scdr << eprosima::fastcdr::MemberId(0) << m_array;scdr << eprosima::fastcdr::MemberId(1) << m_index;
