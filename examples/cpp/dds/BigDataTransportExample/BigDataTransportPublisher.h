...
/**
 * @file BigDataTransportPublisher.h
 *
 */

#ifndef _EPROSIMA_FASTDDS_EXAMPLES_CPP_DDS_BIGDATATRANSPORT_ADVANCEDCONFIGURATIONPUBLISHER_H_
#define _EPROSIMA_FASTDDS_EXAMPLES_CPP_DDS_BIGDATATRANSPORT_ADVANCEDCONFIGURATIONPUBLISHER_H_
...
public:
    ...
    //! Fill data with fixed bytes (1 MB by default)
    void fill_data(
...
#endif /* _EPROSIMA_FASTDDS_EXAMPLES_CPP_DDS_BIGDATATRANSPORT_ADVANCEDCONFIGURATIONPUBLISHER_H_ */
