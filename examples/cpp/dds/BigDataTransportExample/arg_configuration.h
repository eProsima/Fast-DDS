...
#ifndef _EPROSIMA_FASTDDS_EXAMPLES_CPP_DDS_BIGDATATRANSPORT_ARG_CONFIGURATION_H_
#define _EPROSIMA_FASTDDS_EXAMPLES_CPP_DDS_BIGDATATRANSPORT_ARG_CONFIGURATION_H_
...
struct Arg : public option::Arg
{
            ...
            bool msg)
    {
        if (option.arg != 0)
        {
            ...
            if (transport != "default" && transport != "udp" && transport != "udpv4" && transport != "large_data" &&
                    transport != "shm")
            {
                if (msg)
                {
...
const option::Descriptor usage[] = {
    ...
    { TRANSPORT, 0, "", "transport",        Arg::Transport,
      "  \t--transport=<default|udpv4|shm|large_data> \tUse builtin transports."
...
#endif /* _EPROSIMA_FASTDDS_EXAMPLES_CPP_DDS_BIGDATATRANSPORT_ARG_CONFIGURATION_H_ */
