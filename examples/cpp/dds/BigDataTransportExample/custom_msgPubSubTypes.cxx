...
/*!
 * @file custom_msgPubSubTypes.cpp
...
TimestampPubSubType::TimestampPubSubType()
{
    ...
    uint32_t type_size =
            ...
            static_cast<uint32_t>(Timestamp::getMaxCdrSerializedSize());
#else
...
BigDataPubSubType::BigDataPubSubType()
{
    ...
    uint32_t type_size =
#if FASTCDR_VERSION_MAJOR == 1
            static_cast<uint32_t>(BigData::getMaxCdrSerializedSize());
#else
            BigData_max_cdr_typesize;
#endif // if FASTCDR_VERSION_MAJOR == 1
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    m_typeSize = type_size + 4; /*encapsulation*/
    m_isGetKeyDefined = false;
...
#if FASTCDR_VERSION_MAJOR == 1
               static_cast<void>(data_representation);
               return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<BigData*>(data))) +
                      4u /*encapsulation*/;
#else
               try
               {
