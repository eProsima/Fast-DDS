...
PointCloud2 random_pointcloud(
        size_t len = 0)                        // 4 * 4 * 4 * 1280 * 960
{
    PointCloud2 pc_msg;
...
BigData random_bigdata(
        bool include_image_and_pointcloud = true)
{
    BigData data;
...
void set_bigdata_timestamp_to_now(
        BigData& big_data)
{
