...
{
    setName("sample");
    auto type_size = sample::getMaxCdrSerializedSize();
    type_size += eprosima::fastcdr::Cdr::alignment(type_size, 4); /* possible submessage alignment */
    m_typeSize = static_cast<uint32_t>(type_size) + 4; /*encapsulation*/
    m_isGetKeyDefined = sample::isKeyDefined();
    size_t keyLength = sample::getKeyMaxCdrSerializedSize() > 16 ?
            sample::getKeyMaxCdrSerializedSize() : 16;
        ...
        bool force_md5)
{
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
            sample::getKeyMaxCdrSerializedSize());
