...
{
    setName("HelloMsg");
    auto type_size = HelloMsg::getMaxCdrSerializedSize();
    type_size += eprosima::fastcdr::Cdr::alignment(type_size, 4); /* possible submessage alignment */
    m_typeSize = static_cast<uint32_t>(type_size) + 4; /*encapsulation*/
    m_isGetKeyDefined = HelloMsg::isKeyDefined();
    size_t keyLength = HelloMsg::getKeyMaxCdrSerializedSize() > 16 ?
            HelloMsg::getKeyMaxCdrSerializedSize() : 16;
        ...
        void* data)
{
    return [data]() -> uint32_t
           {
               return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<HelloMsg*>(data))) +
                      4u /*encapsulation*/;
           };
}
        ...
        bool force_md5)
{
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
            HelloMsg::getKeyMaxCdrSerializedSize());
