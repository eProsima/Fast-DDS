...
/*!
 * @file FilteringExampleCdrAux.hpp
...
,
            current_alignment);
                ...
                current_alignment += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(0), data.sampleNumber(), current_alignment);
