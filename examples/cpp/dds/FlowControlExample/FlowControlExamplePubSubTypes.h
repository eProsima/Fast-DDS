...
namespace detail {
    ...
    inline size_t constexpr FlowControlExample_offset_of() {
...
private:
    ...
    {
        return 600005ULL == (detail::FlowControlExample_offset_of<FlowControlExample, detail::FlowControlExample_f>() + sizeof(char));
    }
};
