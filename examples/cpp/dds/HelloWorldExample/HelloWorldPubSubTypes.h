...
/*!
 * @brief This class represents the TopicDataType of the type HelloWorldList defined by the user in the IDL file.
 * @ingroup HELLOWORLD
 */
class HelloWorldListPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef HelloWorldList type;

    eProsima_user_DllExport HelloWorldListPubSubType();

    eProsima_user_DllExport virtual ~HelloWorldListPubSubType() override;
