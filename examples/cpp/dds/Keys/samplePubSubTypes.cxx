...
{
    set_name("sample");
    uint32_t type_size = sample_max_cdr_typesize;
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    max_serialized_type_size = type_size + 4; /*encapsulation*/
    is_compute_key_provided = true;
    uint32_t key_length = sample_max_key_cdr_typesize > 16 ? sample_max_key_cdr_typesize : 16;
...
uint32_t samplePubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void* samplePubSubType::create_data()
{
    return reinterpret_cast<void*>(new sample());
}

void samplePubSubType::delete_data(
        void* data)
{
