...
#ifndef _FAST_DDS_GENERATED_SAMPLECDRAUX_IPP_
#define _FAST_DDS_GENERATED_SAMPLECDRAUX_IPP_
...
,
            current_alignment);
                ...
                current_alignment += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(1), data.key_value(), current_alignment);
...
eprosima::fastcdr::EncodingAlgorithmFlag::PLAIN_CDR
    ...
    scdr             << eprosima::fastcdr::MemberId(0) << data.index()
                << eprosima::fastcdr::MemberId(1) << data.key_value()
    ;
...
#endif // _FAST_DDS_GENERATED_SAMPLECDRAUX_IPP_