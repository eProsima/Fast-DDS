...
#ifndef _FAST_DDS_GENERATED_LIFESPAN_HPP_
#define _FAST_DDS_GENERATED_LIFESPAN_HPP_
...
public:
     ...
     * @param x Reference to the object Lifespan that will be copied.
     */
    eProsima_user_DllExport Lifespan& operator =(
            const Lifespan& x)
    {
     ...
     * @param x Lifespan object to compare.
     */
