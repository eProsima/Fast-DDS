...
#ifndef _FAST_DDS_GENERATED_OWNERSHIPSTRENGTH_PUBSUBTYPES_H_
 ...
 */
class ExampleMessagePubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:
    ...
    eProsima_user_DllExport virtual ~ExampleMessagePubSubType() override;
