...
namespace detail {
    ...
    inline size_t constexpr RequestType_offset_of() {
...
private:
    ...
    {
        return 12ULL == (detail::RequestType_offset_of<RequestType, detail::RequestType_f>() + sizeof(int32_t));
