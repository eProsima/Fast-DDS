...
#ifndef _FAST_DDS_GENERATED_SAMPLE_PUBSUBTYPES_H_
#define _FAST_DDS_GENERATED_SAMPLE_PUBSUBTYPES_H_
...
public:
    ...
    eProsima_user_DllExport virtual ~samplePubSubType() override;
...
private:
    ...
    {
        return 6ULL == (detail::sample_offset_of<sample, detail::sample_f>() + sizeof(uint8_t));
