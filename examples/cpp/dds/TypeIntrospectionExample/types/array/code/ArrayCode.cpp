...
eprosima::fastrtps::types::DynamicType_ptr
    DataType<DataTypeKind::ARRAY , GeneratorKind::CODE>::generate_type_() const
{
    ...
    builder->add_member(1, "points", array_builder->build());

    // Set name
    builder->set_name(ARRAY_DATA_TYPE_NAME);
