...
eprosima::fastrtps::types::DynamicType_ptr
    DataType<DataTypeKind::ARRAY , GeneratorKind::GEN>::generate_type_() const
{
    // Register using method from Fast DDS Gen autogenerated code
    registerArrayTypes();

    auto type_object = GetArray_TypeIntrospectionExampleObject(true);
    auto type_id = GetArray_TypeIntrospectionExampleIdentifier(true);
