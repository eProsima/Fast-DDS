...
eprosima::fastrtps::types::DynamicType_ptr
    DataType<DataTypeKind::COMPLEX , GeneratorKind::GEN>::generate_type_() const
{
    // Register using method from Fast DDS Gen autogenerated code
    registerComplexTypes();

    auto type_object = GetComplex_TypeIntrospectionExampleObject(true);
    auto type_id = GetComplex_TypeIntrospectionExampleIdentifier(true);
