...
DataType<DataTypeKind::COMPLEX_ARRAY, GeneratorKind::GEN>::generate_type_() const
{
    // Register using method from Fast DDS Gen autogenerated code
    registerComplexArrayTypes();

    auto type_object = GetComplexArray_TypeIntrospectionExampleObject(true);
    auto type_id = GetComplexArray_TypeIntrospectionExampleIdentifier(true);
