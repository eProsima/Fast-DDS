...
const TypeObject* GetMinimalComplexSequence_TypeIntrospectionExampleObject()
{
    ...
    mst_internal_data.common().member_type_id(*TypeObjectFactory::get_instance()->get_sequence_identifier("InternalSequencePoints_TypeIntrospectionExample", 100, false));
...
const TypeObject* GetCompleteComplexSequence_TypeIntrospectionExampleObject()
{
    ...
    cst_internal_data.common().member_type_id(*TypeObjectFactory::get_instance()->get_sequence_identifier("InternalSequencePoints_TypeIntrospectionExample", 100, true));
