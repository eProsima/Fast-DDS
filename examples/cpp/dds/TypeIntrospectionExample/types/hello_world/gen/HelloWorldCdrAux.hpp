...
constexpr uint32_t HelloWorld_TypeIntrospectionExample_max_cdr_typesize {268UL};
constexpr uint32_t HelloWorld_TypeIntrospectionExample_max_key_cdr_typesize {0UL};
