...
eprosima::fastrtps::types::DynamicType_ptr
    DataType<DataTypeKind::HELLO_WORLD , GeneratorKind::GEN>::generate_type_() const
{
    // Register using method from Fast DDS Gen autogenerated code
    registerHelloWorldTypes();

    auto type_object = GetHelloWorld_TypeIntrospectionExampleObject(true);
    auto type_id = GetHelloWorld_TypeIntrospectionExampleIdentifier(true);
