...
void registerPlainTypes()
{
    TypeObjectFactory *factory = TypeObjectFactory::get_instance();
    factory->add_type_object("Plain_TypeIntrospectionExample", GetPlain_TypeIntrospectionExampleIdentifier(true),
    GetPlain_TypeIntrospectionExampleObject(true));
    factory->add_type_object("Plain_TypeIntrospectionExample", GetPlain_TypeIntrospectionExampleIdentifier(false),
    GetPlain_TypeIntrospectionExampleObject(false));

}

const TypeIdentifier* GetPlain_TypeIntrospectionExampleIdentifier(bool complete)
{
    const TypeIdentifier * c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("Plain_TypeIntrospectionExample", complete);
    if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
    {
        return c_identifier;
    }

    GetPlain_TypeIntrospectionExampleObject(complete); // Generated inside
    return TypeObjectFactory::get_instance()->get_type_identifier("Plain_TypeIntrospectionExample", complete);
}

const TypeObject* GetPlain_TypeIntrospectionExampleObject(bool complete)
{
    const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("Plain_TypeIntrospectionExample", complete);
    ...
    {
        return GetCompletePlain_TypeIntrospectionExampleObject();
    }
    //else
    return GetMinimalPlain_TypeIntrospectionExampleObject();
}

const TypeObject* GetMinimalPlain_TypeIntrospectionExampleObject()
{
    const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("Plain_TypeIntrospectionExample", false);
    if (c_type_object != nullptr)
    {
        return c_type_object;
    }
    ...
    TypeObjectFactory::get_instance()->add_type_object("Plain_TypeIntrospectionExample", &identifier, type_object);
    delete type_object;
    return TypeObjectFactory::get_instance()->get_type_object("Plain_TypeIntrospectionExample", false);
}

const TypeObject* GetCompletePlain_TypeIntrospectionExampleObject()
{
    const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("Plain_TypeIntrospectionExample", true);
    ...
    // Header
    type_object->complete().struct_type().header().detail().type_name("Plain_TypeIntrospectionExample");
    // TODO inheritance
    ...
    TypeObjectFactory::get_instance()->add_type_object("Plain_TypeIntrospectionExample", &identifier, type_object);
    delete type_object;
    return TypeObjectFactory::get_instance()->get_type_object("Plain_TypeIntrospectionExample", true);
}
