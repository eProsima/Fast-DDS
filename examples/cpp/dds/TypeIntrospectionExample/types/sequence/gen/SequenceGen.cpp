...
DataType<DataTypeKind::SEQUENCE, GeneratorKind::GEN>::generate_type_() const
{
    // Register using method from Fast DDS Gen autogenerated code
    registerSequenceTypes();

    auto type_object = GetSequence_TypeIntrospectionExampleObject(true);
    auto type_id = GetSequence_TypeIntrospectionExampleIdentifier(true);
