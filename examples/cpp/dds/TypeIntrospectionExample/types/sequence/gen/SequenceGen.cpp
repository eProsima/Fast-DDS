...
template <>
void
DataType<DataTypeKind::SEQUENCE, GeneratorKind::GEN>::generate_type_support_()
{
    type_support_.reset(new Sequence_TypeIntrospectionExamplePubSubType());
}

template <>
void
DataType<DataTypeKind::SEQUENCE, GeneratorKind::GEN_DYN>::generate_type_support_()
{
    ...
    if (RETCODE_OK != DomainParticipantFactory::get_instance()->type_object_registry().get_type_objects(
                SEQUENCE_DATA_TYPE_NAME, type_object_pair))
