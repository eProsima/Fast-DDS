...
template <>
void
DataType<DataTypeKind::SIMPLELARGE, GeneratorKind::GEN>::generate_type_support_()
{
    type_support_.reset(new SimpleLarge_TypeIntrospectionExamplePubSubType());
}

template <>
void
DataType<DataTypeKind::SIMPLELARGE, GeneratorKind::GEN_DYN>::generate_type_support_()
{
    ...
    if (RETCODE_OK != DomainParticipantFactory::get_instance()->type_object_registry().get_type_objects(
                SIMPLELARGE_DATA_TYPE_NAME, type_object_pair))
