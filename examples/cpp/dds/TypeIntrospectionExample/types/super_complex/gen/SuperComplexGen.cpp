...
eprosima::fastrtps::types::DynamicType_ptr
    DataType<DataTypeKind::SUPER_COMPLEX , GeneratorKind::GEN>::generate_type_() const
{
    // Register using method from Fast DDS Gen autogenerated code
    registerSuperComplexTypes();

    auto type_object = GetSuperComplex_TypeIntrospectionExampleObject(true);
    auto type_id = GetSuperComplex_TypeIntrospectionExampleIdentifier(true);
