...
LoanableHelloWorldPubSubType::LoanableHelloWorldPubSubType()
{
    ...
    uint32_t key_length = LoanableHelloWorld_max_key_cdr_typesize > 16 ? LoanableHelloWorld_max_key_cdr_typesize : 16;
...
uint32_t LoanableHelloWorldPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void* LoanableHelloWorldPubSubType::create_data()
{
    return reinterpret_cast<void*>(new LoanableHelloWorld());
}

void LoanableHelloWorldPubSubType::delete_data(
        void* data)
{
    delete(reinterpret_cast<LoanableHelloWorld*>(data));
}

bool LoanableHelloWorldPubSubType::compute_key(
        SerializedPayload_t& payload,
