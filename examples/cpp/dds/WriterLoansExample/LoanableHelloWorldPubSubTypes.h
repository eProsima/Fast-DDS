...
public:
    ...
    eProsima_user_DllExport virtual ~LoanableHelloWorldPubSubType() override;
...
private:
    ...
    {
        return 264ULL == (detail::LoanableHelloWorld_offset_of<LoanableHelloWorld, detail::LoanableHelloWorld_f>() + sizeof(std::array<char, 256>));
