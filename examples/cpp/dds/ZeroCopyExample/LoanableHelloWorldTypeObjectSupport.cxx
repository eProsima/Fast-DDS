    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_LoanableHelloWorld)
    {
        ...
        }
        {
            ...
            if (eprosima::fastdds::dds::RETCODE_OK != return_code_message)
            {
                ...
                {
                    element_identifier_anonymous_array_char_256 = new TypeIdentifier(type_ids_message.type_identifier1());
                }
                ...
                {
                    element_identifier_anonymous_array_char_256 = new TypeIdentifier(type_ids_message.type_identifier2());
                }
                else
                {
                    EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
