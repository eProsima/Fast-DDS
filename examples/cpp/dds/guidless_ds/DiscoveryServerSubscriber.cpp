        ...
        TransportKind transport)
{
    ...
    auto second_server = server_locator;
    eprosima::fastrtps::rtps::IPLocator::setPhysicalPort(second_server, 12345);
    remote_server_att.metatrafficUnicastLocatorList.push_back(server_locator);
    remote_server_att_2.metatrafficUnicastLocatorList.push_back(second_server);

    // Add remote SERVER to CLIENT's list of SERVERs
    pqos.wire_protocol().builtin.discovery_config.m_DiscoveryServers.push_back(remote_server_att);
    // pqos.wire_protocol().builtin.discovery_config.m_DiscoveryServers.push_back(remote_server_att_2);
