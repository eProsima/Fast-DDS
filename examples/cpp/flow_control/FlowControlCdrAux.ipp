...
#define FAST_DDS_GENERATED__FLOWCONTROLCDRAUX_IPP
...
eProsima_user_DllExport bool is_FlowControl_cdr_plain(
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_FlowControl_cdr_plain(data_representation) &&
                sizeof(FlowControl) == FlowControl_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(FlowControl));

            scdr.jump((array_size -1) * sizeof(FlowControl));
        }
        else
        {
