...
#ifndef FASTDDS_EXAMPLES_CPP_LOWBANDWIDTHTRANSPORTS__CLIPARSER_HPP
#define FASTDDS_EXAMPLES_CPP_LOWBANDWIDTHTRANSPORTS__CLIPARSER_HPP
...
public:
    ...
    using subscriber_config = publisher_config;

    //! Configuration structure for the application
    struct low_bandwidth_config
    {
    ...
    static void print_help(
            uint8_t return_code)
    {
        std::cout << "Usage: low_bandwidth_transports <entity> [options]"
                  << std::endl;
        std::cout << ""                                                                         << std::endl;
     ...
     */
    static low_bandwidth_config parse_cli_options(
            int argc,
            char* argv[])
    {
        low_bandwidth_config config;
...
#endif // FASTDDS_EXAMPLES_CPP_LOWBANDWIDTHTRANSPORTS__CLIPARSER_HPP
