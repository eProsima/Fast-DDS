...
/*!
 * @brief This class represents the TopicDataType of the type ClientID defined by the user in the IDL file.
 * @ingroup Calculator
 */
class ClientIDPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ClientID type;

    eProsima_user_DllExport ClientIDPubSubType();

    eProsima_user_DllExport ~ClientIDPubSubType() override;
