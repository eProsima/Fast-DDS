...
public:
            ...
            /*out*/ int32_t& max_value) override
    {
        ...
        RequestType request;
        request.representation_limits = Calculator_representation_limits_In{};
...
public:
            ...
            /*in*/ int32_t value2) override
    {
        ...
        // Create and send the request
        RequestType request;
        request.addition = Calculator_addition_In{};
...
public:
            ...
            /*in*/ int32_t value2) override
    {
        ...
        // Create and send the request
        RequestType request;
        request.subtraction = Calculator_subtraction_In{};
...
public:
            ...
            /*in*/ uint32_t n_results) override
    {
        ...
        // Create and send the request
        RequestType request;
        request.fibonacci_seq = Calculator_fibonacci_seq_In{};
...
public:
            ...
            /*in*/ std::shared_ptr<eprosima::fastdds::dds::rpc::RpcClientWriter<int32_t>>& value) override
    {
        ...
        // Create and send the request
        RequestType request;
        request.sum_all = Calculator_sum_all_In{};
...
private:
    ...
    {
        using FeedType = Calculator_sum_all_value_Feed;
...
public:
            ...
            /*in*/ std::shared_ptr<eprosima::fastdds::dds::rpc::RpcClientWriter<int32_t>>& value) override
    {
        ...
        // Create and send the request
        RequestType request;
        request.accumulator = Calculator_accumulator_In{};
...
private:
    ...
    {
        using FeedType = Calculator_accumulator_value_Feed;
...
public:
            ...
            /*in*/ calculator_example::FilterKind filter_kind) override
    {
        ...
        // Create and send the request
        RequestType request;
        request.filter = Calculator_filter_In{};
...
private:
    ...
    {
        using FeedType = Calculator_filter_value_Feed;
