...
private:
        ...
        public IOutputFeedCancellator
    {
        fibonacci_seq_result_writer(
            ...
            , replier_(replier)
        {
            reply_.fibonacci_seq = Calculator_fibonacci_seq_Result{};
            reply_.fibonacci_seq->result = Calculator_fibonacci_seq_Out{};
        }
        ...
        public IOutputFeedCancellator
    {
        accumulator_result_writer(
            ...
            , replier_(replier)
        {
            reply_.accumulator = Calculator_accumulator_Result{};
            reply_.accumulator->result = Calculator_accumulator_Out{};
        }
        ...
        public IOutputFeedCancellator
    {
        filter_result_writer(
            ...
            , replier_(replier)
        {
            reply_.filter = Calculator_filter_Result{};
            reply_.filter->result = Calculator_filter_Out{};
        }
            ...
            for (;;)
            {
                ...
                {
                    {
                        ...
                        /*void*/ implementation_->representation_limits(
                            *req,
                            ...
                            max_value);
                        ReplyType reply{};
                        reply.representation_limits = Calculator_representation_limits_Result{};
                        reply.representation_limits->result = Calculator_representation_limits_Out{};
                ...
                if (req->request.addition.has_value())
                {
                    try
                    {
                        ...
                        ReplyType reply{};
                        reply.addition = Calculator_addition_Result{};
                        reply.addition->result = Calculator_addition_Out{};
                ...
                if (req->request.subtraction.has_value())
                {
                    try
                    {
                        ...
                        ReplyType reply{};
                        reply.subtraction = Calculator_subtraction_Result{};
                        reply.subtraction->result = Calculator_subtraction_Out{};
                ...
                if (req->request.fibonacci_seq.has_value())
                {
                    try
                    {
                        ...
                        ReplyType reply{};
                        reply.fibonacci_seq = Calculator_fibonacci_seq_Result{};
                        reply.fibonacci_seq->result = Calculator_fibonacci_seq_Out{};
                ...
                if (req->request.sum_all.has_value())
                {
                    try
                    {
                        int32_t result = implementation_->sum_all(
                            *req,
                            *(req->sum_all_feeds.value));
                        ReplyType reply{};
                        reply.sum_all = Calculator_sum_all_Result{};
                        reply.sum_all->result = Calculator_sum_all_Out{};
                        reply.sum_all->result->return_ = result;
                        replier_->send_reply(&reply, req->info);
                    }
                    catch (const calculator_example::OverflowException& ex)
                    {
                ...
                if (req->request.accumulator.has_value())
                {
                    try
                    {
                        ...
                        ReplyType reply{};
                        reply.accumulator = Calculator_accumulator_Result{};
                        reply.accumulator->result = Calculator_accumulator_Out{};
                ...
                if (req->request.filter.has_value())
                {
                    try
                    {
                        ...
                        ReplyType reply{};
                        reply.filter = Calculator_filter_Result{};
                        reply.filter->result = Calculator_filter_Out{};
