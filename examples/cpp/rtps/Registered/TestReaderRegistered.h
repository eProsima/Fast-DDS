...
#ifndef FASTDDS_EXAMPLES_CPP_RTPS_REGISTERED__TEST_READER_REGISTERED_H
#define FASTDDS_EXAMPLES_CPP_RTPS_REGISTERED__TEST_READER_REGISTERED_H
...
#endif /* FASTDDS_EXAMPLES_CPP_RTPS_REGISTERED__TEST_READER_REGISTERED_H */
