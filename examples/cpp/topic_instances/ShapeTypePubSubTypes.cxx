...
{
    const ::ShapeType* p_type =
            static_cast<const ::ShapeType*>(data);
...
unsigned char* ShapeTypePubSubType::get_key_buffer_nts()
{
    ...
    uint32_t key_length = (std::max)(ShapeType_max_key_cdr_typesize, 16u);
