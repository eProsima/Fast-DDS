...
#ifndef EPROSIMA_DDS_CORE_XTYPES_DETAIL_ANNOTATIONS_HPP_
#define EPROSIMA_DDS_CORE_XTYPES_DETAIL_ANNOTATIONS_HPP_
...
inline IdAnnotation id( uint32_t id) { return IdAnnotation(id); }
...
#endif //EPROSIMA_DDS_CORE_XTYPES_DETAIL_ANNOTATIONS_HPP_
