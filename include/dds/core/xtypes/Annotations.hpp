...
dds::core::xtypes::IdAnnotation Id(
        uint32_t);
...
dds::core::xtypes::ExtensibilityAnnotation Extensibility(
        dds::core::xtypes::ExtensibilityAnnotation::ExtensibilityKind kind);
...
dds::core::xtypes::VerbatimAnnotation Verbatim(
        const std::string& text);

dds::core::xtypes::BitsetAnnotation Bitset();

dds::core::xtypes::BitsetAnnotation BitBound(
        uint32_t bound);
