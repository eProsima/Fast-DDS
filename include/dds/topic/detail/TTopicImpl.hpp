...
template<
        typename T,
        template<typename Q> class DELEGATE>
void Topic<T, DELEGATE>::listener(
        Listener* listener,
...
template<typename T>
void dds::topic::detail::Topic<T>::close()
{
    //To implement
...
template<typename T>
void dds::topic::detail::Topic<T>::init(
...
template<typename T>
void dds::topic::detail::Topic<T>::listener(
...
template<typename T>
dds::topic::TopicListener<T>* dds::topic::detail::Topic<T>::listener()
{
    //To implement
...
template<typename T>
dds::topic::Topic<T, dds::topic::detail::Topic> dds::topic::detail::Topic<T>::wrapper()
{
    //To implement
...
template<typename T>
void dds::topic::detail::Topic<T>::listener_notify(
...
template<typename T>
dds::topic::Topic<T, dds::topic::detail::Topic> dds::topic::detail::Topic<T>::discover_topic(
        const dds::domain::DomainParticipant& dp,
        const std::string& name,
...
template<typename T>
void dds::topic::detail::Topic<T>::discover_topics(
        const dds::domain::DomainParticipant& dp,
