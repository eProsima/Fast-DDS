...
#define EPROSIMA_LOG_INFO(cat, msg) EPROSIMA_LOG_INFO__(cat, msg)
//! Logs a warning. Disable reporting through Log::SetVerbosity or define LOG_NO_WARNING
#define EPROSIMA_LOG_WARNING(cat, msg) EPROSIMA_LOG_WARNING__(cat, msg)
//! Logs an error. Disable reporting through define LOG_NO_ERROR
#define EPROSIMA_LOG_ERROR(cat, msg) EPROSIMA_LOG_ERROR__(cat, msg)

#if ENABLE_EPROSIMA_LOG_MACROS_
...
#define EPROSIMA_LOG_ERROR__(cat, msg)                                                                                 \
    do {                                                                                                               \
...
#define EPROSIMA_LOG_WARNING__(cat, msg)                                                                            \
    do {                                                                                                            \
        using namespace eprosima::fastdds::dds;                                                                     \
...
#define EPROSIMA_LOG_INFO__(cat, msg)                                                                   \
    do {                                                                                                \
        using namespace eprosima::fastdds::dds;                                                         \
