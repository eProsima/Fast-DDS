...
class Exception : public std::exception
{
    public:
         ...
         */
        FASTDDS_EXPORTED_API void minor(const int32_t &minor);
    ...
    protected:
         ...
         */
        FASTDDS_EXPORTED_API explicit Exception(const char* const& message);

        /**
         * @brief Default copy constructor.
         * @param ex Exception that will be copied.
         */
        FASTDDS_EXPORTED_API Exception(const Exception &ex);

        /**
         * @brief Default move constructor.
         * @param ex Exception that will be moved.
         */
        FASTDDS_EXPORTED_API Exception(Exception&& ex);
         ...
         * @param minor The number that will be associated with the system exception.
         */
        FASTDDS_EXPORTED_API explicit Exception(const char* const& message, const int32_t minor);

        /**
         * @brief Assigment operation.
         * @param ex Exception that will be copied.
         */
        FASTDDS_EXPORTED_API Exception& operator=(const Exception& ex);

        /**
         * @brief Assigment operation.
         * @param ex Exception that will be moved.
         */
        FASTDDS_EXPORTED_API Exception& operator=(Exception&& ex);
