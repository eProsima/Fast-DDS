...
class SecurityException : public Exception
{
    public:
         ...
         */
        FASTDDS_EXPORTED_API SecurityException(const std::string& message) : Exception(message.c_str(), 1) {}

        /**
         * @brief Default copy constructor.
         * @param ex SecurityException that will be copied.
         */
        FASTDDS_EXPORTED_API SecurityException(const SecurityException &ex);

        /**
         * @brief Default move constructor.
         * @param ex SecurityException that will be moved.
         */
        FASTDDS_EXPORTED_API SecurityException(SecurityException&& ex);

        /**
         * @brief Assigment operation.
         * @param ex SecurityException that will be copied.
         */
        FASTDDS_EXPORTED_API SecurityException& operator=(const SecurityException &ex);

        /**
         * @brief Assigment operation.
         * @param ex SecurityException that will be moved.
         */
        FASTDDS_EXPORTED_API SecurityException& operator=(SecurityException&& ex);

        /// \brief Default constructor
        virtual FASTDDS_EXPORTED_API ~SecurityException() throw();

        /// \brief This function throws the object as an exception.
        virtual FASTDDS_EXPORTED_API void raise() const;
};
} // namespace security
} // namespace rtps
} // namespace fastrtps
