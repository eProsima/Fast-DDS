...
#ifndef SHAREDMEM_TRANSPORT_H
#define SHAREDMEM_TRANSPORT_H

#include "SharedMemTransportInterface.h"
#include "SharedMemTransportDescriptor.h"
 ...
 */
class SharedMemTransport : public SharedMemTransportInterface
{
public:
    ...
    virtual const SharedMemTransportDescriptor* configuration() const override;
...
protected:
	...
	//eProsimaSharedMem OpenAndBindInputSocket(const std::string& sIp, uint16_t port, bool is_multicast) override;
    ...
    */
    ...
    //virtual void SetSocketOutboundInterface(eProsimaSharedMem&, const std::string&) override;
};
