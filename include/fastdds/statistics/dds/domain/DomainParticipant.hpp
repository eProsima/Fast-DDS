...
public:
     ...
     */
    FASTDDS_EXPORTED_API eprosima::fastdds::dds::ReturnCode_t enable_statistics_datawriter(
     ...
     * and RETCODE_ERROR otherwise
     */
    FASTDDS_EXPORTED_API eprosima::fastdds::dds::ReturnCode_t enable_statistics_datawriter_with_profile(
     ...
     * and RETCODE_ERROR otherwise
     */
    FASTDDS_EXPORTED_API eprosima::fastdds::dds::ReturnCode_t disable_statistics_datawriter(
            const std::string& topic_name);
