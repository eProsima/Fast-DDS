...
#ifndef _tcp_idl.1_H_
#define _tcp_idl.1_H_
...
#define tcp_idl.1_DllAPI __declspec( dllexport )
#else
#define tcp_idl.1_DllAPI __declspec( dllimport )
#endif // tcp_idl.1_SOURCE
#else
#define tcp_idl.1_DllAPI
#endif
#else
#define tcp_idl.1_DllAPI
#endif // _WIN32
