 ...
 *
 * This file should be generated by the tool gen.
 */
...
const TypeIdentifier* GethashidIdentifier(bool complete = false);
const TypeObject* GethashidObject(bool complete = false);
const TypeObject* GetMinimalhashidObject();
const TypeObject* GetCompletehashidObject();

const TypeIdentifier* Getdefault_nestedIdentifier(bool complete = false);
const TypeObject* Getdefault_nestedObject(bool complete = false);
const TypeObject* GetMinimaldefault_nestedObject();
const TypeObject* GetCompletedefault_nestedObject();

const TypeIdentifier* Getignore_literal_namesIdentifier(bool complete = false);
const TypeObject* Getignore_literal_namesObject(bool complete = false);
const TypeObject* GetMinimalignore_literal_namesObject();
const TypeObject* GetCompleteignore_literal_namesObject();

const TypeIdentifier* Gettry_constructIdentifier(bool complete = false);
const TypeObject* Gettry_constructObject(bool complete = false);
...
const TypeIdentifier* GetDataRepresentationMaskIdentifier(bool complete = false);
const TypeObject* GetDataRepresentationMaskObject(bool complete = false);
const TypeObject* GetMinimalDataRepresentationMaskObject();
const TypeObject* GetCompleteDataRepresentationMaskObject();

const TypeIdentifier* Getdata_representationIdentifier(bool complete = false);
const TypeObject* Getdata_representationObject(bool complete = false);
const TypeObject* GetMinimaldata_representationObject();
const TypeObject* GetCompletedata_representationObject();

const TypeIdentifier* GettopicIdentifier(bool complete = false);
const TypeObject* GettopicObject(bool complete = false);
