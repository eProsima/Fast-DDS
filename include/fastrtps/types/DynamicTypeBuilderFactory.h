...
using AnnotationParameterValue = eprosima::fastdds::dds::xtypes::AnnotationParameterValue;
using AppliedAnnotationSeq = eprosima::fastdds::dds::xtypes::AppliedAnnotationSeq;
