...
typedef vector<AppliedAnnotationParameter> AppliedAnnotationParameterSeq;
...
public:
    ...
    inline void hash_id(const std::string &member_idid) { mmember_idid = member_idid; }
    inline void hash_id(std::string &&member_idid) { mmember_idid = std::move(member_idid); }
    inline const std::string& hash_id() const { return mmember_idid; }
    inline std::string& hash_id() { return mmember_idid; }
...
typedef vector<TypeIdentifierTypeObjectPair> TypeIdentifierTypeObjectPairSeq;
