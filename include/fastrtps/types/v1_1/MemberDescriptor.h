...
#ifndef TYPES_1_1_MEMBER_DESCRIPTOR_H
#define TYPES_1_1_MEMBER_DESCRIPTOR_H
...
public:
    ...
    RTPS_DllAPI bool is_consistent(octet parentKind) const;
...
#endif // TYPES_1_1_MEMBER_DESCRIPTOR_H
