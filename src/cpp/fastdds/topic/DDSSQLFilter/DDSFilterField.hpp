...
public:
    ...
    inline bool set_value(
            eprosima::fastrtps::types::v1_3::DynamicData& data_value)
    {
     ...
     */
    bool set_value(
            eprosima::fastrtps::types::v1_3::DynamicData& data,
            size_t n);
...
private:
    ...
    bool set_value(
            const eprosima::fastrtps::types::v1_3::DynamicData* data,
            eprosima::fastrtps::types::v1_3::MemberId member_id);
