...
RTPS_DllAPI const DataReaderQos eprosima::fastdds::dds::DATAREADER_QOS_DEFAULT;
...
ReaderQos DataReaderQos::change_to_reader_qos() const
{
    ReaderQos rqos;
...
void DataReaderQos::change_to_datareader_qos(
        const ReaderQos& qos)
{
...
void DataReaderQos::copy_from_topic_qos(
