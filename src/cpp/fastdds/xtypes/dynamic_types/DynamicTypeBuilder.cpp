        ...
        ReturnCode_t* ec /*= nullptr*/) const noexcept
{
    try
    {
        ...
        //TODO(richware) return &DynamicTypeBuilderImpl::get_implementation(*this).get_member(id).get_interface();
    }
        ...
        ReturnCode_t* ec /*= nullptr*/) const noexcept
{
    try
    {
        ...
        //TODO(richware) return &DynamicTypeBuilderImpl::get_implementation(*this).get_member_by_index(index).get_interface();
    }
    catch (std::system_error& e)
    {
        if (ec)
