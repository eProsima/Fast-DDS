...
#ifndef FASTDDS_XTYPES_DYNAMIC_TYPES_IDL_PARSER_BUILTINTAGS_HPP
#define FASTDDS_XTYPES_DYNAMIC_TYPES_IDL_PARSER_BUILTINTAGS_HPP
...
namespace idlparser {
    ...
    static constexpr const char* IDL_TRUE_TAG = CONST_TRUE;
    static constexpr const char* IDL_FALSE_TAG = CONST_FALSE;
...
#endif // FASTDDS_XTYPES_DYNAMIC_TYPES_IDL_PARSER_BUILTINTAGS_HPP