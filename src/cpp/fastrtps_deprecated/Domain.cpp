...
void Domain::getDefaultParticipantAttributes(
...
void Domain::getDefaultPublisherAttributes(
...
void Domain::getDefaultSubscriberAttributes(
...
bool Domain::loadXMLProfilesFile(
