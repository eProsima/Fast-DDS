...
bool LatencyBudgetQosPolicy::addToCDRMessage(CDRMessage_t* msg) {
    ...
    valid &= CDRMessage::addUInt32(msg,duration.nanosec);
    return valid;
}
...
bool LivelinessQosPolicy::addToCDRMessage(CDRMessage_t* msg) {
    ...
    valid &= CDRMessage::addUInt32(msg,lease_duration.nanosec);
    return valid;
}
...
bool ReliabilityQosPolicy::addToCDRMessage(CDRMessage_t* msg) {
    ...
    valid &= CDRMessage::addUInt32(msg,max_blocking_time.nanosec);
    return valid;
}
...
bool TimeBasedFilterQosPolicy::addToCDRMessage(CDRMessage_t* msg) {
    ...
    valid &= CDRMessage::addUInt32(msg,minimum_separation.nanosec);
    return valid;
}
...
bool DurabilityServiceQosPolicy::addToCDRMessage(CDRMessage_t* msg) {
    ...
    valid &= CDRMessage::addUInt32(msg,service_cleanup_delay.nanosec);
