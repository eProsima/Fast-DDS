...
protected:
    ...
    // this functions will populate the changes_to_release_ vector with the erased entity's changes

    // erase a participant from the map and its readers and writers and populate changes_to_release_
