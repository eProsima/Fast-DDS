...
std::vector<eprosima::fastdds::rtps::GuidPrefix_t> DiscoveryParticipantsAckStatus::relevant_participants() const
{
    std::vector<eprosima::fastdds::rtps::GuidPrefix_t> res;
    for (auto it = relevant_participants_map_.begin(); it != relevant_participants_map_.end(); ++it)
    {
