        ...
        const ReaderAttributes& att)
{
    ...
    {
        matched_writers_pool_.push_back(new WriterProxy(this, pimpl->get_attributes().allocation.locators, proxy_changes_config_));
    }
}
        ...
        const WriterProxyData& wdata)
{
...

    {
        ...
        if (matched_writers_pool_.empty())
        {
            ...
            {
                wp = new WriterProxy(this, mp_RTPSParticipant->get_attributes().allocation.locators, proxy_changes_config_);
            }
            else
            {
