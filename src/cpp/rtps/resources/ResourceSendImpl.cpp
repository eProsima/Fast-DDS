...
bool ResourceSendImpl::initSend(ParticipantImpl* pimpl,const Locator_t& loc,bool useIP4,bool useIP6)
{
...
void ResourceSendImpl::sendSync(CDRMessage_t* msg, const Locator_t& loc)
{
	...
	{
		logWarning(RTPS_MSG_OUT,"Destination "<< loc << " not valid for this ListenReosurce",EPRO_YELLOW);
	}
