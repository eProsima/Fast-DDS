...
void SecurityManager::create_participant_stateless_message_pool()
{
    ...
    { PREALLOCATED_WITH_REALLOC_MEMORY_MODE, 8192, 20, 100 };
    participant_stateless_message_reader_hattr_ =
    { PREALLOCATED_WITH_REALLOC_MEMORY_MODE, 8192, 10, 5000 };

    BasicPoolConfig cfg{ PREALLOCATED_WITH_REALLOC_MEMORY_MODE, 8192 };
...
void SecurityManager::create_participant_volatile_message_secure_pool()
{
    ...
    { PREALLOCATED_WITH_REALLOC_MEMORY_MODE, 1024, 10, 0 };
