...
#ifndef RTPS_TRANSPORT_UDP_TSN__TSN_UDPV6TRANSPORT_HPP
#define RTPS_TRANSPORT_UDP_TSN__TSN_UDPV6TRANSPORT_HPP
...
struct TSN_UDPv6Transport : public UDPv6Transport
{
    explicit TSN_UDPv6Transport(
            const TSN_UDPv6TransportDescriptor& descriptor);

    ~TSN_UDPv6Transport() override = default;
...
#endif  // RTPS_TRANSPORT_UDP_TSN__TSN_UDPV6TRANSPORT_HPP
