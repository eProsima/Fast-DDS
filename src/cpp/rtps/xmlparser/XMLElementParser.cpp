    ...
    /*
        <xs:complexType name="dataSharingQosPolicyType">
            <xs:all>
                ...
                <xs:element name="sharedDir" type="stringType" minOccurs="0"/>
                <xs:element name="domainIds" type="domainIdVectorType" minOccurs="0"/>
                <xs:element name="maxDomains" type="uint32Type" minOccurs="0"/>
            </xs:all>
        </xs:complexType>
     */
