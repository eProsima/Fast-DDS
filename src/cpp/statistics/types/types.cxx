...
{
    // m_value com.eprosima.idl.parser.typecode.ArrayTypeCode@cb0ed20
...
{
    // m_value com.eprosima.idl.parser.typecode.ArrayTypeCode@43738a82
...
{
    // m_guidPrefix com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@6cc7b4de

    // m_entityId com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@32cf48b7
...
{
    // m_high com.eprosima.idl.parser.typecode.PrimitiveTypeCode@23bb8443
    m_high = 0;
    // m_low com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1176dcec
    m_low = 0;
...
eprosima::fastdds::statistics::DiscoveryTime::DiscoveryTime()
{
    ...
    // m_time com.eprosima.idl.parser.typecode.PrimitiveTypeCode@35cabb2a
    m_time = 0;
    // m_host com.eprosima.idl.parser.typecode.StringTypeCode@7e07db1f
    m_host ="";
    // m_user com.eprosima.idl.parser.typecode.StringTypeCode@1189dd52
    m_user ="";
    // m_process com.eprosima.idl.parser.typecode.StringTypeCode@36bc55de
    m_process ="";
...
eprosima::fastdds::statistics::EntityCount::EntityCount()
{
    ...
    // m_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@158d2680
    m_count = 0;
...
{
    // m_sample_id com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@7f0eb4b4

    // m_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c33f1a9
    m_count = 0;
...
eprosima::fastdds::statistics::Entity2LocatorTraffic::Entity2LocatorTraffic()
{
    ...
    // m_dst_locator com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@6069db50

    // m_packet_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4efbca5a
    m_packet_count = 0;
    // m_byte_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1b7cc17c
    m_byte_count = 0;
    // m_byte_magnitude_order com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59662a0b
...
eprosima::fastdds::statistics::WriterReaderData::WriterReaderData()
{
    ...
    // m_data com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2f9f7dcf
    m_data = 0.0;
...
{
    // m_src_locator com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@6069db50

    // m_dst_locator com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@6069db50

    // m_data com.eprosima.idl.parser.typecode.PrimitiveTypeCode@747ddf94
    m_data = 0.0;
...
eprosima::fastdds::statistics::EntityData::EntityData()
{
    ...
    // m_data com.eprosima.idl.parser.typecode.PrimitiveTypeCode@35e2d654
    m_data = 0.0;
...
eprosima::fastdds::statistics::PhysicalData::PhysicalData()
{
    ...
    // m_host com.eprosima.idl.parser.typecode.StringTypeCode@7d8995e
    m_host ="";
    // m_user com.eprosima.idl.parser.typecode.StringTypeCode@130d63be
    m_user ="";
    // m_process com.eprosima.idl.parser.typecode.StringTypeCode@42a48628
    m_process ="";
...
eprosima::fastdds::statistics::Data::Data()
{
    ...
    // m_writer_reader_data com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@235834f2

    // m_locator2locator_data com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@5656be13

    // m_entity_data com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@4218d6a3

    // m_entity2locator_traffic com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@76505305

    // m_entity_count com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@14cd1699

    // m_discovery_time com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@77888435

    // m_sample_identity_count com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@73a1e9a9

    // m_physical_data com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@71d44a3
