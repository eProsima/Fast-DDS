...
bool CDRMessageCreator2::createMessageData(CDRMessage_t* msg,
		GuidPrefix_t guidprefix,CacheChange_t* change,TopicKind_t topicKind,bool expectsInline){
	...
	try{
		...
		CDRMessageCreator2::createSubmessageData(&submsgdata,change,topicKind,expectsInline);
...
bool CDRMessageCreator2::createSubmessageData(CDRMessage_t* submessage,CacheChange_t* change,
		TopicKind_t topicKind,bool expectsInline) {
