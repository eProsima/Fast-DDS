...
static const char* const CLASS_NAME = "GranularUDPv4Transport";

GranularUDPv4Transport::GranularUDPv4Transport(const TransportDescriptor& descriptor):
...
GranularUDPv4Transport::GranularUDPv4Transport()
{
   auto ioServiceFunction = [&]()
   {
      io_service::work work(mService);
...
bool GranularUDPv4Transport::IsInputChannelOpen(const Locator_t& locator) const
{
   return false;
//   boost::unique_lock<boost::recursive_mutex> scopedLock(mInputMapMutex);
//   return IsLocatorSupported(locator) && (mInputSockets.find(locator) != mInputSockets.end());
}

bool GranularUDPv4Transport::IsOutputChannelOpen(const Locator_t& locator) const
{
   boost::unique_lock<boost::recursive_mutex> scopedLock(mOutputMapMutex);
   return IsLocatorSupported(locator) && (mOutputSockets.find(locator) != mOutputSockets.end());
}

bool GranularUDPv4Transport::OpenOutputChannel(const Locator_t& locator)
{
...
bool GranularUDPv4Transport::OpenInputChannel(const Locator_t& locator)
{
   return false;
...
bool GranularUDPv4Transport::CloseOutputChannel(const Locator_t& locator)
{
   if (!IsOutputChannelOpen(locator))
      return false;   
   ...
   auto& socket = mOutputSockets.at(locator);
   socket.cancel();
   socket.close();

   mOutputSockets.erase(locator);
   return true;
}

bool GranularUDPv4Transport::CloseInputChannel(const Locator_t& locator)
{
   return false;
//   if (!IsInputChannelOpen(locator))
//      return false;   
...
bool GranularUDPv4Transport::OpenAndBindOutputSockets(const Locator_t& locator)
{
   ...
   try 
   {
      mOutputSockets.insert(std::pair<Locator_t, boost::asio::ip::udp::socket>(locator, 
...
bool GranularUDPv4Transport::OpenAndBindInputSockets(uint16_t port, ip::address_v4 multicastFilterAddress)
{
   return false;
...
boost::asio::ip::udp::socket GranularUDPv4Transport::OpenAndBindUnicastOutputSocket(ip::address_v4 ipAddress, uint32_t port)
{
...
boost::asio::ip::udp::socket GranularUDPv4Transport::OpenAndBindMulticastInputSocket(uint32_t port, ip::address_v4 multicastFilterAddress)
{
   ip::udp::socket socket(mService);
   socket.open(ip::udp::v4());
...
bool GranularUDPv4Transport::DoLocatorsMatch(const Locator_t& left, const Locator_t& right) const
{
   return left == right;
}

bool GranularUDPv4Transport::IsLocatorSupported(const Locator_t& locator) const
{
   return locator.kind == LOCATOR_KIND_UDPv4;
}

Locator_t GranularUDPv4Transport::RemoteToMainLocal(const Locator_t& remote) const
{
...
bool GranularUDPv4Transport::Send(const octet* sendBuffer, uint32_t sendBufferSize, const Locator_t& localLocator, const Locator_t& remoteLocator)
{
   return false;
...
bool GranularUDPv4Transport::Receive(std::vector<octet>& receiveBuffer, const Locator_t& localLocator, Locator_t& remoteLocator)
{
   return false;
...
bool GranularUDPv4Transport::SendThroughSocket(const octet* sendBuffer,
