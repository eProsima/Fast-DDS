...
bool IPLocator::setIPv4(Locator_t &destlocator, const Locator_t &origlocator)
{
...
// IPv6
bool IPLocator::setIPv6(Locator_t &locator, const unsigned char* addr)
{
    memcpy(locator.address, addr, 16 * sizeof(char));
    return true;
}

bool IPLocator::setIPv6(Locator_t &locator,
...
bool IPLocator::setIPv6(Locator_t &destlocator, const Locator_t &origlocator)
{
...
bool IPLocator::copyIPv6(const Locator_t &locator, unsigned char* dest)
{
