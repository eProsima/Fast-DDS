...
#ifndef SRC_CPP_UTILS_COLLECTIONS_IMPL_FOONATHAN_MAP_NODE_SIZE_IMPL_HPP_
 ...
 *   foonathan::memory::map_node_size<std::map<uint32_t, uint32_t>::value_type>
...
#endif  /* SRC_CPP_UTILS_COLLECTIONS_IMPL_FOONATHAN_MAP_NODE_SIZE_IMPL_HPP_ */