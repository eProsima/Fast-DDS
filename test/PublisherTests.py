...
writeTest("/mnt/perfshare/output/pub.log", "---------------------------------")
writeTest("/mnt/perfshare/output/pub.log", "Start Publisher Test - " + now.strftime("%Y-%m-%d_%H-%M-%S"))
os.system("mkdir -p /mnt/perfshare/output")
writeTest("/mnt/perfshare/output/pub.log", "Start Tests")
os.chdir(folder)
os.system("python3 GenerateTestsAndXMLs.py '" + folder + "'")
time.sleep(5)
writeTest("/mnt/perfshare/output/pub.log", "Generated XML files")
writeTest("/mnt/perfshare/output/pub.log", "Start Tests")
os.system("python3 PublisherTestList.py /mnt/perfshare/ '" + folder + "'")
writeTest("/mnt/perfshare/output/pub.log", "Tests Completed")
