...
writeTest(folder + "/output/sub.log", "---------------------------------")
writeTest(folder + "/output/sub.log", "Start Subscriber Test - " + now.strftime("%Y-%m-%d_%H-%M-%S"))
writeTest(folder + "/output/sub.log", "Start Tests")
os.chdir(folder)
os.system("python3 GenerateTestsAndXMLs.py '" + folder + "'")
time.sleep(5)
writeTest(folder + "/output/sub.log", "Generated XML files")
writeTest(folder + "/output/sub.log", "Start Tests")
os.system("python3 SubscriberTestList.py " + folder + "/")
writeTest(folder + "/output/sub.log", "Tests Completed")