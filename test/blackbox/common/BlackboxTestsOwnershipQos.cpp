...
/*!
 * \test DDS-OWN-SAMPLE-01 Tests samples reception works successfully with Non-Keyed types, Ownership QoS EXCLUSIVE and
 * dynamic change of strength.
 */
TEST_P(OwnershipQos, exclusive_kind_non_keyed_sample_reception)
{
...
/*!
 * \test DDS-OWN-SAMPLE-02 Tests samples reception works successfully with Keyed types, Ownership QoS EXCLUSIVE and
 * dynamic change of strength.
 */
TEST_P(OwnershipQos, exclusive_kind_keyed_sample_reception)
{
