...
public:
            ...
            bool as_writer)
    {
        ...
        secure_topic_ = participant_->create_topic(secure_name, type->getName(), TOPIC_QOS_DEFAULT);
        plain_topic_  = participant_->create_topic(plain_name,  type->getName(), TOPIC_QOS_DEFAULT);
