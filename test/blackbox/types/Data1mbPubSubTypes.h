...
namespace detail {
    ...
    struct Data1mb_f
    {
        typedef std::vector<uint8_t> Data1mb::* type;
        friend type get(
                Data1mb_f);
    };

    template struct Data1mb_rob<Data1mb_f, &Data1mb::m_data>;
}
...
public:
    ...
    eProsima_user_DllExport virtual ~Data1mbPubSubType() override;
    ...
    {
        return 1024004ULL == eprosima::fastrtps::size_of_<Data1mb, detail::Data1mb_f, std::vector<uint8_t>>();
    }
