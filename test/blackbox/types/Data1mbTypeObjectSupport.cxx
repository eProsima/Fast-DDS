    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Data1mb)
    {
        ...
        CompleteStructMemberSeq member_seq_Data1mb;
        {
            ...
            if (eprosima::fastdds::dds::RETCODE_OK != return_code_data)
            {
                ...
                {
                    element_identifier_anonymous_sequence_uint8_t_1024000 = new TypeIdentifier(type_ids_data.type_identifier1());
                }
                ...
                {
                    element_identifier_anonymous_sequence_uint8_t_1024000 = new TypeIdentifier(type_ids_data.type_identifier2());
                }
                else
                {
                    EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
