...
#ifndef FAST_DDS_GENERATED__DATA64KBCDRAUX_IPP
#define FAST_DDS_GENERATED__DATA64KBCDRAUX_IPP
...
eProsima_user_DllExport bool is_Data64kb_cdr_plain(
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_Data64kb_cdr_plain(data_representation) &&
                sizeof(Data64kb) == Data64kb_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(Data64kb));

            scdr.jump((array_size -1) * sizeof(Data64kb));
        }
        else
        {
...
#endif // FAST_DDS_GENERATED__DATA64KBCDRAUX_IPP
