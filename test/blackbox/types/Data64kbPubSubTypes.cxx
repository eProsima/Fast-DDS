...
#include "Data64kbPubSubTypes.hpp"

#include <fastdds/dds/log/Log.hpp>
#include <fastdds/rtps/common/CdrSerialization.hpp>

#include "Data64kbCdrAux.hpp"
...
{
    set_name("Data64kb");
    uint32_t type_size = Data64kb_max_cdr_typesize;
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    max_serialized_type_size = type_size + 4; /*encapsulation*/
    is_compute_key_provided = false;
    uint32_t key_length = Data64kb_max_key_cdr_typesize > 16 ? Data64kb_max_key_cdr_typesize : 16;
...
uint32_t Data64kbPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void* Data64kbPubSubType::create_data()
{
    return reinterpret_cast<void*>(new ::Data64kb());
}

void Data64kbPubSubType::delete_data(
        void* data)
{
    ...
    bool Data64kbPubSubType::is_plain(
...
bool Data64kbPubSubType::compute_key(
        SerializedPayload_t& payload,
