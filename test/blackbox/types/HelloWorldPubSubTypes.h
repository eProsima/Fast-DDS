...
namespace detail {
    ...
    struct HelloWorld_f
    {
        typedef eprosima::fastrtps::fixed_string<128> HelloWorld::* type;
        friend type get(
                HelloWorld_f);
    };
...
public:
    ...
    {
        return 137ULL == eprosima::fastrtps::size_of_<HelloWorld, detail::HelloWorld_f, eprosima::fastrtps::fixed_string<128>>();
    }
