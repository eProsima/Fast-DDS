...
eProsima_user_DllExport const eprosima::fastrtps::types::TypeIdentifier* GetHelloWorldIdentifier(
        bool complete = false);
eProsima_user_DllExport const eprosima::fastrtps::types::TypeObject* GetHelloWorldObject(
        bool complete = false);
