...
#define FAST_DDS_GENERATED__KEYEDDATA1MBCDRAUX_IPP
...
eProsima_user_DllExport bool is_KeyedData1mb_cdr_plain(
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_KeyedData1mb_cdr_plain(data_representation) &&
                sizeof(KeyedData1mb) == KeyedData1mb_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(KeyedData1mb));

            scdr.jump((array_size -1) * sizeof(KeyedData1mb));
        }
        else
        {
...
#endif // FAST_DDS_GENERATED__KEYEDDATA1MBCDRAUX_IPP
