...
#include "KeyedData1mbType.h"

using SerializedPayload_t = eprosima::fastrtps::rtps::SerializedPayload_t;
using InstanceHandle_t = eprosima::fastrtps::rtps::InstanceHandle_t;

KeyedData1mbType::KeyedData1mbType()
{
...
bool KeyedData1mbType::serialize(
        void* data,
...
bool KeyedData1mbType::deserialize(
        SerializedPayload_t* payload,
        void* data)
{
...
std::function<uint32_t()> KeyedData1mbType::getSerializedSizeProvider(
        void* data)
{
...
void* KeyedData1mbType::createData()
{
    return reinterpret_cast<void*>(new KeyedData1mb());
}

void KeyedData1mbType::deleteData(
        void* data)
{
    delete(reinterpret_cast<KeyedData1mb*>(data));
}

bool KeyedData1mbType::getKey(
        void* data,
