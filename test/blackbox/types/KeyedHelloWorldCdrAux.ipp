...
#ifndef FAST_DDS_GENERATED__KEYEDHELLOWORLDCDRAUX_IPP
#define FAST_DDS_GENERATED__KEYEDHELLOWORLDCDRAUX_IPP
...
eProsima_user_DllExport bool is_KeyedHelloWorld_cdr_plain(
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const KeyedHelloWorld* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_KeyedHelloWorld_cdr_plain(data_representation) &&
                sizeof(KeyedHelloWorld) == KeyedHelloWorld_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(KeyedHelloWorld));

            scdr.jump((array_size -1) * sizeof(KeyedHelloWorld));
        }
        else
        {
...
#endif // FAST_DDS_GENERATED__KEYEDHELLOWORLDCDRAUX_IPP
