...
#include "KeyedHelloWorldCdrAux.hpp"
...
{
    set_name("KeyedHelloWorld");
    uint32_t type_size = KeyedHelloWorld_max_cdr_typesize;
...
{
    const ::KeyedHelloWorld* p_type =
            static_cast<const ::KeyedHelloWorld*>(data);
        ...
        void* data)
{
    try
    {
        ...
        ::KeyedHelloWorld* p_type =
                static_cast<::KeyedHelloWorld*>(data);
...
uint32_t KeyedHelloWorldPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void* KeyedHelloWorldPubSubType::create_data()
{
    return reinterpret_cast<void*>(new ::KeyedHelloWorld());
}

void KeyedHelloWorldPubSubType::delete_data(
        void* data)
{
    delete(reinterpret_cast<::KeyedHelloWorld*>(data));
}

bool KeyedHelloWorldPubSubType::compute_key(
        SerializedPayload_t& payload,
...
unsigned char* KeyedHelloWorldPubSubType::get_key_buffer_nts()
{
    ...
    uint32_t key_length = (std::max)(KeyedHelloWorld_max_key_cdr_typesize, 16u);
