...
#define FAST_DDS_GENERATED__STRINGTESTCDRAUX_IPP
...
eProsima_user_DllExport bool is_StringTest_cdr_plain(
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_StringTest_cdr_plain(data_representation) &&
                sizeof(StringTest) == StringTest_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(StringTest));

            scdr.jump((array_size -1) * sizeof(StringTest));
        }
        else
        {
...
#endif // FAST_DDS_GENERATED__STRINGTESTCDRAUX_IPP
