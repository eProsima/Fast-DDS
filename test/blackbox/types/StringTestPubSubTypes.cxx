...
#include "StringTestPubSubTypes.hpp"

#include <fastdds/dds/log/Log.hpp>
#include <fastdds/rtps/common/CdrSerialization.hpp>

#include "StringTestCdrAux.hpp"
...
{
    set_name("StringTest");
    uint32_t type_size = StringTest_max_cdr_typesize;
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    max_serialized_type_size = type_size + 4; /*encapsulation*/
    is_compute_key_provided = false;
    uint32_t key_length = StringTest_max_key_cdr_typesize > 16 ? StringTest_max_key_cdr_typesize : 16;
...
uint32_t StringTestPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void* StringTestPubSubType::create_data()
{
    return reinterpret_cast<void*>(new ::StringTest());
}

void StringTestPubSubType::delete_data(
        void* data)
{
    ...
    bool StringTestPubSubType::is_plain(
...
bool StringTestPubSubType::compute_key(
        SerializedPayload_t& payload,
