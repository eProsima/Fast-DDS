...
namespace TestModule {
    ...
    {
        const TypeIdentifier* c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("TestModule::MACHINEID", complete);
        ...
        return TypeObjectFactory::get_instance()->get_type_identifier("TestModule::MACHINEID", complete);
    }

    const TypeObject* GetMACHINEIDObject(bool complete)
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("TestModule::MACHINEID", complete);
    ...
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("TestModule::MACHINEID", false);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
        ...
        TypeObjectFactory::get_instance()->add_alias("TestModule::MACHINEID", TypeNamesGenerator::get_string_type_name(255, false));

        TypeObjectFactory::get_instance()->add_type_object("TestModule::MACHINEID", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("TestModule::MACHINEID", false);
    }

    const TypeObject* GetCompleteMACHINEIDObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("TestModule::MACHINEID", true);
        ...
        type_object->complete().alias_type().header().detail().type_name("TestModule::MACHINEID");
        ...
        TypeObjectFactory::get_instance()->add_type_object("TestModule::MACHINEID", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("TestModule::MACHINEID", true);
    }
