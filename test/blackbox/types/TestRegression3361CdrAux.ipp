...
eProsima_user_DllExport bool is_TestRegression3361_cdr_plain(
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const TestRegression3361* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_TestRegression3361_cdr_plain(data_representation) &&
                sizeof(TestRegression3361) == TestRegression3361_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(TestRegression3361));

            scdr.jump((array_size -1) * sizeof(TestRegression3361));
        }
        else
        {
