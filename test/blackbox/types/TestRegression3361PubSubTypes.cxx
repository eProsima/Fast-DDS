...
#include "TestRegression3361PubSubTypes.hpp"
...
TestRegression3361PubSubType::TestRegression3361PubSubType()
{
    ...
    uint32_t type_size = TestRegression3361_max_cdr_typesize;
...
{
    const ::TestRegression3361* p_type =
            static_cast<const ::TestRegression3361*>(data);
        ...
        void* data)
{
    try
    {
        ...
        ::TestRegression3361* p_type =
                static_cast<::TestRegression3361*>(data);
...
uint32_t TestRegression3361PubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void* TestRegression3361PubSubType::create_data()
{
    return reinterpret_cast<void*>(new ::TestRegression3361());
}

void TestRegression3361PubSubType::delete_data(
        void* data)
{
