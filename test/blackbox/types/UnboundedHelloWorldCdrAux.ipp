...
#define FAST_DDS_GENERATED__UNBOUNDEDHELLOWORLDCDRAUX_IPP
...
eProsima_user_DllExport bool is_UnboundedHelloWorld_cdr_plain(
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const UnboundedHelloWorld* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_UnboundedHelloWorld_cdr_plain(data_representation) &&
                sizeof(UnboundedHelloWorld) == UnboundedHelloWorld_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(UnboundedHelloWorld));

            scdr.jump((array_size -1) * sizeof(UnboundedHelloWorld));
        }
        else
        {
...
#endif // FAST_DDS_GENERATED__UNBOUNDEDHELLOWORLDCDRAUX_IPP
