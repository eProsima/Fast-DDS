...
UnboundedHelloWorldPubSubType::UnboundedHelloWorldPubSubType()
{
    ...
    auto type_size = UnboundedHelloWorld::getMaxCdrSerializedSize();
    type_size += eprosima::fastcdr::Cdr::alignment(type_size, 4); /* possible submessage alignment */
    m_typeSize = static_cast<uint32_t>(type_size) + 4; /*encapsulation*/
    m_isGetKeyDefined = UnboundedHelloWorld::isKeyDefined();
    size_t keyLength = UnboundedHelloWorld::getKeyMaxCdrSerializedSize() > 16 ?
            UnboundedHelloWorld::getKeyMaxCdrSerializedSize() : 16;
        ...
        bool force_md5)
{
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
            UnboundedHelloWorld::getKeyMaxCdrSerializedSize());

    // Object that serializes the data.
    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
    p_type->serializeKey(ser);
    if (force_md5 || UnboundedHelloWorld::getKeyMaxCdrSerializedSize() > 16)
    {
        m_md5.init();
