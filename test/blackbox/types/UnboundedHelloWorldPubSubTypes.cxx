...
#include "UnboundedHelloWorldPubSubTypes.hpp"
...
bool is_UnboundedHelloWorld_cdr_plain(
...
{
    set_name("UnboundedHelloWorld");
    uint32_t type_size = UnboundedHelloWorld_max_cdr_typesize;
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    max_serialized_type_size = type_size + 4; /*encapsulation*/
    is_compute_key_provided = false;
    uint32_t key_length = UnboundedHelloWorld_max_key_cdr_typesize > 16 ? UnboundedHelloWorld_max_key_cdr_typesize : 16;
...
uint32_t UnboundedHelloWorldPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void* UnboundedHelloWorldPubSubType::create_data()
{
    return reinterpret_cast<void*>(new ::UnboundedHelloWorld());
}

void UnboundedHelloWorldPubSubType::delete_data(
        void* data)
{
    ...
    bool UnboundedHelloWorldPubSubType::is_plain(
...
bool UnboundedHelloWorldPubSubType::compute_key(
        SerializedPayload_t& payload,
