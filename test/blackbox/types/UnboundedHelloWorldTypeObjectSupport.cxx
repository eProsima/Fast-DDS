        ...
        TypeIdentifierPair& type_ids_UnboundedHelloWorld)
{
    ...
    ReturnCode_t return_code_UnboundedHelloWorld {eprosima::fastdds::dds::RETCODE_OK};
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_UnboundedHelloWorld)
    {
        StructTypeFlag struct_flags_UnboundedHelloWorld = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::NOT_APPLIED,
                false, false);
        static_cast<void>(return_code_UnboundedHelloWorld);
        ...
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_UnboundedHelloWorld, type_name_UnboundedHelloWorld.to_string(), type_ids_UnboundedHelloWorld))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
