...
#define eprosima_fastdds_rtps_core_RTPSMessage_max_cdr_typesize 6852ULL;
...
// TODO(Ricardo) Review
size_t Submessage::getCdrSerializedSize(
        const Submessage& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
    ...
    {
        case SubmessageKind::HEARTBEAT:
        current_alignment += eprosima::fastdds::rtps::core::HeartBeatSubmessage::getCdrSerializedSize(data.heartbeat_submsg(), current_alignment);

        break;


        case SubmessageKind::INFO_TS:
        current_alignment += eprosima::fastdds::rtps::core::InfoTimestampSubmessage::getCdrSerializedSize(data.info_ts_submsg(), current_alignment);

        break;


        case SubmessageKind::INFO_SRC:
        current_alignment += eprosima::fastdds::rtps::core::InfoSourceSubmessage::getCdrSerializedSize(data.info_src_submsg(), current_alignment);

        break;


        case SubmessageKind::INFO_DST:
        current_alignment += eprosima::fastdds::rtps::core::InfoDestinationSubmessage::getCdrSerializedSize(data.info_dst_submsg(), current_alignment);

        break;


        default:
        current_alignment += eprosima::fastdds::rtps::core::SubmessageHeader::getCdrSerializedSize(data.unknown_submsg(), current_alignment);
        ...
        eprosima::fastcdr::Cdr& scdr) const
{
    ...
    {
        case SubmessageKind::HEARTBEAT:
        scdr << m_heartbeat_submsg;

        break;


        case SubmessageKind::INFO_TS:
        scdr << m_info_ts_submsg;

        break;


        case SubmessageKind::INFO_SRC:
        scdr << m_info_src_submsg;

        break;


        case SubmessageKind::INFO_DST:
        scdr << m_info_dst_submsg;

        break;


        default:
        scdr << m_unknown_submsg;
...
RTPSMessage::RTPSMessage()
{
    ...
    // sequence<eprosima::fastdds::rtps::core::Submessage> m_submessages
...
size_t RTPSMessage::getMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
    return eprosima_fastdds_rtps_core_RTPSMessage_max_cdr_typesize;
}

size_t RTPSMessage::getCdrSerializedSize(
        const RTPSMessage& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;

    current_alignment += eprosima::fastdds::rtps::core::Header::getCdrSerializedSize(data.msg_header(), current_alignment);


    current_alignment += 4 + eprosima::fastcdr::Cdr::alignment(current_alignment, 4);


    for(size_t a = 0; a < data.submessages().size(); ++a)
    {
        current_alignment += eprosima::fastdds::rtps::core::Submessage::getCdrSerializedSize(data.submessages().at(a), current_alignment);
    }
...
bool RTPSMessage::isKeyDefined()
{
    return false;
}

void RTPSMessage::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
}
