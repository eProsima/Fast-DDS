...
#ifndef FAST_DDS_GENERATED__MONITORSERVICE_TYPES_IDL_EPROSIMA_FASTDDS_STATISTICSCDRAUX_IPP
        ...
        eprosima::fastdds::statistics::Connection& data)
{
    using namespace eprosima::fastdds::statistics;
        ...
        data.mode(eprosima::fastdds::statistics::ConnectionMode::DATA_SHARING);
        ...
        eprosima::fastdds::statistics::LivelinessChangedStatus_s& data)
{
    using namespace eprosima::fastdds::statistics;
        ...
        data.not_alive_count(0);

        data.last_publication_handle({0});
