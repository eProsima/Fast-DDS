    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_AnnotationTest)
    {
        ...
        }
        {
            ...
            return_code_var_string_10 =
                eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                "Inner_alias_bounded_string_helper", type_ids_var_string_10);

            if (return_code_var_string_10 != eprosima::fastdds::dds::RETCODE_OK)
            {
        ::register_Inner_alias_bounded_string_helper_type_identifier(type_ids_var_string_10);
            }
        ...
        }
        {
            ...
            return_code_var_default_string_10 =
                eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
                "Inner_alias_bounded_string_helper", type_ids_var_default_string_10);

            if (return_code_var_default_string_10 != eprosima::fastdds::dds::RETCODE_OK)
            {
        ::register_Inner_alias_bounded_string_helper_type_identifier(type_ids_var_default_string_10);
            }
