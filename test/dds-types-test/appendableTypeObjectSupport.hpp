...
#ifndef _FAST_DDS_GENERATED_APPENDABLE_TYPE_OBJECT_SUPPORT_HPP_
#define _FAST_DDS_GENERATED_APPENDABLE_TYPE_OBJECT_SUPPORT_HPP_
 ...
 */
eProsima_user_DllExport void register_appendable_type_objects();
