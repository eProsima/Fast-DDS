...
/*!
 * @brief This class represents the TopicDataType of the type LargeBasicPlainArray defined by the user in the IDL file.
 * @ingroup arrays
 */
class LargeBasicPlainArrayPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ::LargeBasicPlainArray type;

    eProsima_user_DllExport LargeBasicPlainArrayPubSubType();

    eProsima_user_DllExport ~LargeBasicPlainArrayPubSubType() override;
    ...
    eProsima_user_DllExport inline bool construct_sample(
            void* memory) const override
    {
        new (memory) LargeBasicPlainArray();
        return true;
    }
...
/*!
 * @brief This class represents the TopicDataType of the type LargePlainArray defined by the user in the IDL file.
 * @ingroup arrays
 */
class LargePlainArrayPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ::LargePlainArray type;

    eProsima_user_DllExport LargePlainArrayPubSubType();

    eProsima_user_DllExport ~LargePlainArrayPubSubType() override;
