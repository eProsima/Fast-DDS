...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const InnerTypedBitsetHelper* array_ptr,
...
eProsima_user_DllExport void deserialize_array(
        eprosima::fastcdr::Cdr& scdr,
        InnerTypedBitsetHelper* array_ptr,
        const std::size_t array_size)
{
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const InnerTypedBitsetHelper2* array_ptr,
        const std::size_t array_size)
{
    // Optimization for serialization
    // of arrays of bitsets not yet supported
...
eProsima_user_DllExport void deserialize_array(
        eprosima::fastcdr::Cdr& scdr,
        InnerTypedBitsetHelper2* array_ptr,
        const std::size_t array_size)
{
    // Optimization for deserialization
    // of arrays of bitsets not yet supported
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const InnerTypedBitsetHelper3* array_ptr,
        const std::size_t array_size)
{
    // Optimization for serialization
    // of arrays of bitsets not yet supported
...
eProsima_user_DllExport void deserialize_array(
        eprosima::fastcdr::Cdr& scdr,
        InnerTypedBitsetHelper3* array_ptr,
        const std::size_t array_size)
{
    // Optimization for deserialization
    // of arrays of bitsets not yet supported
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const InnerTypedBitsetHelper4* array_ptr,
        const std::size_t array_size)
{
    // Optimization for serialization
    // of arrays of bitsets not yet supported
...
eProsima_user_DllExport void deserialize_array(
        eprosima::fastcdr::Cdr& scdr,
        InnerTypedBitsetHelper4* array_ptr,
        const std::size_t array_size)
{
    // Optimization for deserialization
    // of arrays of bitsets not yet supported
...
eProsima_user_DllExport bool is_BitsetStruct_cdr_plain(
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_BitsetStruct_cdr_plain(data_representation) &&
                sizeof(BitsetStruct) == BitsetStruct_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(BitsetStruct));

            scdr.jump((array_size -1) * sizeof(BitsetStruct));
        }
        else
        {
            scdr.serialize_array(array_ptr, array_size);
