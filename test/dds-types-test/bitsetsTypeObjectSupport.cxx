        ...
        TypeIdentifierPair& type_ids_BitsetStruct)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_BitsetStruct)
    {
        ...
        CompleteStructMemberSeq member_seq_BitsetStruct;
        {
            ...
            if (EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier1()._d() || TK_NONE == type_ids_var_InnerBitsetHelper.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_var_InnerBitsetHelper.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier1().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_var_InnerBitsetHelper.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier1().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_var_InnerBitsetHelper.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier1().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_var_InnerBitsetHelper.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier1().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_var_InnerBitsetHelper.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier1().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier1().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_var_InnerBitsetHelper.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier1().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier1().map_ldefn().key_identifier()->_d())))
            {
                common_var_InnerBitsetHelper = TypeObjectUtils::build_common_struct_member(member_id_var_InnerBitsetHelper,
                        member_flags_var_InnerBitsetHelper, type_ids_var_InnerBitsetHelper.type_identifier1());
            }
            else if (EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_var_InnerBitsetHelper.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_var_InnerBitsetHelper.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier2().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_var_InnerBitsetHelper.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier2().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_var_InnerBitsetHelper.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier2().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_var_InnerBitsetHelper.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier2().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier2().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_var_InnerBitsetHelper.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier2().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerBitsetHelper.type_identifier2().map_ldefn().key_identifier()->_d())))
            {
                common_var_InnerBitsetHelper = TypeObjectUtils::build_common_struct_member(member_id_var_InnerBitsetHelper,
                        member_flags_var_InnerBitsetHelper, type_ids_var_InnerBitsetHelper.type_identifier2());
            }
            else
            {
                EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
        ...
        }
        {
            ...
            if (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier1()._d() || TK_NONE == type_ids_var_InnerTypedBitsetHelper.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_var_InnerTypedBitsetHelper.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier1().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_var_InnerTypedBitsetHelper.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier1().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_var_InnerTypedBitsetHelper.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier1().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_var_InnerTypedBitsetHelper.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier1().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_var_InnerTypedBitsetHelper.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier1().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier1().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_var_InnerTypedBitsetHelper.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier1().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier1().map_ldefn().key_identifier()->_d())))
            {
                common_var_InnerTypedBitsetHelper = TypeObjectUtils::build_common_struct_member(member_id_var_InnerTypedBitsetHelper,
                        member_flags_var_InnerTypedBitsetHelper, type_ids_var_InnerTypedBitsetHelper.type_identifier1());
            }
            else if (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_var_InnerTypedBitsetHelper.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_var_InnerTypedBitsetHelper.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier2().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_var_InnerTypedBitsetHelper.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier2().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_var_InnerTypedBitsetHelper.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier2().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_var_InnerTypedBitsetHelper.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier2().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier2().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_var_InnerTypedBitsetHelper.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier2().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper.type_identifier2().map_ldefn().key_identifier()->_d())))
            {
                common_var_InnerTypedBitsetHelper = TypeObjectUtils::build_common_struct_member(member_id_var_InnerTypedBitsetHelper,
                        member_flags_var_InnerTypedBitsetHelper, type_ids_var_InnerTypedBitsetHelper.type_identifier2());
            }
            else
            {
                EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
        ...
        }
        {
            ...
            if (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1()._d() || TK_NONE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_var_InnerTypedBitsetHelper2.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_var_InnerTypedBitsetHelper2.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_var_InnerTypedBitsetHelper2.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier1().map_ldefn().key_identifier()->_d())))
            {
                common_var_InnerTypedBitsetHelper2 = TypeObjectUtils::build_common_struct_member(member_id_var_InnerTypedBitsetHelper2,
                        member_flags_var_InnerTypedBitsetHelper2, type_ids_var_InnerTypedBitsetHelper2.type_identifier1());
            }
            else if (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_var_InnerTypedBitsetHelper2.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_var_InnerTypedBitsetHelper2.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_var_InnerTypedBitsetHelper2.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper2.type_identifier2().map_ldefn().key_identifier()->_d())))
            {
                common_var_InnerTypedBitsetHelper2 = TypeObjectUtils::build_common_struct_member(member_id_var_InnerTypedBitsetHelper2,
                        member_flags_var_InnerTypedBitsetHelper2, type_ids_var_InnerTypedBitsetHelper2.type_identifier2());
            }
            else
            {
                EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
        ...
        }
        {
            ...
            if (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1()._d() || TK_NONE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_var_InnerTypedBitsetHelper3.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_var_InnerTypedBitsetHelper3.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_var_InnerTypedBitsetHelper3.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier1().map_ldefn().key_identifier()->_d())))
            {
                common_var_InnerTypedBitsetHelper3 = TypeObjectUtils::build_common_struct_member(member_id_var_InnerTypedBitsetHelper3,
                        member_flags_var_InnerTypedBitsetHelper3, type_ids_var_InnerTypedBitsetHelper3.type_identifier1());
            }
            else if (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_var_InnerTypedBitsetHelper3.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_var_InnerTypedBitsetHelper3.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_var_InnerTypedBitsetHelper3.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper3.type_identifier2().map_ldefn().key_identifier()->_d())))
            {
                common_var_InnerTypedBitsetHelper3 = TypeObjectUtils::build_common_struct_member(member_id_var_InnerTypedBitsetHelper3,
                        member_flags_var_InnerTypedBitsetHelper3, type_ids_var_InnerTypedBitsetHelper3.type_identifier2());
            }
            else
            {
                EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
        ...
        }
        {
            ...
            if (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1()._d() || TK_NONE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_var_InnerTypedBitsetHelper4.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_var_InnerTypedBitsetHelper4.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_var_InnerTypedBitsetHelper4.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier1().map_ldefn().key_identifier()->_d())))
            {
                common_var_InnerTypedBitsetHelper4 = TypeObjectUtils::build_common_struct_member(member_id_var_InnerTypedBitsetHelper4,
                        member_flags_var_InnerTypedBitsetHelper4, type_ids_var_InnerTypedBitsetHelper4.type_identifier1());
            }
            else if (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_var_InnerTypedBitsetHelper4.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_var_InnerTypedBitsetHelper4.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_var_InnerTypedBitsetHelper4.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_var_InnerTypedBitsetHelper4.type_identifier2().map_ldefn().key_identifier()->_d())))
            {
                common_var_InnerTypedBitsetHelper4 = TypeObjectUtils::build_common_struct_member(member_id_var_InnerTypedBitsetHelper4,
                        member_flags_var_InnerTypedBitsetHelper4, type_ids_var_InnerTypedBitsetHelper4.type_identifier2());
            }
            else
            {
                EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
