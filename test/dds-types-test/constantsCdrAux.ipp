...
#ifndef FAST_DDS_GENERATED__CONSTANTS_IDL_CONST_MODULE2CDRAUX_IPP
#define FAST_DDS_GENERATED__CONSTANTS_IDL_CONST_MODULE2CDRAUX_IPP
        ...
        const_module1::ModuleConstsLiteralsStruct& data)
{
    using namespace const_module1;
        ...
        data.module1_array_literal_const_moduled({0});

        data.module1_array_literal_const_alias_const_moduled({0});
        ...
        const_module2::Module2ConstsLiteralsStruct& data)
{
    using namespace const_module2;
        ...
        data.module2_array_literal_const_moduled({0});

        data.module2_array_literal_const_alias_const_moduled({0});

        data.module2_array_literal_const_scoped_moduled({0});

        data.module2_array_literal_module1_const_moduled({0});

        data.module2_array_literal_const_moduled_module1({0});
...
{
        data.array_literal_const_short({0});

        data.array_literal_const_ushort({0});

        data.array_literal_const_long({0});

        data.array_literal_const_ulong({0});

        data.array_literal_const_longlong({0});

        data.array_literal_const_ulonglong({0});

        data.array_literal_const_int8({0});

        data.array_literal_const_uint8({0});

        data.array_literal_const_int16({0});

        data.array_literal_const_uint16({0});

        data.array_literal_const_int32({0});

        data.array_literal_const_uint32({0});

        data.array_literal_const_int64({0});

        data.array_literal_const_uint64({0});

        data.array_literals_operations1_const({0});

        data.array_literals_operations2_const({0});

        data.array_literals_operations3_const({0});

        data.array_literals_operations4_const({0});

        data.array_literals_operations5_const({0});

        data.array_literals_operations6_const({0});

        data.array_literals_operations7_const({0});

        data.array_literals_operations8_const({0});

        data.array_literal_const_inner_const_helper({0});

        data.array_moduled1_literal_const({0});

        data.array_moduled2_literal_const({0});

        data.array_literal_const_alias_const({0});

        data.array_moduled1_literal_alias_const_moduled({0});

        data.array_moduled2_literal_alias_const_moduled({0});
...
#endif // FAST_DDS_GENERATED__CONSTANTS_IDL_CONST_MODULE2CDRAUX_IPP
