...
eProsima_user_DllExport bool is_const_module1_ModuleConstsLiteralsStruct_cdr_plain(
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const const_module1::ModuleConstsLiteralsStruct* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_const_module1_ModuleConstsLiteralsStruct_cdr_plain(data_representation) &&
                sizeof(const_module1::ModuleConstsLiteralsStruct) == const_module1_ModuleConstsLiteralsStruct_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(const_module1::ModuleConstsLiteralsStruct));

            scdr.jump((array_size -1) * sizeof(const_module1::ModuleConstsLiteralsStruct));
        }
        else
        {
...
eProsima_user_DllExport void deserialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const_module1::ModuleConstsLiteralsStruct* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
...
eProsima_user_DllExport bool is_const_module2_Module2ConstsLiteralsStruct_cdr_plain(
        eprosima::fastdds::dds::DataRepresentationId_t data_representation)
{
    static_cast<void>(data_representation);
    return false;
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const const_module2::Module2ConstsLiteralsStruct* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_const_module2_Module2ConstsLiteralsStruct_cdr_plain(data_representation) &&
                sizeof(const_module2::Module2ConstsLiteralsStruct) == const_module2_Module2ConstsLiteralsStruct_max_cdr_typesize)
        {
            // Serialize the first element
            // to ensure correct alignment
            scdr.serialize(
            ...
            std::memcpy(
                scdr.get_current_position(),
                array_ptr,
                (array_size - 1) * sizeof(const_module2::Module2ConstsLiteralsStruct));

            scdr.jump((array_size -1) * sizeof(const_module2::Module2ConstsLiteralsStruct));
        }
        else
        {
            scdr.serialize_array(array_ptr, array_size);
...
eProsima_user_DllExport void deserialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const_module2::Module2ConstsLiteralsStruct* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
...
eProsima_user_DllExport bool is_ConstsLiteralsStruct_cdr_plain(
        eprosima::fastdds::dds::DataRepresentationId_t data_representation)
{
    static_cast<void>(data_representation);
    return false;
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const ConstsLiteralsStruct* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_ConstsLiteralsStruct_cdr_plain(data_representation) &&
                sizeof(ConstsLiteralsStruct) == ConstsLiteralsStruct_max_cdr_typesize)
        {
            // Serialize the first element
            // to ensure correct alignment
            scdr.serialize(
            ...
            std::memcpy(
                scdr.get_current_position(),
                array_ptr,
                (array_size - 1) * sizeof(ConstsLiteralsStruct));

            scdr.jump((array_size -1) * sizeof(ConstsLiteralsStruct));
        }
        else
        {
            scdr.serialize_array(array_ptr, array_size);
...
eProsima_user_DllExport void deserialize_array(
        eprosima::fastcdr::Cdr& scdr,
        ConstsLiteralsStruct* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
