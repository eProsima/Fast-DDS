...
{
    const ModuleConstsLiteralsStruct* p_type =
	        static_cast<const ModuleConstsLiteralsStruct*>(data);
        ...
        void* data)
{
    try
    {
        ...
        ModuleConstsLiteralsStruct* p_type =
		        static_cast<ModuleConstsLiteralsStruct*>(data);
...
bool Module2ConstsLiteralsStructPubSubType::serialize(
        ...
        DataRepresentationId_t data_representation)
{
    const Module2ConstsLiteralsStruct* p_type =
	        static_cast<const Module2ConstsLiteralsStruct*>(data);
        ...
        void* data)
{
    ...
    {
        // Convert DATA to pointer of your type
        Module2ConstsLiteralsStruct* p_type =
		        static_cast<Module2ConstsLiteralsStruct*>(data);
