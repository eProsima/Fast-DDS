...
namespace const_module1 {
    ...
    {
        const ::const_module1::ModuleConstsLiteralsStruct* p_type = static_cast<const ::const_module1::ModuleConstsLiteralsStruct*>(data);
            ...
            DataRepresentationId_t data_representation)
    {
        try
        {
            ...
            return static_cast<uint32_t>(calculator.calculate_serialized_size(
                        *static_cast<const ::const_module1::ModuleConstsLiteralsStruct*>(data), current_alignment)) +
                    4u /*encapsulation*/;
        }
        catch (eprosima::fastcdr::exception::Exception& /*exception*/)
        {
...
namespace const_module2 {
    ...
    bool Module2ConstsLiteralsStructPubSubType::serialize(
            ...
            DataRepresentationId_t data_representation)
    {
        const ::const_module2::Module2ConstsLiteralsStruct* p_type = static_cast<const ::const_module2::Module2ConstsLiteralsStruct*>(data);
            ...
            DataRepresentationId_t data_representation)
    {
        try
        {
            ...
            size_t current_alignment {0};
            return static_cast<uint32_t>(calculator.calculate_serialized_size(
                        *static_cast<const ::const_module2::Module2ConstsLiteralsStruct*>(data), current_alignment)) +
                    4u /*encapsulation*/;
        }
        catch (eprosima::fastcdr::exception::Exception& /*exception*/)
        {
