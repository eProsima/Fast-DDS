...
/*!
 * @file enumerationsPubSubTypes.hpp
...
#define FAST_DDS_GENERATED__ENUMERATIONS_IDL_TEST_PUBSUBTYPES_HPP
...
/*!
 * @brief This class represents the TopicDataType of the type BoundedBitMaskStructure defined by the user in the IDL file.
 * @ingroup enumerations
 */
class BoundedBitMaskStructurePubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef BoundedBitMaskStructure type;

    eProsima_user_DllExport BoundedBitMaskStructurePubSubType();
...
/*!
 * @brief This class represents the TopicDataType of the type EnumWithValuesStructure defined by the user in the IDL file.
 * @ingroup enumerations
 */
class EnumWithValuesStructurePubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef EnumWithValuesStructure type;

    eProsima_user_DllExport EnumWithValuesStructurePubSubType();

    eProsima_user_DllExport ~EnumWithValuesStructurePubSubType() override;
...
#endif // FAST_DDS_GENERATED__ENUMERATIONS_IDL_TEST_PUBSUBTYPES_HPP
