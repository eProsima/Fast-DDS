...
{
    const InnerStructureHelper* p_type =
	        static_cast<const InnerStructureHelper*>(data);
        ...
        void* data)
{
    try
    {
        ...
        InnerStructureHelper* p_type =
		        static_cast<InnerStructureHelper*>(data);
...
bool InnerEmptyStructureHelperPubSubType::serialize(
        ...
        DataRepresentationId_t data_representation)
{
    const InnerEmptyStructureHelper* p_type =
	        static_cast<const InnerEmptyStructureHelper*>(data);
        ...
        void* data)
{
    ...
    {
        // Convert DATA to pointer of your type
        InnerEmptyStructureHelper* p_type =
		        static_cast<InnerEmptyStructureHelper*>(data);
