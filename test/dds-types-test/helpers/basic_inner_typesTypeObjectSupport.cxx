...
{
    ReturnCode_t return_code_InnerAliasHelper;
    ...
    if (EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier1()._d() || TK_NONE == type_ids_InnerAliasHelper.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_InnerAliasHelper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier1().seq_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_SEQUENCE_LARGE == type_ids_InnerAliasHelper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier1().seq_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_SMALL == type_ids_InnerAliasHelper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier1().array_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_LARGE == type_ids_InnerAliasHelper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier1().array_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_MAP_SMALL == type_ids_InnerAliasHelper.type_identifier1()._d() &&
            (EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier1().map_sdefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier1().map_sdefn().key_identifier()->_d())) ||
            (TI_PLAIN_MAP_LARGE == type_ids_InnerAliasHelper.type_identifier1()._d() &&
            (EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier1().map_ldefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier1().map_ldefn().key_identifier()->_d())))
    {
        common_InnerAliasHelper = TypeObjectUtils::build_common_alias_body(related_flags_InnerAliasHelper,
                type_ids_InnerAliasHelper.type_identifier1());
    }
    else if (EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_InnerAliasHelper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_SEQUENCE_LARGE == type_ids_InnerAliasHelper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier2().seq_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_SMALL == type_ids_InnerAliasHelper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier2().array_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_LARGE == type_ids_InnerAliasHelper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier2().array_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_MAP_SMALL == type_ids_InnerAliasHelper.type_identifier2()._d() &&
            (EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier2().map_sdefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier2().map_sdefn().key_identifier()->_d())) ||
            (TI_PLAIN_MAP_LARGE == type_ids_InnerAliasHelper.type_identifier2()._d() &&
            (EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier2().map_ldefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_InnerAliasHelper.type_identifier2().map_ldefn().key_identifier()->_d())))
    {
        common_InnerAliasHelper = TypeObjectUtils::build_common_alias_body(related_flags_InnerAliasHelper,
                type_ids_InnerAliasHelper.type_identifier2());
    }
    else
    {
        EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
        ...
        TypeIdentifierPair& type_ids_InnerStructureHelper)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_InnerStructureHelper)
    {
        StructTypeFlag struct_flags_InnerStructureHelper = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::NOT_APPLIED,
                true, false);
        static_cast<void>(return_code_InnerStructureHelper);
        ...
        CompleteStructMemberSeq member_seq_InnerStructureHelper;
        {
            ...
            if (EK_COMPLETE == type_ids_field1.type_identifier1()._d() || TK_NONE == type_ids_field1.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_field1.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_field1.type_identifier1().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_field1.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_field1.type_identifier1().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_field1.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_field1.type_identifier1().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_field1.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_field1.type_identifier1().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_field1.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_field1.type_identifier1().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_field1.type_identifier1().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_field1.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_field1.type_identifier1().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_field1.type_identifier1().map_ldefn().key_identifier()->_d())))
            {
                common_field1 = TypeObjectUtils::build_common_struct_member(member_id_field1,
                        member_flags_field1, type_ids_field1.type_identifier1());
            }
            else if (EK_COMPLETE == type_ids_field1.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_field1.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_field1.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_field1.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_field1.type_identifier2().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_field1.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_field1.type_identifier2().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_field1.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_field1.type_identifier2().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_field1.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_field1.type_identifier2().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_field1.type_identifier2().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_field1.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_field1.type_identifier2().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_field1.type_identifier2().map_ldefn().key_identifier()->_d())))
            {
                common_field1 = TypeObjectUtils::build_common_struct_member(member_id_field1,
                        member_flags_field1, type_ids_field1.type_identifier2());
            }
            else
            {
                EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
        ...
        }
        {
            ...
            if (EK_COMPLETE == type_ids_field2.type_identifier1()._d() || TK_NONE == type_ids_field2.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_field2.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_field2.type_identifier1().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_field2.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_field2.type_identifier1().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_field2.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_field2.type_identifier1().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_field2.type_identifier1()._d() &&
                    EK_COMPLETE == type_ids_field2.type_identifier1().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_field2.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_field2.type_identifier1().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_field2.type_identifier1().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_field2.type_identifier1()._d() &&
                    (EK_COMPLETE == type_ids_field2.type_identifier1().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_field2.type_identifier1().map_ldefn().key_identifier()->_d())))
            {
                common_field2 = TypeObjectUtils::build_common_struct_member(member_id_field2,
                        member_flags_field2, type_ids_field2.type_identifier1());
            }
            else if (EK_COMPLETE == type_ids_field2.type_identifier2()._d() ||
                    (TI_PLAIN_SEQUENCE_SMALL == type_ids_field2.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_field2.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_SEQUENCE_LARGE == type_ids_field2.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_field2.type_identifier2().seq_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_SMALL == type_ids_field2.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_field2.type_identifier2().array_sdefn().header().equiv_kind()) ||
                    (TI_PLAIN_ARRAY_LARGE == type_ids_field2.type_identifier2()._d() &&
                    EK_COMPLETE == type_ids_field2.type_identifier2().array_ldefn().header().equiv_kind()) ||
                    (TI_PLAIN_MAP_SMALL == type_ids_field2.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_field2.type_identifier2().map_sdefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_field2.type_identifier2().map_sdefn().key_identifier()->_d())) ||
                    (TI_PLAIN_MAP_LARGE == type_ids_field2.type_identifier2()._d() &&
                    (EK_COMPLETE == type_ids_field2.type_identifier2().map_ldefn().header().equiv_kind() ||
                    EK_COMPLETE == type_ids_field2.type_identifier2().map_ldefn().key_identifier()->_d())))
            {
                common_field2 = TypeObjectUtils::build_common_struct_member(member_id_field2,
                        member_flags_field2, type_ids_field2.type_identifier2());
            }
            else
            {
                EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
        ...
        TypeIdentifierPair& type_ids_InnerEmptyStructureHelper)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_InnerEmptyStructureHelper)
    {
        StructTypeFlag struct_flags_InnerEmptyStructureHelper = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::NOT_APPLIED,
                true, false);
        static_cast<void>(return_code_InnerEmptyStructureHelper);
...
{
    ReturnCode_t return_code_Inner_alias_bounded_string_helper;
    ...
    if (EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier1()._d() || TK_NONE == type_ids_Inner_alias_bounded_string_helper.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_bounded_string_helper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier1().seq_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_SEQUENCE_LARGE == type_ids_Inner_alias_bounded_string_helper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier1().seq_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_SMALL == type_ids_Inner_alias_bounded_string_helper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier1().array_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_LARGE == type_ids_Inner_alias_bounded_string_helper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier1().array_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_MAP_SMALL == type_ids_Inner_alias_bounded_string_helper.type_identifier1()._d() &&
            (EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier1().map_sdefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier1().map_sdefn().key_identifier()->_d())) ||
            (TI_PLAIN_MAP_LARGE == type_ids_Inner_alias_bounded_string_helper.type_identifier1()._d() &&
            (EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier1().map_ldefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier1().map_ldefn().key_identifier()->_d())))
    {
        common_Inner_alias_bounded_string_helper = TypeObjectUtils::build_common_alias_body(related_flags_Inner_alias_bounded_string_helper,
                type_ids_Inner_alias_bounded_string_helper.type_identifier1());
    }
    else if (EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_bounded_string_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_SEQUENCE_LARGE == type_ids_Inner_alias_bounded_string_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier2().seq_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_SMALL == type_ids_Inner_alias_bounded_string_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier2().array_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_LARGE == type_ids_Inner_alias_bounded_string_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier2().array_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_MAP_SMALL == type_ids_Inner_alias_bounded_string_helper.type_identifier2()._d() &&
            (EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier2().map_sdefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier2().map_sdefn().key_identifier()->_d())) ||
            (TI_PLAIN_MAP_LARGE == type_ids_Inner_alias_bounded_string_helper.type_identifier2()._d() &&
            (EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier2().map_ldefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_Inner_alias_bounded_string_helper.type_identifier2().map_ldefn().key_identifier()->_d())))
    {
        common_Inner_alias_bounded_string_helper = TypeObjectUtils::build_common_alias_body(related_flags_Inner_alias_bounded_string_helper,
                type_ids_Inner_alias_bounded_string_helper.type_identifier2());
    }
    else
    {
        EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
        ...
        TypeIdentifierPair& type_ids_Inner_alias_bounded_wstring_helper)
{
    ...
    if (EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1()._d() || TK_NONE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1().seq_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_SEQUENCE_LARGE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1().seq_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_SMALL == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1().array_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_LARGE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1().array_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_MAP_SMALL == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1()._d() &&
            (EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1().map_sdefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1().map_sdefn().key_identifier()->_d())) ||
            (TI_PLAIN_MAP_LARGE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1()._d() &&
            (EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1().map_ldefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier1().map_ldefn().key_identifier()->_d())))
    {
        common_Inner_alias_bounded_wstring_helper = TypeObjectUtils::build_common_alias_body(related_flags_Inner_alias_bounded_wstring_helper,
                type_ids_Inner_alias_bounded_wstring_helper.type_identifier1());
    }
    else if (EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_SEQUENCE_LARGE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2().seq_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_SMALL == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2().array_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_LARGE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2().array_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_MAP_SMALL == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2()._d() &&
            (EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2().map_sdefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2().map_sdefn().key_identifier()->_d())) ||
            (TI_PLAIN_MAP_LARGE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2()._d() &&
            (EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2().map_ldefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_Inner_alias_bounded_wstring_helper.type_identifier2().map_ldefn().key_identifier()->_d())))
    {
        common_Inner_alias_bounded_wstring_helper = TypeObjectUtils::build_common_alias_body(related_flags_Inner_alias_bounded_wstring_helper,
                type_ids_Inner_alias_bounded_wstring_helper.type_identifier2());
    }
    else
    {
        EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
...
{
    ReturnCode_t return_code_Inner_alias_array_helper;
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Inner_alias_array_helper)
    {
        ...
        if (EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1()._d() || TK_NONE == type_ids_Inner_alias_array_helper.type_identifier2()._d() ||
                (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_array_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1().seq_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_SEQUENCE_LARGE == type_ids_Inner_alias_array_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1().seq_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_SMALL == type_ids_Inner_alias_array_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1().array_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_LARGE == type_ids_Inner_alias_array_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1().array_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_MAP_SMALL == type_ids_Inner_alias_array_helper.type_identifier1()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1().map_sdefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1().map_sdefn().key_identifier()->_d())) ||
                (TI_PLAIN_MAP_LARGE == type_ids_Inner_alias_array_helper.type_identifier1()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1().map_ldefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1().map_ldefn().key_identifier()->_d())))
        {
            element_identifier_anonymous_array_int16_t_2 = new TypeIdentifier(type_ids_Inner_alias_array_helper.type_identifier1());
        }
        else if (EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2()._d() ||
                (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_array_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_SEQUENCE_LARGE == type_ids_Inner_alias_array_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2().seq_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_SMALL == type_ids_Inner_alias_array_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2().array_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_LARGE == type_ids_Inner_alias_array_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2().array_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_MAP_SMALL == type_ids_Inner_alias_array_helper.type_identifier2()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2().map_sdefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2().map_sdefn().key_identifier()->_d())) ||
                (TI_PLAIN_MAP_LARGE == type_ids_Inner_alias_array_helper.type_identifier2()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2().map_ldefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2().map_ldefn().key_identifier()->_d())))
        {
            element_identifier_anonymous_array_int16_t_2 = new TypeIdentifier(type_ids_Inner_alias_array_helper.type_identifier2());
        }
        else
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
    ...
    if (EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1()._d() || TK_NONE == type_ids_Inner_alias_array_helper.type_identifier2()._d() ||
            ...
            EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier1().map_ldefn().key_identifier()->_d())))
    {
        common_Inner_alias_array_helper = TypeObjectUtils::build_common_alias_body(related_flags_Inner_alias_array_helper,
                type_ids_Inner_alias_array_helper.type_identifier1());
    }
    else if (EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_array_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_array_helper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
    ...
    {
        common_Inner_alias_array_helper = TypeObjectUtils::build_common_alias_body(related_flags_Inner_alias_array_helper,
                type_ids_Inner_alias_array_helper.type_identifier2());
    }
    else
    {
        EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
...
{
    ReturnCode_t return_code_Inner_alias_sequence_helper;
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Inner_alias_sequence_helper)
    {
        ...
        if (EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1()._d() || TK_NONE == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() ||
                (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_sequence_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1().seq_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_SEQUENCE_LARGE == type_ids_Inner_alias_sequence_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1().seq_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_SMALL == type_ids_Inner_alias_sequence_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1().array_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_LARGE == type_ids_Inner_alias_sequence_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1().array_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_MAP_SMALL == type_ids_Inner_alias_sequence_helper.type_identifier1()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1().map_sdefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1().map_sdefn().key_identifier()->_d())) ||
                (TI_PLAIN_MAP_LARGE == type_ids_Inner_alias_sequence_helper.type_identifier1()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1().map_ldefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1().map_ldefn().key_identifier()->_d())))
        {
            element_identifier_anonymous_sequence_int16_t_unbounded = new TypeIdentifier(type_ids_Inner_alias_sequence_helper.type_identifier1());
        }
        else if (EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() ||
                (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_SEQUENCE_LARGE == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2().seq_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_SMALL == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2().array_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_LARGE == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2().array_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_MAP_SMALL == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2().map_sdefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2().map_sdefn().key_identifier()->_d())) ||
                (TI_PLAIN_MAP_LARGE == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2().map_ldefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2().map_ldefn().key_identifier()->_d())))
        {
            element_identifier_anonymous_sequence_int16_t_unbounded = new TypeIdentifier(type_ids_Inner_alias_sequence_helper.type_identifier2());
        }
        else
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
    ...
    if (EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1()._d() || TK_NONE == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() ||
            ...
            EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier1().map_ldefn().key_identifier()->_d())))
    {
        common_Inner_alias_sequence_helper = TypeObjectUtils::build_common_alias_body(related_flags_Inner_alias_sequence_helper,
                type_ids_Inner_alias_sequence_helper.type_identifier1());
    }
    else if (EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_sequence_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_sequence_helper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
    ...
    {
        common_Inner_alias_sequence_helper = TypeObjectUtils::build_common_alias_body(related_flags_Inner_alias_sequence_helper,
                type_ids_Inner_alias_sequence_helper.type_identifier2());
    }
    else
    {
        EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
...
{
    ReturnCode_t return_code_Inner_alias_map_helper;
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Inner_alias_map_helper)
    {
        ...
        if (EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1()._d() || TK_NONE == type_ids_Inner_alias_map_helper.type_identifier2()._d() ||
                (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_map_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1().seq_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_SEQUENCE_LARGE == type_ids_Inner_alias_map_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1().seq_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_SMALL == type_ids_Inner_alias_map_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1().array_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_LARGE == type_ids_Inner_alias_map_helper.type_identifier1()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1().array_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_MAP_SMALL == type_ids_Inner_alias_map_helper.type_identifier1()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1().map_sdefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1().map_sdefn().key_identifier()->_d())) ||
                (TI_PLAIN_MAP_LARGE == type_ids_Inner_alias_map_helper.type_identifier1()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1().map_ldefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1().map_ldefn().key_identifier()->_d())))
        {
            element_identifier_anonymous_map_int32_t_int32_t_unbounded = new TypeIdentifier(type_ids_Inner_alias_map_helper.type_identifier1());
        }
        else if (EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2()._d() ||
                (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_map_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_SEQUENCE_LARGE == type_ids_Inner_alias_map_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().seq_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_SMALL == type_ids_Inner_alias_map_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().array_sdefn().header().equiv_kind()) ||
                (TI_PLAIN_ARRAY_LARGE == type_ids_Inner_alias_map_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().array_ldefn().header().equiv_kind()) ||
                (TI_PLAIN_MAP_SMALL == type_ids_Inner_alias_map_helper.type_identifier2()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().map_sdefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().map_sdefn().key_identifier()->_d())) ||
                (TI_PLAIN_MAP_LARGE == type_ids_Inner_alias_map_helper.type_identifier2()._d() &&
                (EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().map_ldefn().header().equiv_kind() ||
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().map_ldefn().key_identifier()->_d())))
        {
            element_identifier_anonymous_map_int32_t_int32_t_unbounded = new TypeIdentifier(type_ids_Inner_alias_map_helper.type_identifier2());
        }
        else
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
        ...
        if (EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1()._d() || TK_NONE == type_ids_Inner_alias_map_helper.type_identifier2()._d() ||
                ...
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1().map_ldefn().key_identifier()->_d())))
        {
            key_identifier_anonymous_map_int32_t_int32_t_unbounded = new TypeIdentifier(type_ids_Inner_alias_map_helper.type_identifier1());
        }
        else if (EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2()._d() ||
                (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_map_helper.type_identifier2()._d() &&
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
                ...
                EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().map_ldefn().key_identifier()->_d())))
        {
            key_identifier_anonymous_map_int32_t_int32_t_unbounded = new TypeIdentifier(type_ids_Inner_alias_map_helper.type_identifier2());
        }
        else
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
    ...
    if (EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1()._d() || TK_NONE == type_ids_Inner_alias_map_helper.type_identifier2()._d() ||
            ...
            EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier1().map_ldefn().key_identifier()->_d())))
    {
        common_Inner_alias_map_helper = TypeObjectUtils::build_common_alias_body(related_flags_Inner_alias_map_helper,
                type_ids_Inner_alias_map_helper.type_identifier1());
    }
    else if (EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_Inner_alias_map_helper.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_Inner_alias_map_helper.type_identifier2().seq_sdefn().header().equiv_kind()) ||
    ...
    {
        common_Inner_alias_map_helper = TypeObjectUtils::build_common_alias_body(related_flags_Inner_alias_map_helper,
                type_ids_Inner_alias_map_helper.type_identifier2());
    }
    else
    {
        EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
...
{
    ReturnCode_t return_code_inner_structure_helper_alias;
    ...
    if (EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier1()._d() || TK_NONE == type_ids_inner_structure_helper_alias.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_inner_structure_helper_alias.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier1().seq_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_SEQUENCE_LARGE == type_ids_inner_structure_helper_alias.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier1().seq_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_SMALL == type_ids_inner_structure_helper_alias.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier1().array_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_LARGE == type_ids_inner_structure_helper_alias.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier1().array_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_MAP_SMALL == type_ids_inner_structure_helper_alias.type_identifier1()._d() &&
            (EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier1().map_sdefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier1().map_sdefn().key_identifier()->_d())) ||
            (TI_PLAIN_MAP_LARGE == type_ids_inner_structure_helper_alias.type_identifier1()._d() &&
            (EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier1().map_ldefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier1().map_ldefn().key_identifier()->_d())))
    {
        common_inner_structure_helper_alias = TypeObjectUtils::build_common_alias_body(related_flags_inner_structure_helper_alias,
                type_ids_inner_structure_helper_alias.type_identifier1());
    }
    else if (EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_inner_structure_helper_alias.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier2().seq_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_SEQUENCE_LARGE == type_ids_inner_structure_helper_alias.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier2().seq_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_SMALL == type_ids_inner_structure_helper_alias.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier2().array_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_LARGE == type_ids_inner_structure_helper_alias.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier2().array_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_MAP_SMALL == type_ids_inner_structure_helper_alias.type_identifier2()._d() &&
            (EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier2().map_sdefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier2().map_sdefn().key_identifier()->_d())) ||
            (TI_PLAIN_MAP_LARGE == type_ids_inner_structure_helper_alias.type_identifier2()._d() &&
            (EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier2().map_ldefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_inner_structure_helper_alias.type_identifier2().map_ldefn().key_identifier()->_d())))
    {
        common_inner_structure_helper_alias = TypeObjectUtils::build_common_alias_body(related_flags_inner_structure_helper_alias,
                type_ids_inner_structure_helper_alias.type_identifier2());
    }
    else
    {
        EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
...
{
    ReturnCode_t return_code_inner_bitset_helper_alias;
    ...
    CommonAliasBody common_inner_bitset_helper_alias;
    if (EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier1()._d() || TK_NONE == type_ids_inner_bitset_helper_alias.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_inner_bitset_helper_alias.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier1().seq_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_SEQUENCE_LARGE == type_ids_inner_bitset_helper_alias.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier1().seq_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_SMALL == type_ids_inner_bitset_helper_alias.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier1().array_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_LARGE == type_ids_inner_bitset_helper_alias.type_identifier1()._d() &&
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier1().array_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_MAP_SMALL == type_ids_inner_bitset_helper_alias.type_identifier1()._d() &&
            (EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier1().map_sdefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier1().map_sdefn().key_identifier()->_d())) ||
            (TI_PLAIN_MAP_LARGE == type_ids_inner_bitset_helper_alias.type_identifier1()._d() &&
            (EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier1().map_ldefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier1().map_ldefn().key_identifier()->_d())))
    {
        common_inner_bitset_helper_alias = TypeObjectUtils::build_common_alias_body(related_flags_inner_bitset_helper_alias,
                type_ids_inner_bitset_helper_alias.type_identifier1());
    }
    else if (EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier2()._d() ||
            (TI_PLAIN_SEQUENCE_SMALL == type_ids_inner_bitset_helper_alias.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier2().seq_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_SEQUENCE_LARGE == type_ids_inner_bitset_helper_alias.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier2().seq_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_SMALL == type_ids_inner_bitset_helper_alias.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier2().array_sdefn().header().equiv_kind()) ||
            (TI_PLAIN_ARRAY_LARGE == type_ids_inner_bitset_helper_alias.type_identifier2()._d() &&
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier2().array_ldefn().header().equiv_kind()) ||
            (TI_PLAIN_MAP_SMALL == type_ids_inner_bitset_helper_alias.type_identifier2()._d() &&
            (EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier2().map_sdefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier2().map_sdefn().key_identifier()->_d())) ||
            (TI_PLAIN_MAP_LARGE == type_ids_inner_bitset_helper_alias.type_identifier2()._d() &&
            (EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier2().map_ldefn().header().equiv_kind() ||
            EK_COMPLETE == type_ids_inner_bitset_helper_alias.type_identifier2().map_ldefn().key_identifier()->_d())))
    {
        common_inner_bitset_helper_alias = TypeObjectUtils::build_common_alias_body(related_flags_inner_bitset_helper_alias,
                type_ids_inner_bitset_helper_alias.type_identifier2());
    }
    else
    {
        EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                "inner_bitset_helper_alias related TypeIdentifier inconsistent.");
        return;
    }
