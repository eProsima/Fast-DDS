...
/*!
 * @file primitivesPubSubTypes.hpp
...
#define FAST_DDS_GENERATED__PRIMITIVES_PUBSUBTYPES_HPP
...
#error \
    Generated primitives is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
/*!
 * @brief This class represents the TopicDataType of the type Uint8Struct defined by the user in the IDL file.
 * @ingroup primitives
 */
class Uint8StructPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ::Uint8Struct type;

    eProsima_user_DllExport Uint8StructPubSubType();
...
/*!
 * @brief This class represents the TopicDataType of the type Int16Struct defined by the user in the IDL file.
 * @ingroup primitives
 */
class Int16StructPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ::Int16Struct type;

    eProsima_user_DllExport Int16StructPubSubType();
...
/*!
 * @brief This class represents the TopicDataType of the type Uint16Struct defined by the user in the IDL file.
 * @ingroup primitives
 */
class Uint16StructPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ::Uint16Struct type;

    eProsima_user_DllExport Uint16StructPubSubType();
...
/*!
 * @brief This class represents the TopicDataType of the type Int32Struct defined by the user in the IDL file.
 * @ingroup primitives
 */
class Int32StructPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ::Int32Struct type;

    eProsima_user_DllExport Int32StructPubSubType();
...
/*!
 * @brief This class represents the TopicDataType of the type Uint32Struct defined by the user in the IDL file.
 * @ingroup primitives
 */
class Uint32StructPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ::Uint32Struct type;

    eProsima_user_DllExport Uint32StructPubSubType();
...
/*!
 * @brief This class represents the TopicDataType of the type Int64Struct defined by the user in the IDL file.
 * @ingroup primitives
 */
class Int64StructPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ::Int64Struct type;

    eProsima_user_DllExport Int64StructPubSubType();
...
/*!
 * @brief This class represents the TopicDataType of the type Uint64Struct defined by the user in the IDL file.
 * @ingroup primitives
 */
class Uint64StructPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ::Uint64Struct type;

    eProsima_user_DllExport Uint64StructPubSubType();
...
#endif // FAST_DDS_GENERATED__PRIMITIVES_PUBSUBTYPES_HPP
