...
{
    setName("RelativePathIncludeStruct");
    uint32_t type_size =
#if FASTCDR_VERSION_MAJOR == 1
        static_cast<uint32_t>(RelativePathIncludeStruct::getMaxCdrSerializedSize());
#else
    ...
    uint32_t keyLength = RelativePathIncludeStruct_max_key_cdr_typesize > 16 ? RelativePathIncludeStruct_max_key_cdr_typesize : 16;
    ...
    return [data, data_representation]() -> uint32_t
           {
               ...
               return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<RelativePathIncludeStruct*>(data))) +
                      4u /*encapsulation*/;
#else
               try
               {
...
void* RelativePathIncludeStructPubSubType::createData()
{
    return reinterpret_cast<void*>(new RelativePathIncludeStruct());
}

void RelativePathIncludeStructPubSubType::deleteData(
        void* data)
{
