...
/*!
 * @file relative_path_includePubSubTypes.cpp
 * This header file contains the implementation of the serialization functions.
 *
 * This file was generated by the tool fastddsgen (version: 4.1.0).
 */

#include "relative_path_includePubSubTypes.hpp"
...
bool is_RelativePathIncludeStruct_cdr_plain(
...
{
    set_name("RelativePathIncludeStruct");
    uint32_t type_size = RelativePathIncludeStruct_max_cdr_typesize;
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    max_serialized_type_size = type_size + 4; /*encapsulation*/
    is_compute_key_provided = false;
    uint32_t key_length = RelativePathIncludeStruct_max_key_cdr_typesize > 16 ? RelativePathIncludeStruct_max_key_cdr_typesize : 16;
...
bool RelativePathIncludeStructPubSubType::deserialize(
        SerializedPayload_t& payload,
        void* data)
{
    try
...
uint32_t RelativePathIncludeStructPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void* RelativePathIncludeStructPubSubType::create_data()
{
    return reinterpret_cast<void*>(new ::RelativePathIncludeStruct());
}

void RelativePathIncludeStructPubSubType::delete_data(
        void* data)
{
    delete(reinterpret_cast<::RelativePathIncludeStruct*>(data));
}

#ifdef TOPIC_DATA_TYPE_API_HAS_IS_PLAIN

    bool RelativePathIncludeStructPubSubType::is_plain(
...
bool RelativePathIncludeStructPubSubType::compute_key(
        SerializedPayload_t& payload,
...
#include "relative_path_includeCdrAux.ipp"
