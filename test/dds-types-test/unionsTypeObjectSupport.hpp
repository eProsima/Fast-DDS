...
#ifndef FAST_DDS_GENERATED__UNIONS_IDL_FIXED_STRING_MODULE_TYPE_OBJECT_SUPPORT_HPP
#define FAST_DDS_GENERATED__UNIONS_IDL_FIXED_STRING_MODULE_TYPE_OBJECT_SUPPORT_HPP
...
eProsima_user_DllExport void register_DefaultAnnotation_type_identifier(
        eprosima::fastdds::dds::xtypes::TypeIdentifierPair& type_ids);
/**
 * @brief Register DefaultAnnotationExternalValue related TypeIdentifier.
 *        Fully-descriptive TypeIdentifiers are directly registered.
 *        Hash TypeIdentifiers require to fill the TypeObject information and hash it, consequently, the TypeObject is
 *        indirectly registered as well.
 *
 ...
 *             Invalid TypeIdentifier is returned in case of error.
 */
eProsima_user_DllExport void register_DefaultAnnotationExternalValue_type_identifier(
        eprosima::fastdds::dds::xtypes::TypeIdentifierPair& type_ids);
/**
 * @brief Register UnionShortExtraMember related TypeIdentifier.
 *        Fully-descriptive TypeIdentifiers are directly registered.
 *        Hash TypeIdentifiers require to fill the TypeObject information and hash it, consequently, the TypeObject is
 *        indirectly registered as well.
 *
...
#endif // FAST_DDS_GENERATED__UNIONS_IDL_FIXED_STRING_MODULE_TYPE_OBJECT_SUPPORT_HPP
