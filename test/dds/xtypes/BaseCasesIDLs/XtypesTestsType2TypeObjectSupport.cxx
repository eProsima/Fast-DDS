        ...
        TypeIdentifierPair& type_ids_Type2)
{
    ...
    ReturnCode_t return_code_Type2 {eprosima::fastdds::dds::RETCODE_OK};
    return_code_Type2 =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "Type2", type_ids_Type2);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_Type2)
    {
        StructTypeFlag struct_flags_Type2 = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        ...
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_Type2, type_name_Type2.to_string(), type_ids_Type2))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
