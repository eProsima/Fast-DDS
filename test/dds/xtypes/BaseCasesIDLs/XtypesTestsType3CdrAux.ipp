...
/*!
 * @file XtypesTestsType3CdrAux.ipp
 * This source file contains some declarations of CDR related functions.
 *
 * This file was generated by the tool fastddsgen (version: 4.1.0).
 */

#ifndef FAST_DDS_GENERATED__XTYPESTESTSTYPE3CDRAUX_IPP
#define FAST_DDS_GENERATED__XTYPESTESTSTYPE3CDRAUX_IPP
...
eProsima_user_DllExport bool is_Type3_cdr_plain(
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_Type3_cdr_plain(data_representation) &&
                sizeof(Type3) == Type3_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(Type3));

            scdr.jump((array_size -1) * sizeof(Type3));
        }
        else
        {
...
#endif // FAST_DDS_GENERATED__XTYPESTESTSTYPE3CDRAUX_IPP
