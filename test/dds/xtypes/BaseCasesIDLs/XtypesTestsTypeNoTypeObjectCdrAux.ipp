...
eProsima_user_DllExport bool is_TypeNoTypeObject_cdr_plain(
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const TypeNoTypeObject* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_TypeNoTypeObject_cdr_plain(data_representation) &&
                sizeof(TypeNoTypeObject) == TypeNoTypeObject_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(TypeNoTypeObject));

            scdr.jump((array_size -1) * sizeof(TypeNoTypeObject));
        }
        else
        {
