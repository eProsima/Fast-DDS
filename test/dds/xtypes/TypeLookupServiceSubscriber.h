...
private:
    ...
    void create_type_creator_functions()
    {
        ...
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(FixMix);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(FixId);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(FixHexId);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(FixHashidDefault);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(FixHashid);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(DerivedEmptyAutoidSequential);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(DerivedAutoidSequential);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(DerivedAutoidHash);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(DerivedAutoidDefault);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(AutoidSequential);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(AutoidHash);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(AutoidDefault);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringWString);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringWChar);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringUShort);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringULongLong);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringULong);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringString);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringShort);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringOctet);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringLongLong);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringLongDouble);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringLong);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerUnionHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerStructureHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerEnumHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerBitsetHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerBitMaskHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasSequenceHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasMapHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasBoundedWStringHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasBoundedStringHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasArrayHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringFloat);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringDouble);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringChar);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapWStringBoolean);
        ...
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperWString);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperWChar);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperUShort);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperULongLong);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperULong);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperString);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperShort);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperOctet);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperLongLong);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperLongDouble);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperLong);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerUnionHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerStructureHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerEnumHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerBitsetHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerBitMaskHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasSequenceHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasMapHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasBoundedWStringHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasBoundedStringHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasArrayHelper);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperFloat);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperDouble);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperChar);
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperBoolean);
        ...
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(wchar_external);
        types_without_typeobject_.insert("wchar_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(ushort_external);
        types_without_typeobject_.insert("ushort_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(ulonglong_external);
        types_without_typeobject_.insert("ulonglong_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(ulong_external);
        types_without_typeobject_.insert("ulong_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(struct_external_optional);
        types_without_typeobject_.insert("struct_external_optional");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(struct_external);
        types_without_typeobject_.insert("struct_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(string_unbounded_external);
        types_without_typeobject_.insert("string_unbounded_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(string_bounded_external);
        types_without_typeobject_.insert("string_bounded_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(short_external);
        types_without_typeobject_.insert("short_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(sequence_short_external);
        types_without_typeobject_.insert("sequence_short_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(recursive_union_container);
        types_without_typeobject_.insert("recursive_union_container");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(recursive_test_2);
        types_without_typeobject_.insert("recursive_test_2");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(recursive_test_1);
        types_without_typeobject_.insert("recursive_test_1");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(recursive_structure);
        types_without_typeobject_.insert("recursive_structure");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(octet_external);
        types_without_typeobject_.insert("octet_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(map_short_external);
        types_without_typeobject_.insert("map_short_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(longlong_external);
        types_without_typeobject_.insert("longlong_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(longdouble_external);
        types_without_typeobject_.insert("longdouble_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(long_external);
        types_without_typeobject_.insert("long_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(float_external);
        types_without_typeobject_.insert("float_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(ext_struct_external);
        types_without_typeobject_.insert("ext_struct_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(ext_and_inner_struct_external);
        types_without_typeobject_.insert("ext_and_inner_struct_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(double_external);
        types_without_typeobject_.insert("double_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(char_external);
        types_without_typeobject_.insert("char_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(boolean_external);
        types_without_typeobject_.insert("boolean_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(array_short_external);
        types_without_typeobject_.insert("array_short_external");
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(InnerStructExternal);
        types_without_typeobject_.insert("InnerStructExternal");
        ...
        SUBSCRIBER_TYPE_CREATOR_FUNCTION(AnnotatedStruct);
