...
void BasicStructPubSubType::register_type_object_representation() const
{
...
void ComplexStructPubSubType::register_type_object_representation() const
{
    register_Test_type_objects();
}
...
void CompleteStructPubSubType::register_type_object_representation() const
{
    register_Test_type_objects();
}
...
void KeyedStructPubSubType::register_type_object_representation() const
{
    register_Test_type_objects();
}
