...
echo "[router] Network config applied. Keeping container alive for 7 seconds and then changing WAN IP..."
sleep 7s
bash ${TCP_KA_DIR}/change_wan_ip_sim.sh
echo "WAN IP modified."
