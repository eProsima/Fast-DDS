...
echo "[router] Network config applied. Keeping container alive for 7 seconds and then unplugging WAN interface..."
sleep 7s
bash ${TCP_KA_DIR}/unplug_sim.sh
echo "WAN interface unplugged."
sleep 3s
bash ${TCP_KA_DIR}/unplug_sim.sh
echo "WAN interface plugged back."
