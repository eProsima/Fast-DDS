...
void LatencyTestPublisher::run()
{
	...
	if (n_export_csv)
    {
		...
		outFile.open("perf_LatencyTest_minimum" + str_reliable + ".csv");
		outFile << output_file_minimum.str();
		outFile.close();
		outFile.open("perf_LatencyTest_average" + str_reliable + ".csv");
		outFile << output_file_average.str();
		outFile.close();
		outFile.open("perf_LatencyTest_16" + str_reliable + ".csv");
		outFile << output_file_16.str();
		outFile.close();
		outFile.open("perf_LatencyTest_32" + str_reliable + ".csv");
		outFile << output_file_32.str();
		outFile.close();
		outFile.open("perf_LatencyTest_64" + str_reliable + ".csv");
		outFile << output_file_64.str();
		outFile.close();
		outFile.open("perf_LatencyTest_128" + str_reliable + ".csv");
		outFile << output_file_128.str();
		outFile.close();
		outFile.open("perf_LatencyTest_256" + str_reliable + ".csv");
		outFile << output_file_256.str();
		outFile.close();
		outFile.open("perf_LatencyTest_512" + str_reliable + ".csv");
		outFile << output_file_512.str();
		outFile.close();
		outFile.open("perf_LatencyTest_1024" + str_reliable + ".csv");
		outFile << output_file_1024.str();
		outFile.close();
		outFile.open("perf_LatencyTest_2048" + str_reliable + ".csv");
		outFile << output_file_2048.str();
		outFile.close();
		outFile.open("perf_LatencyTest_4096" + str_reliable + ".csv");
		outFile << output_file_4096.str();
		outFile.close();
		outFile.open("perf_LatencyTest_8192" + str_reliable + ".csv");
		outFile << output_file_8192.str();
		outFile.close();
		outFile.open("perf_LatencyTest_16384" + str_reliable + ".csv");
