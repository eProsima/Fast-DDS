...
#ifndef _ALLOCTESTTYPE_H_
#define _ALLOCTESTTYPE_H_
...
public:
     ...
     */
    eProsima_user_DllExport AllocTestType(const AllocTestType &x);
    
    /*!
     * @brief Move constructor.
     * @param x Reference to the object AllocTestType that will be copied.
     */
    eProsima_user_DllExport AllocTestType(AllocTestType &&x);
    
    /*!
     * @brief Copy assignment.
     * @param x Reference to the object AllocTestType that will be copied.
     */
    eProsima_user_DllExport AllocTestType& operator=(const AllocTestType &x);
    
    /*!
     * @brief Move assignment.
     * @param x Reference to the object AllocTestType that will be copied.
     */
    eProsima_user_DllExport AllocTestType& operator=(AllocTestType &&x);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const AllocTestType& data, size_t current_alignment = 0);
