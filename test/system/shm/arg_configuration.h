...
#ifndef _EPROSIMA_FASTDDS_EXAMPLES_CPP_DDS_SHMRECOVERYTEST_ARG_CONFIGURATION_H_
#define _EPROSIMA_FASTDDS_EXAMPLES_CPP_DDS_SHMRECOVERYTEST_ARG_CONFIGURATION_H_
...
const option::Descriptor usage[] = {
    { UNKNOWN_OPT, 0, "", "",                Arg::None,
      "Usage: SHMExample <publisher|subscriber>\n\nGeneral options:" },
...
#endif /* _EPROSIMA_FASTDDS_EXAMPLES_CPP_DDS_SHMRECOVERYTEST_ARG_CONFIGURATION_H_ */
