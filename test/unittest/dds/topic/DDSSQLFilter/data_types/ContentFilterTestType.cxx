...
{
    // m_char_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5cdd8682
    m_char_field = 0;
    // m_uint8_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@799d4f69
    m_uint8_field = 0;
    // m_int16_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49c43f4e
    m_int16_field = 0;
    // m_uint16_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@290dbf45
    m_uint16_field = 0;
    // m_int32_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69a10787
    m_int32_field = 0;
    // m_uint32_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2d127a61
    m_uint32_field = 0;
    // m_int64_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2bbaf4f0
    m_int64_field = 0;
    // m_uint64_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11c20519
    m_uint64_field = 0;
    // m_float_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@70beb599
    m_float_field = 0.0;
    // m_double_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4e41089d
    m_double_field = 0.0;
    // m_long_double_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32a068d1
    m_long_double_field = 0.0;
    // m_bool_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@33cb5951
    m_bool_field = false;
    // m_string_field com.eprosima.idl.parser.typecode.StringTypeCode@365c30cc
    m_string_field ="";
    // m_enum_field com.eprosima.idl.parser.typecode.EnumTypeCode@701fc37a
    m_enum_field = ::RED;
    // m_enum2_field com.eprosima.idl.parser.typecode.EnumTypeCode@4148db48
    m_enum2_field = ::WOOD;
...
{
    // m_char_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6ee12bac
    m_char_field = 0;
    // m_uint8_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@400cff1a
    m_uint8_field = 0;
    // m_int16_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@275710fc
    m_int16_field = 0;
    // m_uint16_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@525f1e4e
    m_uint16_field = 0;
    // m_int32_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4de5031f
    m_int32_field = 0;
    // m_uint32_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@67e2d983
    m_uint32_field = 0;
    // m_int64_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5d47c63f
    m_int64_field = 0;
    // m_uint64_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5ea434c8
    m_uint64_field = 0;
    // m_float_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3bbc39f8
    m_float_field = 0.0;
    // m_double_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4ae3c1cd
    m_double_field = 0.0;
    // m_long_double_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@29f69090
    m_long_double_field = 0.0;
    // m_bool_field com.eprosima.idl.parser.typecode.PrimitiveTypeCode@568bf312
    m_bool_field = false;
    // m_string_field com.eprosima.idl.parser.typecode.StringTypeCode@ca263c2
    m_string_field ="";
    // m_enum_field com.eprosima.idl.parser.typecode.EnumTypeCode@701fc37a
    m_enum_field = ::RED;
    // m_enum2_field com.eprosima.idl.parser.typecode.EnumTypeCode@4148db48
    m_enum2_field = ::WOOD;
    // m_struct_field com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@589b3632

    // m_array_char_field com.eprosima.idl.parser.typecode.ArrayTypeCode@45f45fa1
    memset(&m_array_char_field, 0, (max_array_size) * 1);
    // m_array_uint8_field com.eprosima.idl.parser.typecode.ArrayTypeCode@4c6e276e
    memset(&m_array_uint8_field, 0, (max_array_size) * 1);
    // m_array_int16_field com.eprosima.idl.parser.typecode.ArrayTypeCode@534df152
    memset(&m_array_int16_field, 0, (max_array_size) * 2);
    // m_array_uint16_field com.eprosima.idl.parser.typecode.ArrayTypeCode@52e677af
    memset(&m_array_uint16_field, 0, (max_array_size) * 2);
    // m_array_int32_field com.eprosima.idl.parser.typecode.ArrayTypeCode@35083305
    memset(&m_array_int32_field, 0, (max_array_size) * 4);
    // m_array_uint32_field com.eprosima.idl.parser.typecode.ArrayTypeCode@8e0379d
    memset(&m_array_uint32_field, 0, (max_array_size) * 4);
    // m_array_int64_field com.eprosima.idl.parser.typecode.ArrayTypeCode@341b80b2
    memset(&m_array_int64_field, 0, (max_array_size) * 8);
    // m_array_uint64_field com.eprosima.idl.parser.typecode.ArrayTypeCode@55a1c291
    memset(&m_array_uint64_field, 0, (max_array_size) * 8);
    // m_array_float_field com.eprosima.idl.parser.typecode.ArrayTypeCode@40e6dfe1
    memset(&m_array_float_field, 0, (max_array_size) * 4);
    // m_array_double_field com.eprosima.idl.parser.typecode.ArrayTypeCode@1b083826
    memset(&m_array_double_field, 0, (max_array_size) * 8);
    // m_array_long_double_field com.eprosima.idl.parser.typecode.ArrayTypeCode@105fece7
    memset(&m_array_long_double_field, 0, (max_array_size) * 16);
    // m_array_bool_field com.eprosima.idl.parser.typecode.ArrayTypeCode@3ec300f1
    memset(&m_array_bool_field, 0, (max_array_size) * 1);
    // m_array_string_field com.eprosima.idl.parser.typecode.ArrayTypeCode@482cd91f

    // m_array_enum_field com.eprosima.idl.parser.typecode.ArrayTypeCode@123f1134
    memset(&m_array_enum_field, 0, (max_array_size) * 4);
    // m_array_enum2_field com.eprosima.idl.parser.typecode.ArrayTypeCode@7d68ef40
    memset(&m_array_enum2_field, 0, (max_array_size) * 4);
    // m_array_struct_field com.eprosima.idl.parser.typecode.ArrayTypeCode@5b0abc94

    // m_bounded_sequence_char_field com.eprosima.idl.parser.typecode.SequenceTypeCode@25b485ba

    // m_bounded_sequence_uint8_field com.eprosima.idl.parser.typecode.SequenceTypeCode@2b546384

    // m_bounded_sequence_int16_field com.eprosima.idl.parser.typecode.SequenceTypeCode@5d740a0f

    // m_bounded_sequence_uint16_field com.eprosima.idl.parser.typecode.SequenceTypeCode@214b199c

    // m_bounded_sequence_int32_field com.eprosima.idl.parser.typecode.SequenceTypeCode@20d3d15a

    // m_bounded_sequence_uint32_field com.eprosima.idl.parser.typecode.SequenceTypeCode@2893de87

    // m_bounded_sequence_int64_field com.eprosima.idl.parser.typecode.SequenceTypeCode@55ca8de8

    // m_bounded_sequence_uint64_field com.eprosima.idl.parser.typecode.SequenceTypeCode@2c34f934

    // m_bounded_sequence_float_field com.eprosima.idl.parser.typecode.SequenceTypeCode@12d3a4e9

    // m_bounded_sequence_double_field com.eprosima.idl.parser.typecode.SequenceTypeCode@240237d2

    // m_bounded_sequence_long_double_field com.eprosima.idl.parser.typecode.SequenceTypeCode@25a65b77

    // m_bounded_sequence_bool_field com.eprosima.idl.parser.typecode.SequenceTypeCode@2ed0fbae

    // m_bounded_sequence_string_field com.eprosima.idl.parser.typecode.SequenceTypeCode@212bf671

    // m_bounded_sequence_enum_field com.eprosima.idl.parser.typecode.SequenceTypeCode@14a2f921

    // m_bounded_sequence_enum2_field com.eprosima.idl.parser.typecode.SequenceTypeCode@3c87521

    // m_bounded_sequence_struct_field com.eprosima.idl.parser.typecode.SequenceTypeCode@2aece37d

    // m_unbounded_sequence_char_field com.eprosima.idl.parser.typecode.SequenceTypeCode@548a102f

    // m_unbounded_sequence_uint8_field com.eprosima.idl.parser.typecode.SequenceTypeCode@5762806e

    // m_unbounded_sequence_int16_field com.eprosima.idl.parser.typecode.SequenceTypeCode@17c386de

    // m_unbounded_sequence_uint16_field com.eprosima.idl.parser.typecode.SequenceTypeCode@5af97850

    // m_unbounded_sequence_int32_field com.eprosima.idl.parser.typecode.SequenceTypeCode@5ef60048

    // m_unbounded_sequence_uint32_field com.eprosima.idl.parser.typecode.SequenceTypeCode@1d548a08

    // m_unbounded_sequence_int64_field com.eprosima.idl.parser.typecode.SequenceTypeCode@16aa0a0a

    // m_unbounded_sequence_uint64_field com.eprosima.idl.parser.typecode.SequenceTypeCode@780cb77

    // m_unbounded_sequence_float_field com.eprosima.idl.parser.typecode.SequenceTypeCode@691a7f8f

    // m_unbounded_sequence_double_field com.eprosima.idl.parser.typecode.SequenceTypeCode@50a7bc6e

    // m_unbounded_sequence_long_double_field com.eprosima.idl.parser.typecode.SequenceTypeCode@161b062a

    // m_unbounded_sequence_bool_field com.eprosima.idl.parser.typecode.SequenceTypeCode@17c1bced

    // m_unbounded_sequence_string_field com.eprosima.idl.parser.typecode.SequenceTypeCode@2d9d4f9d

    // m_unbounded_sequence_enum_field com.eprosima.idl.parser.typecode.SequenceTypeCode@4034c28c

    // m_unbounded_sequence_enum2_field com.eprosima.idl.parser.typecode.SequenceTypeCode@e50a6f6

    // m_unbounded_sequence_struct_field com.eprosima.idl.parser.typecode.SequenceTypeCode@14ec4505
