...
/*!
 * @file ContentFilterTestTypePubSubTypes.cpp
...
ContentFilterTestTypePubSubType::ContentFilterTestTypePubSubType()
{
    ...
    auto type_size = ContentFilterTestType::getMaxCdrSerializedSize();
    type_size += eprosima::fastcdr::Cdr::alignment(type_size, 4); /* possible submessage alignment */
    m_typeSize = static_cast<uint32_t>(type_size) + 4; /*encapsulation*/
    m_isGetKeyDefined = ContentFilterTestType::isKeyDefined();
    size_t keyLength = ContentFilterTestType::getKeyMaxCdrSerializedSize() > 16 ?
            ContentFilterTestType::getKeyMaxCdrSerializedSize() : 16;
    m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
    memset(m_keyBuffer, 0, keyLength);
}
...
bool ContentFilterTestTypePubSubType::deserialize(
        SerializedPayload_t* payload,
        void* data)
{
    //Convert DATA to pointer of your type
        ...
        void* data)
{
    return [data]() -> uint32_t
           {
               return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<ContentFilterTestType*>(data))) +
                      4u /*encapsulation*/;
           };
}

void* ContentFilterTestTypePubSubType::createData()
{
    return reinterpret_cast<void*>(new ContentFilterTestType());
}

void ContentFilterTestTypePubSubType::deleteData(
        void* data)
{
        ...
        bool force_md5)
{
    ...
    // Object that manages the raw buffer.
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
            ContentFilterTestType::getKeyMaxCdrSerializedSize());

    // Object that serializes the data.
    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);
    p_type->serializeKey(ser);
    if (force_md5 || ContentFilterTestType::getKeyMaxCdrSerializedSize() > 16)
    {
        m_md5.init();
        m_md5.update(m_keyBuffer, static_cast<unsigned int>(ser.getSerializedDataLength()));
        m_md5.finalize();
