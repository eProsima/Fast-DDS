...
#define StructType_max_cdr_typesize 416ULL;

#define ContentFilterTestType_max_cdr_typesize 89072ULL;
        ...
        size_t current_alignment)
{
    ...
    current_alignment += 4 + eprosima::fastcdr::Cdr::alignment(current_alignment, 4) + data.alias_string_field().size() + 1;
        ...
        eprosima::fastcdr::Cdr& scdr) const
{
    ...
    scdr << m_alias_string_field.c_str();
        ...
        eprosima::fastcdr::Cdr& dcdr)
{
...

    {
        std::string aux;
        dcdr >> aux;
        m_alias_string_field = aux.c_str();
    }
...
ContentFilterTestType::ContentFilterTestType()
{
    ...
    // /type_d() m_array_string_field

    // alias_string m_array_alias_string_field
    ...
    // sequence<long double, max_seq_size> m_bounded_sequence_long_double_field

    // sequence<boolean, max_seq_size> m_bounded_sequence_bool_field

    // sequence</type_d(), max_seq_size> m_bounded_sequence_string_field

    // sequence<alias_string, max_seq_size> m_bounded_sequence_alias_string_field

    // sequence<Color, max_seq_size> m_bounded_sequence_enum_field

    // sequence<Material, max_seq_size> m_bounded_sequence_enum2_field

    // sequence<StructType, max_seq_size> m_bounded_sequence_struct_field
    ...
    // sequence</type_d()> m_unbounded_sequence_string_field

    // sequence<alias_string> m_unbounded_sequence_alias_string_field
        ...
        size_t current_alignment)
{
    ...
    for(size_t a = 0; a < data.array_alias_string_field().size(); ++a)
    {
            current_alignment += 4 + eprosima::fastcdr::Cdr::alignment(current_alignment, 4) + data.array_alias_string_field().at(a).size() + 1;
    ...
    {
        current_alignment += (data.bounded_sequence_long_double_field().size() * 16) + eprosima::fastcdr::Cdr::alignment(current_alignment, 8); // 128 bits, but aligned as 64
    }
    ...
    for(size_t a = 0; a < data.bounded_sequence_alias_string_field().size(); ++a)
    {
        current_alignment += 4 + eprosima::fastcdr::Cdr::alignment(current_alignment, 4) +
            data.bounded_sequence_alias_string_field().at(a).size() + 1;
    }
    ...
    {
        current_alignment += (data.unbounded_sequence_long_double_field().size() * 16) + eprosima::fastcdr::Cdr::alignment(current_alignment, 8); // 128 bits, but aligned as 64
    }
    ...
    for(size_t a = 0; a < data.unbounded_sequence_alias_string_field().size(); ++a)
    {
        current_alignment += 4 + eprosima::fastcdr::Cdr::alignment(current_alignment, 4) +
            data.unbounded_sequence_alias_string_field().at(a).size() + 1;
    }
        ...
        eprosima::fastcdr::Cdr& scdr) const
{
    ...
    for (const auto& str : m_array_alias_string_field)
    {
        scdr << str.c_str();
    }
    ...
    {
        scdr << static_cast<uint32_t>(m_bounded_sequence_alias_string_field.size());

        for (const auto& item : m_bounded_sequence_alias_string_field)
        {
            scdr << item.c_str();
        }
    }
    ...
    {
        scdr << static_cast<uint32_t>(m_unbounded_sequence_alias_string_field.size());

        for (const auto& item : m_unbounded_sequence_alias_string_field)
        {
            scdr << item.c_str();
        }
    }
        ...
        eprosima::fastcdr::Cdr& dcdr)
{
    ...
    for (auto& str : m_array_alias_string_field)
    {
        {
            std::string aux_str;
            dcdr >> aux_str;
...

    {
        ...
        dcdr >> sequence_size;
        m_bounded_sequence_alias_string_field.resize(sequence_size);

        for (auto& item : m_bounded_sequence_alias_string_field)
        {
            std::string s;
            dcdr >> s;
            item = s.c_str();
...

    {
        uint32_t sequence_size = 0;
        dcdr >> sequence_size;
        m_unbounded_sequence_alias_string_field.resize(sequence_size);

        for (auto& item : m_unbounded_sequence_alias_string_field)
        {
            std::string s;
            dcdr >> s;
            item = s.c_str();
