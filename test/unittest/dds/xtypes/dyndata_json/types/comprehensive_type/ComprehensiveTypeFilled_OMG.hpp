...
#ifndef EXPECTED_JSON_COMPREHENSIVE_FILLED_OMG_HPP
#define EXPECTED_JSON_COMPREHENSIVE_FILLED_OMG_HPP

#include <string>

std::string expected_json_comprehensive_filled_omg = R"({
    "complex_array": [
        {
            "bitmask_sequence": [],
            "complex_union": {
...
#endif // EXPECTED_JSON_COMPREHENSIVE_FILLED_OMG_HPP
