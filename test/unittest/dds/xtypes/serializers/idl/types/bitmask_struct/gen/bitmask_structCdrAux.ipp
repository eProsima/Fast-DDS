...
eProsima_user_DllExport bool is_BitmaskStruct_cdr_plain(
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_BitmaskStruct_cdr_plain(data_representation) &&
                sizeof(BitmaskStruct) == BitmaskStruct_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(BitmaskStruct));

            scdr.jump((array_size -1) * sizeof(BitmaskStruct));
        }
        else
        {
