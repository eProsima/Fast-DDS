...
bool is_BitsetStruct_cdr_plain(
...
{
    set_name("BitsetStruct");
    uint32_t type_size = BitsetStruct_max_cdr_typesize;
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    max_serialized_type_size = type_size + 4; /*encapsulation*/
    is_compute_key_provided = false;
    uint32_t key_length = BitsetStruct_max_key_cdr_typesize > 16 ? BitsetStruct_max_key_cdr_typesize : 16;
...
uint32_t BitsetStructPubSubType::calculate_serialized_size(
        const void* const data,
        DataRepresentationId_t data_representation)
{
    try
...
void* BitsetStructPubSubType::create_data()
{
    return reinterpret_cast<void*>(new ::BitsetStruct());
}

void BitsetStructPubSubType::delete_data(
        void* data)
{
    ...
    bool BitsetStructPubSubType::is_plain(
...
bool BitsetStructPubSubType::compute_key(
        SerializedPayload_t& payload,
