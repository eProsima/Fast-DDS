...
void register_bitmask_struct_type_identifier(
        TypeIdentifierPair& type_ids_bitmask_struct)
{

    ReturnCode_t return_code_bitmask_struct {eprosima::fastdds::dds::RETCODE_OK};
    return_code_bitmask_struct =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "bitmask_struct", type_ids_bitmask_struct);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_bitmask_struct)
    {
        StructTypeFlag struct_flags_bitmask_struct = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_bitmask_struct = "bitmask_struct";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_bitmask_struct;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_bitmask_struct;
        CompleteTypeDetail detail_bitmask_struct = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_bitmask_struct, ann_custom_bitmask_struct, type_name_bitmask_struct.to_string());
        CompleteStructHeader header_bitmask_struct;
        header_bitmask_struct = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_bitmask_struct);
        CompleteStructMemberSeq member_seq_bitmask_struct;
        {
            ...
            ann_custom_bitmask_struct.reset();
            CompleteMemberDetail detail_my_bitmask = TypeObjectUtils::build_complete_member_detail(name_my_bitmask, member_ann_builtin_my_bitmask, ann_custom_bitmask_struct);
            CompleteStructMember member_my_bitmask = TypeObjectUtils::build_complete_struct_member(common_my_bitmask, detail_my_bitmask);
            TypeObjectUtils::add_complete_struct_member(member_seq_bitmask_struct, member_my_bitmask);
        }
        CompleteStructType struct_type_bitmask_struct = TypeObjectUtils::build_complete_struct_type(struct_flags_bitmask_struct, header_bitmask_struct, member_seq_bitmask_struct);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_bitmask_struct, type_name_bitmask_struct.to_string(), type_ids_bitmask_struct))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "bitmask_struct already registered in TypeObjectRegistry for a different type.");
        }
    }
}
