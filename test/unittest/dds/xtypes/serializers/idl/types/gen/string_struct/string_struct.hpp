...
/*!
 * @brief This class represents the structure string_struct defined by the user in the IDL file.
...
public:
     ...
     */
    eProsima_user_DllExport string_struct()
    {
    }
     ...
     * @param x Reference to the object string_struct that will be copied.
     */
    eProsima_user_DllExport string_struct(
            const string_struct& x)
    {
     ...
     * @param x Reference to the object string_struct that will be copied.
     */
    eProsima_user_DllExport string_struct& operator =(
            const string_struct& x)
    {
     ...
     * @param x string_struct object to compare.
     */
    eProsima_user_DllExport bool operator ==(
            const string_struct& x) const
    {
