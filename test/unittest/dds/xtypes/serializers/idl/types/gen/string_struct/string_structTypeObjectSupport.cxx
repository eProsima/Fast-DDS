...
void register_string_struct_type_identifier(
        TypeIdentifierPair& type_ids_string_struct)
{

    ReturnCode_t return_code_string_struct {eprosima::fastdds::dds::RETCODE_OK};
    return_code_string_struct =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "string_struct", type_ids_string_struct);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_string_struct)
    {
        StructTypeFlag struct_flags_string_struct = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_string_struct = "string_struct";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_string_struct;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_string_struct;
        CompleteTypeDetail detail_string_struct = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_string_struct, ann_custom_string_struct, type_name_string_struct.to_string());
        CompleteStructHeader header_string_struct;
        header_string_struct = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_string_struct);
        CompleteStructMemberSeq member_seq_string_struct;
        {
            ...
            ann_custom_string_struct.reset();
            CompleteMemberDetail detail_my_string = TypeObjectUtils::build_complete_member_detail(name_my_string, member_ann_builtin_my_string, ann_custom_string_struct);
            CompleteStructMember member_my_string = TypeObjectUtils::build_complete_struct_member(common_my_string, detail_my_string);
            TypeObjectUtils::add_complete_struct_member(member_seq_string_struct, member_my_string);
        }
        {
            ...
            ann_custom_string_struct.reset();
            CompleteMemberDetail detail_my_wstring = TypeObjectUtils::build_complete_member_detail(name_my_wstring, member_ann_builtin_my_wstring, ann_custom_string_struct);
            CompleteStructMember member_my_wstring = TypeObjectUtils::build_complete_struct_member(common_my_wstring, detail_my_wstring);
            TypeObjectUtils::add_complete_struct_member(member_seq_string_struct, member_my_wstring);
        }
        {
            ...
            ann_custom_string_struct.reset();
            CompleteMemberDetail detail_my_bounded_string = TypeObjectUtils::build_complete_member_detail(name_my_bounded_string, member_ann_builtin_my_bounded_string, ann_custom_string_struct);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_string_struct, member_my_bounded_string);
        }
        {
            ...
            ann_custom_string_struct.reset();
            CompleteMemberDetail detail_my_bounded_wstring = TypeObjectUtils::build_complete_member_detail(name_my_bounded_wstring, member_ann_builtin_my_bounded_wstring, ann_custom_string_struct);
            ...
            TypeObjectUtils::add_complete_struct_member(member_seq_string_struct, member_my_bounded_wstring);
        }
        CompleteStructType struct_type_string_struct = TypeObjectUtils::build_complete_struct_type(struct_flags_string_struct, header_string_struct, member_seq_string_struct);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_string_struct, type_name_string_struct.to_string(), type_ids_string_struct))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "string_struct already registered in TypeObjectRegistry for a different type.");
        }
    }
}
