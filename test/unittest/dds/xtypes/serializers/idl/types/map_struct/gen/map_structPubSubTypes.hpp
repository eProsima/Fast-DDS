...
/*!
 * @file map_structPubSubTypes.hpp
...
#ifndef FAST_DDS_GENERATED__MAP_STRUCT_IDL_PUBSUBTYPES_HPP
#define FAST_DDS_GENERATED__MAP_STRUCT_IDL_PUBSUBTYPES_HPP
...
/*!
 * @brief This class represents the TopicDataType of the type ValueStruct defined by the user in the IDL file.
 * @ingroup map_struct
 */
class ValueStructPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ValueStruct type;

    eProsima_user_DllExport ValueStructPubSubType();

    eProsima_user_DllExport ~ValueStructPubSubType() override;
...
#endif // FAST_DDS_GENERATED__MAP_STRUCT_IDL_PUBSUBTYPES_HPP
