...
/*!
 * @file struct_structPubSubTypes.hpp
...
#error \
    Generated struct_struct is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
#endif // FAST_DDS_GENERATED__STRUCT_STRUCT_PUBSUBTYPES_HPP
