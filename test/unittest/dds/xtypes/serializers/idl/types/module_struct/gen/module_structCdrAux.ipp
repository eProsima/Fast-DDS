...
#ifndef FAST_DDS_GENERATED__MODULE_STRUCT_IDL_TRIALMODULE_UNIONMODULECDRAUX_IPP
        ...
        ModuleStruct& data)
{
        ...
        data.bitmask_member(0);

        data.enum_member(TrialModule::EnumModule::EnumType::VALUE_ONE);
