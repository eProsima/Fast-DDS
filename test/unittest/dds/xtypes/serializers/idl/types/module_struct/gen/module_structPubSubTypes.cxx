...
namespace TrialModule {
    namespace StructModule {
        ...
        {
            const ::TrialModule::StructModule::StructType* p_type = static_cast<const ::TrialModule::StructModule::StructType*>(data);
                ...
                DataRepresentationId_t data_representation)
        {
            try
            {
                ...
                return static_cast<uint32_t>(calculator.calculate_serialized_size(
                            *static_cast<const ::TrialModule::StructModule::StructType*>(data), current_alignment)) +
                        4u /*encapsulation*/;
            }
            catch (eprosima::fastcdr::exception::Exception& /*exception*/)
            {
