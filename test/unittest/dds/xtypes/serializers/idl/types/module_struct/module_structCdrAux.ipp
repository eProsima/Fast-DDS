...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const TrialModule::BitsetModule::BitsetType* array_ptr,
...
eProsima_user_DllExport void deserialize_array(
        eprosima::fastcdr::Cdr& scdr,
        TrialModule::BitsetModule::BitsetType* array_ptr,
        const std::size_t array_size)
{
...
eProsima_user_DllExport bool is_TrialModule_StructModule_StructType_cdr_plain(
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const TrialModule::StructModule::StructType* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_TrialModule_StructModule_StructType_cdr_plain(data_representation) &&
                sizeof(TrialModule::StructModule::StructType) == TrialModule_StructModule_StructType_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(TrialModule::StructModule::StructType));

            scdr.jump((array_size -1) * sizeof(TrialModule::StructModule::StructType));
        }
        else
        {
            scdr.serialize_array(array_ptr, array_size);
...
eProsima_user_DllExport void deserialize_array(
        eprosima::fastcdr::Cdr& scdr,
        TrialModule::StructModule::StructType* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const TrialModule::UnionModule::UnionType* array_ptr,
        const std::size_t array_size)
{
    // Optimization for serialization
...
eProsima_user_DllExport void deserialize_array(
        eprosima::fastcdr::Cdr& scdr,
        TrialModule::UnionModule::UnionType* array_ptr,
        const std::size_t array_size)
{
    // Optimization for deserialization
    // of arrays of unions not yet supported
...
eProsima_user_DllExport bool is_ModuleStruct_cdr_plain(
        eprosima::fastdds::dds::DataRepresentationId_t data_representation)
{
    static_cast<void>(data_representation);
    return false;
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_ModuleStruct_cdr_plain(data_representation) &&
                sizeof(ModuleStruct) == ModuleStruct_max_cdr_typesize)
        {
            // Serialize the first element
            // to ensure correct alignment
            scdr.serialize(
