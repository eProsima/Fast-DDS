...
/*!
 * @file module_structPubSubTypes.hpp
...
#define FAST_DDS_GENERATED__MODULE_STRUCT_PUBSUBTYPES_HPP
...
#error \
    Generated module_struct is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
namespace TrialModule
{
    namespace StructModule
    {
        ...
        public:
            ...
            typedef ::TrialModule::StructModule::StructType type;
...
/*!
 * @brief This class represents the TopicDataType of the type ModuleStruct defined by the user in the IDL file.
 * @ingroup module_struct
 */
class ModuleStructPubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef ::ModuleStruct type;

    eProsima_user_DllExport ModuleStructPubSubType();

    eProsima_user_DllExport ~ModuleStructPubSubType() override;
...
#endif // FAST_DDS_GENERATED__MODULE_STRUCT_PUBSUBTYPES_HPP
