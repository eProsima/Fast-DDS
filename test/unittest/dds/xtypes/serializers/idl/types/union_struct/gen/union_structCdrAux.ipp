...
eProsima_user_DllExport bool is_UnionStruct_cdr_plain(
        ...
        const UnionStruct& data)
{
    ...
    scdr
        << eprosima::fastcdr::MemberId(0) << data.my_complex_union()
;
    scdr.end_serialize_type(current_state);
}
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_UnionStruct_cdr_plain(data_representation) &&
                sizeof(UnionStruct) == UnionStruct_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(UnionStruct));

            scdr.jump((array_size -1) * sizeof(UnionStruct));
        }
        else
        {
            scdr.serialize_array(array_ptr, array_size);
