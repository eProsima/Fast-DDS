...
#ifndef FAST_DDS_GENERATED__COMPREHENSIVETYPE_IDLCDRAUX_IPP
#define FAST_DDS_GENERATED__COMPREHENSIVETYPE_IDLCDRAUX_IPP
        ...
        AllStruct& data)
{
        ...
        data.my_aliased_enum(MyEnum::A);

        data.my_aliased_bounded_string({});

        data.my_recursive_alias(MyEnum::A);
