...
eProsima_user_DllExport bool is_PrimitivesStruct_cdr_plain(
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const PrimitivesStruct* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_PrimitivesStruct_cdr_plain(data_representation) &&
                sizeof(PrimitivesStruct) == PrimitivesStruct_max_cdr_typesize)
        {
            ...
            std::memcpy(
                ...
                array_ptr,
                (array_size - 1) * sizeof(PrimitivesStruct));

            scdr.jump((array_size -1) * sizeof(PrimitivesStruct));
        }
        else
        {
...
eProsima_user_DllExport bool is_AllStruct_cdr_plain(
        eprosima::fastdds::dds::DataRepresentationId_t data_representation)
{
    static_cast<void>(data_representation);
    return false;
        ...
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_AllStruct_cdr_plain(data_representation) &&
                sizeof(AllStruct) == AllStruct_max_cdr_typesize)
        {
            // Serialize the first element
            // to ensure correct alignment
            scdr.serialize(
            ...
            std::memcpy(
                scdr.get_current_position(),
                array_ptr,
                (array_size - 1) * sizeof(AllStruct));

            scdr.jump((array_size -1) * sizeof(AllStruct));
        }
        else
        {
            scdr.serialize_array(array_ptr, array_size);
...
eProsima_user_DllExport bool is_ComprehensiveType_cdr_plain(
        eprosima::fastdds::dds::DataRepresentationId_t data_representation)
{
    static_cast<void>(data_representation);
    return false;
...
eProsima_user_DllExport void serialize_array(
        eprosima::fastcdr::Cdr& scdr,
        const ComprehensiveType* array_ptr,
        const std::size_t array_size)
{
    if (array_size > 0)
    {
        ...
        if (is_ComprehensiveType_cdr_plain(data_representation) &&
                sizeof(ComprehensiveType) == ComprehensiveType_max_cdr_typesize)
        {
            // Serialize the first element
            // to ensure correct alignment
            scdr.serialize(
            ...
            std::memcpy(
                scdr.get_current_position(),
                array_ptr,
                (array_size - 1) * sizeof(ComprehensiveType));

            scdr.jump((array_size -1) * sizeof(ComprehensiveType));
        }
        else
        {
            scdr.serialize_array(array_ptr, array_size);
