...
#ifndef _FAST_DDS_GENERATED_BITMASK_STRUCT_HPP_
#define _FAST_DDS_GENERATED_BITMASK_STRUCT_HPP_
...
/*!
 * @brief This class represents the structure bitmask_struct defined by the user in the IDL file.
 * @ingroup bitmask_struct
 */
class bitmask_struct
{
public:
     ...
     */
    eProsima_user_DllExport bitmask_struct()
    {
    }
     ...
     * @param x Reference to the object bitmask_struct that will be copied.
     */
    eProsima_user_DllExport bitmask_struct(
            const bitmask_struct& x)
    {
     ...
     * @param x Reference to the object bitmask_struct that will be copied.
     */
    eProsima_user_DllExport bitmask_struct& operator =(
            const bitmask_struct& x)
    {
     ...
     * @param x bitmask_struct object to compare.
     */
    eProsima_user_DllExport bool operator ==(
            const bitmask_struct& x) const
    {
