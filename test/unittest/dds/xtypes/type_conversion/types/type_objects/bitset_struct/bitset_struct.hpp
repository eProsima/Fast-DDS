...
#ifndef _FAST_DDS_GENERATED_BITSET_STRUCT_HPP_
#define _FAST_DDS_GENERATED_BITSET_STRUCT_HPP_
...
/*!
 * @brief This class represents the structure bitset_struct defined by the user in the IDL file.
 * @ingroup bitset_struct
 */
class bitset_struct
{
public:
     ...
     */
    eProsima_user_DllExport bitset_struct()
    {
    }
     ...
     * @param x Reference to the object bitset_struct that will be copied.
     */
    eProsima_user_DllExport bitset_struct(
            const bitset_struct& x)
    {
     ...
     * @param x Reference to the object bitset_struct that will be copied.
     */
    eProsima_user_DllExport bitset_struct& operator =(
            const bitset_struct& x)
    {
    ...
    /*!
     * @brief Comparison operator.
     * @param x bitset_struct object to compare.
     */
    eProsima_user_DllExport bool operator ==(
            const bitset_struct& x) const
    {
