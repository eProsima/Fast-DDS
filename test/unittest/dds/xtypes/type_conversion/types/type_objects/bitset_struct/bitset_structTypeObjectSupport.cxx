...
void register_bitset_struct_type_identifier(
        TypeIdentifierPair& type_ids_bitset_struct)
{

    ReturnCode_t return_code_bitset_struct {eprosima::fastdds::dds::RETCODE_OK};
    return_code_bitset_struct =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "bitset_struct", type_ids_bitset_struct);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_bitset_struct)
    {
        StructTypeFlag struct_flags_bitset_struct = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_bitset_struct = "bitset_struct";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_bitset_struct;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_bitset_struct;
        CompleteTypeDetail detail_bitset_struct = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_bitset_struct, ann_custom_bitset_struct, type_name_bitset_struct.to_string());
        CompleteStructHeader header_bitset_struct;
        header_bitset_struct = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_bitset_struct);
        CompleteStructMemberSeq member_seq_bitset_struct;
        {
            ...
            ann_custom_bitset_struct.reset();
            CompleteMemberDetail detail_my_bitset = TypeObjectUtils::build_complete_member_detail(name_my_bitset, member_ann_builtin_my_bitset, ann_custom_bitset_struct);
            CompleteStructMember member_my_bitset = TypeObjectUtils::build_complete_struct_member(common_my_bitset, detail_my_bitset);
            TypeObjectUtils::add_complete_struct_member(member_seq_bitset_struct, member_my_bitset);
        }
        CompleteStructType struct_type_bitset_struct = TypeObjectUtils::build_complete_struct_type(struct_flags_bitset_struct, header_bitset_struct, member_seq_bitset_struct);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_bitset_struct, type_name_bitset_struct.to_string(), type_ids_bitset_struct))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "bitset_struct already registered in TypeObjectRegistry for a different type.");
        }
    }
}
