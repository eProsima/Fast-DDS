...
TEST_F(DynamicTypesTests, TypeDescriptors_unit_tests)
{
    ...
    ASSERT_FALSE(pInt32Descriptor2.copy_from(nullptr) == ResponseCode::OK);
    ASSERT_TRUE(pInt32Descriptor2.copy_from(&pInt32Descriptor) == ResponseCode::OK);
...
TEST_F(DynamicTypesTests, DynamicType_basic_unit_tests)
{
    ...
    ASSERT_TRUE(struct_type_builder->add_member(0, "int32", int32_type) == ResponseCode::OK);
    auto struct_type = struct_type_builder->build();
    ASSERT_TRUE(struct_type != nullptr);

    ASSERT_TRUE(struct_type_builder->add_member(1, "int64", DynamicTypeBuilderFactory::get_instance()->create_int64_type()) == ResponseCode::OK);
...
TEST_F(DynamicTypesTests, DynamicTypeBuilderFactory_unit_tests)
{
    ...
    ASSERT_FALSE(DynamicTypeBuilderFactory::get_instance()->create_custom_builder(nullptr));
    {
        ...
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(data) == ResponseCode::OK);

        auto data2 = DynamicDataFactory::get_instance()->create_data(type);
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(data2) == ResponseCode::OK);
...
{
    {
        ...
        int32_t test1 = 123;
        int32_t test2 = 0;
        ASSERT_TRUE(data->set_int32_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_int32_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_int32_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);

        //ASSERT_FALSE(data->set_int32_value(0, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_uint32_value(0, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_int16_value(0, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_uint16_value(0, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_int64_value(0, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_uint64_value(0, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_float32_value(0, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_float64_value(0, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_float128_value(0, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_char8_value('a', MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_char16_value(L'a', MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_byte_value(0, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_bool_value(false, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_string_value("", MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_wstring_value(L"", MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_enum_value("", MEMBER_ID_INVALID) == ResponseCode::OK);

        //int32_t iTest32;
        //ASSERT_FALSE(data->get_int32_value(iTest32, MEMBER_ID_INVALID) == ResponseCode::OK);
        uint32_t uTest32;
        ASSERT_FALSE(data->get_uint32_value(uTest32, MEMBER_ID_INVALID) == ResponseCode::OK);
        int16_t iTest16;
        ASSERT_FALSE(data->get_int16_value(iTest16, MEMBER_ID_INVALID) == ResponseCode::OK);
        uint16_t uTest16;
        ASSERT_FALSE(data->get_uint16_value(uTest16, MEMBER_ID_INVALID) == ResponseCode::OK);
        int64_t iTest64;
        ASSERT_FALSE(data->get_int64_value(iTest64, MEMBER_ID_INVALID) == ResponseCode::OK);
        uint64_t uTest64;
        ASSERT_FALSE(data->get_uint64_value(uTest64, MEMBER_ID_INVALID) == ResponseCode::OK);
        float fTest32;
        ASSERT_FALSE(data->get_float32_value(fTest32, MEMBER_ID_INVALID) == ResponseCode::OK);
        double fTest64;
        ASSERT_FALSE(data->get_float64_value(fTest64, MEMBER_ID_INVALID) == ResponseCode::OK);
        long double fTest128;
        ASSERT_FALSE(data->get_float128_value(fTest128, MEMBER_ID_INVALID) == ResponseCode::OK);
        char cTest8;
        ASSERT_FALSE(data->get_char8_value(cTest8, MEMBER_ID_INVALID) == ResponseCode::OK);
        wchar_t cTest16;
        ASSERT_FALSE(data->get_char16_value(cTest16, MEMBER_ID_INVALID) == ResponseCode::OK);
        octet oTest;
        ASSERT_FALSE(data->get_byte_value(oTest, MEMBER_ID_INVALID) == ResponseCode::OK);
        bool bTest;
        ASSERT_FALSE(data->get_bool_value(bTest, MEMBER_ID_INVALID) == ResponseCode::OK);
        std::string sTest;
        ASSERT_FALSE(data->get_string_value(sTest, MEMBER_ID_INVALID) == ResponseCode::OK);
        std::wstring wsTest;
        ASSERT_FALSE(data->get_wstring_value(wsTest, MEMBER_ID_INVALID) == ResponseCode::OK);
        std::string sEnumTest;
        ASSERT_FALSE(data->get_enum_value(sEnumTest, MEMBER_ID_INVALID) == ResponseCode::OK);
        ...
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(data) == ResponseCode::OK);
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(data2) == ResponseCode::OK);
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(data3) == ResponseCode::OK);
    }
    ASSERT_TRUE(DynamicTypeBuilderFactory::get_instance()->is_empty());
    ASSERT_TRUE(DynamicDataFactory::get_instance()->is_empty());
}
...
{
    {
        ...
        uint32_t test1 = 123;
        uint32_t test2 = 0;
        ASSERT_TRUE(data->set_uint32_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_uint32_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_uint32_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        int16_t test1 = 123;
        int16_t test2 = 0;
        ASSERT_TRUE(data->set_int16_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_int16_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_int16_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        uint16_t test1 = 123;
        uint16_t test2 = 0;
        ASSERT_TRUE(data->set_uint16_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_uint16_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_uint16_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        int64_t test1 = 123;
        int64_t test2 = 0;
        ASSERT_TRUE(data->set_int64_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_int64_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_int64_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        uint64_t test1 = 123;
        uint64_t test2 = 0;
        ASSERT_TRUE(data->set_uint64_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_uint64_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_uint64_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        float test1 = 123.0f;
        float test2 = 0.0f;
        ASSERT_TRUE(data->set_float32_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_float32_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_float32_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        double test1 = 123.0;
        double test2 = 0.0;
        ASSERT_TRUE(data->set_float64_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_float64_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_float64_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        ASSERT_TRUE(data->set_float128_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_float128_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_float128_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        char test1 = 'a';
        char test2 = 'b';
        ASSERT_TRUE(data->set_char8_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_char8_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_char8_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        wchar_t test1 = L'a';
        wchar_t test2 = L'b';
        ASSERT_TRUE(data->set_char16_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_char16_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_char16_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        octet test1 = 255;
        octet test2 = 0;
        ASSERT_TRUE(data->set_byte_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_byte_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_byte_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        bool test1 = true;
        bool test2 = false;
        ASSERT_TRUE(data->set_bool_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->get_bool_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_bool_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        ASSERT_TRUE(created_builder->add_empty_member(0, "DEFAULT") == ResponseCode::OK);
        ASSERT_TRUE(created_builder->add_empty_member(1, "FIRST") == ResponseCode::OK);
        ASSERT_TRUE(created_builder->add_empty_member(2, "SECOND") == ResponseCode::OK);

        // Try to add a descriptor with the same name.
        ASSERT_FALSE(created_builder->add_empty_member(4, "DEFAULT") == ResponseCode::OK);
        ...
        ASSERT_FALSE(data->set_enum_value("BAD", MEMBER_ID_INVALID) == ResponseCode::OK);

        std::string test1 = "SECOND";
        ASSERT_FALSE(data->set_enum_value(test1, 1) == ResponseCode::OK);
        ASSERT_TRUE(data->set_enum_value(test1, MEMBER_ID_INVALID) == ResponseCode::OK);

        std::string test2;
        int iTest;
        ASSERT_FALSE(data->get_int32_value(iTest, 0) == ResponseCode::OK);
        ASSERT_FALSE(data->get_enum_value(test2, 1) == ResponseCode::OK);
        ASSERT_TRUE(data->get_enum_value(test2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);

        // Work as uint32_t
        uint32_t uTest1 = 2;
        ASSERT_FALSE(data->set_enum_value(uTest1, 1) == ResponseCode::OK);
        ASSERT_TRUE(data->set_enum_value(uTest1, MEMBER_ID_INVALID) == ResponseCode::OK);

        uint32_t uTest2;
        ASSERT_FALSE(data->get_int32_value(iTest, 0) == ResponseCode::OK);
        ASSERT_FALSE(data->get_enum_value(uTest2, 1) == ResponseCode::OK);
        ASSERT_TRUE(data->get_enum_value(uTest2, MEMBER_ID_INVALID) == ResponseCode::OK);
...
TEST_F(DynamicTypesTests, DynamicType_string_unit_tests)
{
    uint32_t length = 15;
    {
        ...
        ASSERT_FALSE(data->set_int32_value(10, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_string_value("", 1) == ResponseCode::OK);
        std::string sTest1 = "STRING_TEST";
        ASSERT_TRUE(data->set_string_value(sTest1, MEMBER_ID_INVALID) == ResponseCode::OK);

        int test = 0;
        ASSERT_FALSE(data->get_int32_value(test, MEMBER_ID_INVALID) == ResponseCode::OK);
        std::string sTest2 = "";
        ASSERT_FALSE(data->get_string_value(sTest2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_string_value(sTest2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(sTest1 == sTest2);

        ASSERT_FALSE(data->set_string_value("TEST_OVER_LENGTH_LIMITS", MEMBER_ID_INVALID) == ResponseCode::OK);
...
TEST_F(DynamicTypesTests, DynamicType_wstring_unit_tests)
{
    uint32_t length = 15;
    {
        ...
        ASSERT_FALSE(data->set_int32_value(10, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(data->set_wstring_value(L"", 1) == ResponseCode::OK);
        std::wstring sTest1 = L"STRING_TEST";
        ASSERT_TRUE(data->set_wstring_value(sTest1, MEMBER_ID_INVALID) == ResponseCode::OK);

        int test = 0;
        ASSERT_FALSE(data->get_int32_value(test, MEMBER_ID_INVALID) == ResponseCode::OK);
        std::wstring sTest2 = L"";
        ASSERT_FALSE(data->get_wstring_value(sTest2, 0) == ResponseCode::OK);
        ASSERT_TRUE(data->get_wstring_value(sTest2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(sTest1 == sTest2);

        ASSERT_FALSE(data->set_wstring_value(L"TEST_OVER_LENGTH_LIMITS", MEMBER_ID_INVALID) == ResponseCode::OK);
...
{
    {
        ...
        ASSERT_FALSE(aliasData->set_int32_value(10, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_FALSE(aliasData->set_string_value("", 1) == ResponseCode::OK);

        uint32_t uTest1 = 2;
        ASSERT_TRUE(aliasData->set_uint32_value(uTest1, MEMBER_ID_INVALID) == ResponseCode::OK);

        uint32_t uTest2 = 0;
        ASSERT_TRUE(aliasData->get_uint32_value(uTest2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(uTest1 == uTest2);
        ...
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(aliasData) == ResponseCode::OK);
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(data2) == ResponseCode::OK);
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(data3) == ResponseCode::OK);
    }
...
{
    {
        ...
        ASSERT_FALSE(aliasData->set_string_value("", 1) == ResponseCode::OK);
        std::string sTest1 = "STRING_TEST";
        ASSERT_TRUE(aliasData->set_string_value(sTest1, MEMBER_ID_INVALID) == ResponseCode::OK);

        int test = 0;
        ASSERT_FALSE(aliasData->get_int32_value(test, MEMBER_ID_INVALID) == ResponseCode::OK);
        std::string sTest2 = "";
        ASSERT_FALSE(aliasData->get_string_value(sTest2, 0) == ResponseCode::OK);
        ASSERT_TRUE(aliasData->get_string_value(sTest2, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(sTest1 == sTest2);

        ASSERT_FALSE(aliasData->set_string_value("TEST_OVER_LENGTH_LIMITS", MEMBER_ID_INVALID) == ResponseCode::OK);
...
{
    {
        ...
        // Add members to the struct.
        ASSERT_TRUE(bitset_type_builder->add_member(0, "int2", base_type) == ResponseCode::OK);
        ASSERT_TRUE(bitset_type_builder->add_member(1, "int20", base_type2) == ResponseCode::OK);
        ...
        ASSERT_TRUE(bitset_data != nullptr);

        ASSERT_FALSE(bitset_data->set_int32_value(10, 1) == ResponseCode::OK);
        ASSERT_FALSE(bitset_data->set_string_value("", MEMBER_ID_INVALID) == ResponseCode::OK);

        // Set and get the child values.
        octet test1(234);
        ASSERT_TRUE(bitset_data->set_byte_value(test1, 0) == ResponseCode::OK);
        octet test2(0);
        ASSERT_TRUE(bitset_data->get_byte_value(test2, 0) == ResponseCode::OK);
        ASSERT_FALSE(test1 == test2);
        // 11101010
        // 00000010 (two bits)
        ASSERT_TRUE(test2 == 2);
        uint32_t test3(289582314);
        ASSERT_TRUE(bitset_data->set_uint32_value(test3, 1) == ResponseCode::OK);
        uint32_t test4(0);
        ASSERT_TRUE(bitset_data->get_uint32_value(test4, 1) == ResponseCode::OK);
        ...
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(bitset_data) == ResponseCode::OK);
...
TEST_F(DynamicTypesTests, DynamicType_bitmask_unit_tests)
{
    uint32_t limit = 5;
    {
        ...
        ASSERT_TRUE(created_builder->add_empty_member(0, "TEST") == ResponseCode::OK);

        // Try to add a descriptor with the same name
        ASSERT_FALSE(created_builder->add_empty_member(1, "TEST") == ResponseCode::OK);

        ASSERT_TRUE(created_builder->add_empty_member(1, "TEST2") == ResponseCode::OK);

        ASSERT_TRUE(created_builder->add_empty_member(4, "TEST4") == ResponseCode::OK);

        ASSERT_FALSE(created_builder->add_empty_member(5, "TEST5") == ResponseCode::OK); // Out of bounds
        ...
        bool test1 = true;
        ASSERT_FALSE(data->set_int32_value(1, MEMBER_ID_INVALID) == ResponseCode::OK);
        ASSERT_TRUE(data->set_bool_value(test1, testId) == ResponseCode::OK);

        // Over the limit
        ASSERT_FALSE(data->set_bool_value(test1, limit + 1) == ResponseCode::OK);

        bool test2 = false;
        ASSERT_TRUE(data->get_bool_value(test2, 2) == ResponseCode::OK);
        ASSERT_TRUE(test2 == false);
        ASSERT_TRUE(data->get_bool_value(test2, testId) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        ASSERT_TRUE(data->get_bool_value(test2, testId) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        bool test3 = data->get_bool_value("TEST");
        ASSERT_TRUE(test1 == test3);
        ASSERT_TRUE(data->set_bool_value(true, "TEST4") == ResponseCode::OK);
        bool test4 = data->get_bool_value("TEST4");
        ASSERT_TRUE(test4 == true);

        test1 = false;
        ASSERT_TRUE(data->set_bool_value(test1, testId) == ResponseCode::OK);
        ASSERT_TRUE(data->get_bool_value(test2, test2Id) == ResponseCode::OK);
        ASSERT_TRUE(data->get_bool_value(test2, testId) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        ...
        // Serialize <-> Deserialize Test
        ASSERT_TRUE(data->set_bool_value(true, 0) == ResponseCode::OK);
        DynamicPubSubType pubsubType(created_type);
        uint32_t payloadSize = static_cast<uint32_t>(pubsubType.getSerializedSizeProvider(data)());
        SerializedPayload_t payload(payloadSize);
        ASSERT_TRUE(pubsubType.serialize(data, &payload));
...
TEST_F(DynamicTypesTests, DynamicType_sequence_unit_tests)
{
    uint32_t length = 2;
    {
        ...
        ASSERT_FALSE(data->set_int32_value(234, 1) == ResponseCode::OK);

        MemberId newId;
        ASSERT_TRUE(data->insert_sequence_data(newId) == ResponseCode::OK);
        MemberId newId2;
        ASSERT_TRUE(data->insert_sequence_data(newId2) == ResponseCode::OK);

        // Try to insert more than the limit.
        MemberId newId3;
        ASSERT_FALSE(data->insert_sequence_data(newId3) == ResponseCode::OK);

        // Set and get a value.
        int32_t test1(234);
        ASSERT_TRUE(data->set_int32_value(test1, newId2) == ResponseCode::OK);
        int32_t test2(0);
        ASSERT_TRUE(data->get_int32_value(test2, newId2) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        ...
        // Remove the elements.
        ASSERT_TRUE(data->remove_sequence_data(newId) == ResponseCode::OK);
        ASSERT_TRUE(data->clear_all_values() == ResponseCode::OK);

        // New Insert Methods
        ASSERT_TRUE(data->insert_int32_value(test1, newId) == ResponseCode::OK);
        ASSERT_TRUE(data->get_int32_value(test2, newId) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        ASSERT_TRUE(data->clear_all_values() == ResponseCode::OK);
...
TEST_F(DynamicTypesTests, DynamicType_sequence_of_sequences_unit_tests)
{
    ...
    uint32_t sup_sequence_length = 3;
    {
        ...
        MemberId newSeqId;
        ASSERT_TRUE(seq_data->insert_sequence_data(newSeqId) == ResponseCode::OK);

        // Set and get a value.
        int32_t test1(234);
        ASSERT_TRUE(seq_data->set_int32_value(test1, newSeqId) == ResponseCode::OK);
        int32_t test2(0);
        ASSERT_TRUE(seq_data->get_int32_value(test2, newSeqId) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);

        // Return the pointer of the sequence
        ASSERT_TRUE(data->return_loaned_value(seq_data) == ResponseCode::OK);
        ASSERT_FALSE(data->return_loaned_value(seq_data) == ResponseCode::OK);
        ...
        ASSERT_TRUE(seq_data->insert_int32_value(test1, newSeqId) == ResponseCode::OK);
        ASSERT_TRUE(seq_data->get_int32_value(test2, newSeqId) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        ASSERT_TRUE(data->insert_complex_value(seq_data, newId) == ResponseCode::OK);
        ASSERT_TRUE(data->clear_all_values() == ResponseCode::OK);
...
TEST_F(DynamicTypesTests, DynamicType_array_unit_tests)
{
    std::vector<uint32_t> sequence_lengths = { 2, 2, 2 };
    {
        ...
        MemberId newId;
        ASSERT_FALSE(data->insert_sequence_data(newId) == ResponseCode::OK);
        ...
        // Set and get a value.
        int32_t test1 = 156;
        ASSERT_TRUE(data->set_int32_value(test1, testPos) == ResponseCode::OK);
        int32_t test2(0);
        ASSERT_TRUE(data->get_int32_value(test2, testPos) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        ...
        ASSERT_TRUE(data->clear_value(testPos) == ResponseCode::OK);
        ASSERT_TRUE(data->get_item_count() == array_type->get_total_bounds());
        ASSERT_TRUE(data->clear_array_data(testPos) == ResponseCode::OK);
        ASSERT_TRUE(data->get_item_count() == array_type->get_total_bounds());
        ...
        ASSERT_FALSE(data->set_int32_value(test1, 100) == ResponseCode::OK);
...
TEST_F(DynamicTypesTests, DynamicType_array_of_arrays_unit_tests)
{
    std::vector<uint32_t> sequence_lengths = { 2, 2 };
    {
        ...
        int32_t test1 = 156;
        ASSERT_TRUE(temp->set_int32_value(test1, testPos) == ResponseCode::OK);
        int32_t test2(0);
        ASSERT_TRUE(temp->get_int32_value(test2, testPos) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);

        ASSERT_TRUE(data->return_loaned_value(temp) == ResponseCode::OK);
        ASSERT_FALSE(data->return_loaned_value(temp) == ResponseCode::OK);
        ASSERT_FALSE(data->return_loaned_value(temp2) == ResponseCode::OK);
...
TEST_F(DynamicTypesTests, DynamicType_map_unit_tests)
{
    uint32_t map_length = 2;
    {
        ...
        // Try to write on an empty position
        ASSERT_FALSE(data->set_int32_value(234, 0) == ResponseCode::OK);

        MemberId keyId;
        MemberId valueId;
        auto key_data = DynamicDataFactory::get_instance()->create_data(base_type);
        ASSERT_TRUE(data->insert_map_data(key_data, keyId, valueId) == ResponseCode::OK);

        // Try to Add the same key twice.
        ASSERT_FALSE(data->insert_map_data(key_data, keyId, valueId) == ResponseCode::OK);
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(key_data) == ResponseCode::OK);

        MemberId keyId2;
        MemberId valueId2;
        key_data = DynamicDataFactory::get_instance()->create_data(base_type);
        key_data->set_int32_value(2, MEMBER_ID_INVALID);
        ASSERT_TRUE(data->insert_map_data(key_data, keyId2, valueId2) == ResponseCode::OK);
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(key_data) == ResponseCode::OK);
        ...
        ASSERT_FALSE(data->insert_map_data(key_data2, keyId, valueId) == ResponseCode::OK);

        // Set and get a value.
        int32_t test1(234);
        ASSERT_TRUE(data->set_int32_value(test1, valueId) == ResponseCode::OK);
        int32_t test2(0);
        ASSERT_TRUE(data->get_int32_value(test2, valueId) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        ...
        ASSERT_FALSE(data->remove_map_data(valueId) == ResponseCode::OK);
        ASSERT_TRUE(data->get_item_count() == 2);
        ASSERT_TRUE(data->remove_map_data(keyId) == ResponseCode::OK);
        ...
        // Delete the map
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(key_data2) == ResponseCode::OK);
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(data) == ResponseCode::OK);
    }
    ASSERT_TRUE(DynamicTypeBuilderFactory::get_instance()->is_empty());
    ASSERT_TRUE(DynamicDataFactory::get_instance()->is_empty());
...
TEST_F(DynamicTypesTests, DynamicType_map_of_maps_unit_tests)
{
    uint32_t map_length = 2;
    {
        ...
        ASSERT_TRUE(seq_data->insert_map_data(key_data3, keyId, valueId) == ResponseCode::OK);
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(key_data3) == ResponseCode::OK);

        // Set and get a value.
        int32_t test1(234);
        ASSERT_TRUE(seq_data->set_int32_value(test1, valueId) == ResponseCode::OK);
        int32_t test2(0);
        ASSERT_TRUE(seq_data->get_int32_value(test2, valueId) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
...
{
    {
        ...
        // Add members to the struct.
        ASSERT_TRUE(struct_type_builder->add_member(0, "int32", base_type) == ResponseCode::OK);
        ASSERT_TRUE(struct_type_builder->add_member(1, "int64", base_type2) == ResponseCode::OK);
        ...
        ASSERT_FALSE(struct_data->set_int32_value(10, 1) == ResponseCode::OK);
        ASSERT_FALSE(struct_data->set_string_value("", MEMBER_ID_INVALID) == ResponseCode::OK);

        // Set and get the child values.
        int32_t test1(234);
        ASSERT_TRUE(struct_data->set_int32_value(test1, 0) == ResponseCode::OK);
        int32_t test2(0);
        ASSERT_TRUE(struct_data->get_int32_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        int64_t test3(234);
        ASSERT_TRUE(struct_data->set_int64_value(test3, 1) == ResponseCode::OK);
        int64_t test4(0);
        ASSERT_TRUE(struct_data->get_int64_value(test4, 1) == ResponseCode::OK);
        ...
        // Delete the structure
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(struct_data) == ResponseCode::OK);
...
{
    {
        ...
        ASSERT_TRUE(child_struct_type_builder->add_member(2, "child_int32", base_type) == ResponseCode::OK);

        // try to add a member to override one of the parent struct.
        ASSERT_FALSE(child_struct_type_builder->add_member(3, "int32", base_type) == ResponseCode::OK);
        ...
        int32_t test5(234);
        ASSERT_TRUE(struct_data->set_int32_value(test5, 2) == ResponseCode::OK);
        int32_t test6(0);
        ASSERT_TRUE(struct_data->get_int32_value(test6, 2) == ResponseCode::OK);
...
{
    {
        ...
        ASSERT_TRUE(parent_struct_type_builder->add_member(0, "child_struct", struct_type) == ResponseCode::OK);
        ASSERT_TRUE(parent_struct_type_builder->add_member(1, "child_int64", base_type2) == ResponseCode::OK);
        ...
        // Set and get the child values.
        int64_t test1(234);
        ASSERT_TRUE(struct_data->set_int64_value(test1, 1) == ResponseCode::OK);
        int64_t test2(0);
        ASSERT_TRUE(struct_data->get_int64_value(test2, 1) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        ...
        // Set and get the child values.
        int32_t test3(234);
        ASSERT_TRUE(child_struct_data->set_int32_value(test3, 0) == ResponseCode::OK);
        int32_t test4(0);
        ASSERT_TRUE(child_struct_data->get_int32_value(test4, 0) == ResponseCode::OK);
        ASSERT_TRUE(test3 == test4);
        int64_t test5(234);
        ASSERT_TRUE(child_struct_data->set_int64_value(test5, 1) == ResponseCode::OK);
        int64_t test6(0);
        ASSERT_TRUE(child_struct_data->get_int64_value(test6, 1) == ResponseCode::OK);
        ASSERT_TRUE(test5 == test6);

        ASSERT_TRUE(struct_data->return_loaned_value(child_struct_data) == ResponseCode::OK);
        ASSERT_FALSE(struct_data->return_loaned_value(child_struct_data) == ResponseCode::OK);
...
{
    {
        ...
        ASSERT_TRUE(union_type_builder->add_member(0, "first", base_type, "", { 0 }, true) == ResponseCode::OK);
        ASSERT_TRUE(union_type_builder->add_member(1, "second", base_type2, "", { 1 }, false) == ResponseCode::OK);

        // Try to add a second "DEFAULT" value to the union
        ASSERT_FALSE(union_type_builder->add_member(0, "third", base_type, "", { 0 }, true) == ResponseCode::OK);

        // Try to add a second value to the same case label
        ASSERT_FALSE(union_type_builder->add_member(0, "third", base_type, "", { 1 }, false) == ResponseCode::OK);
        ...
        // Set and get the child values.
        ASSERT_FALSE(union_data->set_int32_value(10, 1) == ResponseCode::OK);
        ASSERT_FALSE(union_data->set_string_value("", MEMBER_ID_INVALID) == ResponseCode::OK);

        uint64_t label;
        ASSERT_TRUE(union_data->get_union_label(label) == ResponseCode::OK);
        ASSERT_TRUE(label == 0);

        int32_t test1(234);
        ASSERT_TRUE(union_data->set_int32_value(test1, 0) == ResponseCode::OK);
        int32_t test2(0);
        ASSERT_TRUE(union_data->get_int32_value(test2, 0) == ResponseCode::OK);
        ASSERT_TRUE(test1 == test2);
        ASSERT_TRUE(union_data->get_union_label(label) == ResponseCode::OK);
        ASSERT_TRUE(label == 0);
        ...
        ASSERT_FALSE(union_data->get_int32_value(test2, 1) == ResponseCode::OK);
        ASSERT_FALSE(union_data->get_int64_value(test4, 1) == ResponseCode::OK);

        ASSERT_TRUE(union_data->set_int64_value(test3, 1) == ResponseCode::OK);
        ASSERT_TRUE(union_data->get_int64_value(test4, 1) == ResponseCode::OK);
        ASSERT_TRUE(test3 == test4);
        ASSERT_TRUE(union_data->get_union_label(label) == ResponseCode::OK);
        ASSERT_TRUE(label == 1);
        ...
        // Delete the map
        ASSERT_TRUE(DynamicDataFactory::get_instance()->delete_data(union_data) == ResponseCode::OK);
    }
    ASSERT_TRUE(DynamicTypeBuilderFactory::get_instance()->is_empty());
    ASSERT_TRUE(DynamicDataFactory::get_instance()->is_empty());
}
...
{
    {
        ...
        ASSERT_TRUE(parent_union_type_builder->add_member(0, "first", base_type, "", { 0 }, true) == ResponseCode::OK);
        ASSERT_TRUE(parent_union_type_builder->add_member(1, "second", union_type, "", { 1 }, false) == ResponseCode::OK);
        ...
        // Try to get values from invalid indexes and from an invalid element ( not the current one )
        ASSERT_FALSE(child_data->get_int32_value(test2, 1) == ResponseCode::OK);
        ASSERT_FALSE(child_data->get_int64_value(test4, 1) == ResponseCode::OK);

        ASSERT_TRUE(child_data->set_int64_value(test3, 1) == ResponseCode::OK);
        ASSERT_TRUE(child_data->get_int64_value(test4, 1) == ResponseCode::OK);
        ASSERT_TRUE(test3 == test4);

        ASSERT_TRUE(union_data->return_loaned_value(child_data) == ResponseCode::OK);
        ASSERT_TRUE(union_data->get_union_label(label) == ResponseCode::OK);
        ASSERT_TRUE(label == 1);
