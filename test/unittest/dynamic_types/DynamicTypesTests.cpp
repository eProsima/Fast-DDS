...
TEST_F(DynamicTypesTests, DynamicType_int32_unit_tests)
{
    ...
    int32_t test1 = 123;
    int32_t test2 = 0;
    ASSERT_TRUE(data->set_int32_value(MEMBER_ID_INVALID, test1) == eprosima::fastdds::dds::RETCODE_OK);
    ...
    DynamicData::_ref_type data3 {DynamicDataFactory::get_instance()->create_data(created_type)};
...
/*
       ...
       {
        eprosima::fastdds::dds::Log::ScopeLogs _("disable");
        ASSERT_NE(data->set_wstring_value(L"TEST_OVER_LENGTH_LIMITS",
                MEMBER_ID_INVALID), eprosima::fastdds::dds::RETCODE_OK);
       }
