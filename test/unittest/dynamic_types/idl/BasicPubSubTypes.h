...
namespace detail {
    ...
    inline size_t constexpr EnumStruct_offset_of() {
...
private:
    ...
    {
        return 4ULL == (detail::EnumStruct_offset_of<EnumStruct, detail::EnumStruct_f>() + sizeof(MyEnum));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 4ULL == (detail::AliasStruct_offset_of<AliasStruct, detail::AliasStruct_f>() + sizeof(MyAliasEnum));
...
namespace detail {
    ...
    template <typename T, typename Tag>
    inline size_t constexpr AliasAliasStruct_offset_of() {
        return ((::size_t) &reinterpret_cast<char const volatile&>((((T*)0)->*get(Tag()))));
    }
}
#endif
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 4ULL == (detail::AliasAliasStruct_offset_of<AliasAliasStruct, detail::AliasAliasStruct_f>() + sizeof(MyAliasAliasEnum));
