...
private:
    ...
    {
        return 5ULL == (detail::BoolStruct_offset_of<BoolStruct, detail::BoolStruct_f>() + sizeof(bool));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 5ULL == (detail::OctetStruct_offset_of<OctetStruct, detail::OctetStruct_f>() + sizeof(uint8_t));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 6ULL == (detail::ShortStruct_offset_of<ShortStruct, detail::ShortStruct_f>() + sizeof(int16_t));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 8ULL == (detail::LongStruct_offset_of<LongStruct, detail::LongStruct_f>() + sizeof(int32_t));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 16ULL == (detail::LongLongStruct_offset_of<LongLongStruct, detail::LongLongStruct_f>() + sizeof(int64_t));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 6ULL == (detail::UShortStruct_offset_of<UShortStruct, detail::UShortStruct_f>() + sizeof(uint16_t));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 8ULL == (detail::ULongStruct_offset_of<ULongStruct, detail::ULongStruct_f>() + sizeof(uint32_t));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 16ULL == (detail::ULongLongStruct_offset_of<ULongLongStruct, detail::ULongLongStruct_f>() + sizeof(uint64_t));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 8ULL == (detail::FloatStruct_offset_of<FloatStruct, detail::FloatStruct_f>() + sizeof(float));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 16ULL == (detail::DoubleStruct_offset_of<DoubleStruct, detail::DoubleStruct_f>() + sizeof(double));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 24ULL == (detail::LongDoubleStruct_offset_of<LongDoubleStruct, detail::LongDoubleStruct_f>() + sizeof(long double));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 5ULL == (detail::CharStruct_offset_of<CharStruct, detail::CharStruct_f>() + sizeof(char));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 36ULL == (detail::ArraytStruct_offset_of<ArraytStruct, detail::ArraytStruct_f>() + sizeof(std::array<std::array<std::array<int32_t, 2>, 2>, 2>));
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 32ULL == (detail::StructStructStruct_offset_of<StructStructStruct, detail::StructStructStruct_f>() + sizeof(int64_t));
