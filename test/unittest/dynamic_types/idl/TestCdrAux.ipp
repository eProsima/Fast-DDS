        ...
        ComplexStruct& data)
{
        ...
        data.my_alias_enum(::A);

        data.my_enum(::A);



        data.my_array_octet({ {{ {{0}} }} });

        data.my_octet_array_500({0});
        ...
        data.my_small_string_8({});

        data.my_large_string_8({});


        data.multi_alias_array_42({::A});

        data.my_array_arrays({ {{0}} });
