...
public:
    ...
    eProsima_user_DllExport virtual ~ComplexStructPubSubType();
...
public:
    ...
    eProsima_user_DllExport virtual ~CompleteStructPubSubType();
...
public:
    ...
    eProsima_user_DllExport virtual ~KeyedStructPubSubType();
