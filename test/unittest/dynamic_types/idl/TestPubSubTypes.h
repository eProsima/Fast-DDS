...
public:
    ...
    eProsima_user_DllExport ~ComplexStructPubSubType() override;
...
public:
    ...
    eProsima_user_DllExport ~CompleteStructPubSubType() override;
...
public:
    ...
    eProsima_user_DllExport ~KeyedStructPubSubType() override;
