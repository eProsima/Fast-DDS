...
#ifndef _FAST_DDS_GENERATED_INHERITANCE_TYPE_OBJECT_SUPPORT_HPP_
#define _FAST_DDS_GENERATED_INHERITANCE_TYPE_OBJECT_SUPPORT_HPP_
 ...
 */
eProsima_user_DllExport void register_inheritance_type_objects();
