...
{
    // m_int8_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@71a794e5
    m_int8_ = 0;
    // m_uint8_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76329302
    m_uint8_ = 0;
    // m_int16_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5e25a92e
    m_int16_ = 0;
    // m_uint16_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4df828d7
    m_uint16_ = 0;
    // m_int32_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@b59d31
    m_int32_ = 0;
    // m_uint32_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@62fdb4a6
    m_uint32_ = 0;
    // m_int64_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11e21d0e
    m_int64_ = 0;
    // m_uint64_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3e77a1ed
    m_uint64_ = 555;
    // m_local_string com.eprosima.idl.parser.typecode.StringTypeCode@1176dcec
    m_local_string ="";
...
{
    m__d = 'a';
    // m_case_zero com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5d20e46
    m_case_zero = 0;
    // m_case_one com.eprosima.idl.parser.typecode.PrimitiveTypeCode@709ba3fb
    m_case_one = 0;
}
...
{
    m__d = 5;
    // m_case_five com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5a4aa2f2
    m_case_five = 0;
    // m_case_seven com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6591f517
    m_case_seven = 0;
}
...
{
    m__d = 3;
    // m_case_three com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4461c7e3
    m_case_three = 0;
    // m_case_six com.eprosima.idl.parser.typecode.PrimitiveTypeCode@351d0846
    m_case_six = 0;
}
...
bitmodule::MyBitset::MyBitset(
        MyBitset&& x)    : bitmodule::ParentBitset(std::move(x)) 
{
    m_bitset = x.m_bitset;
}
...
{
    // m_mybitset com.eprosima.idl.parser.typecode.BitsetTypeCode@475e586c

    // m_mybitmask com.eprosima.idl.parser.typecode.BitmaskTypeCode@657c8ad9
...
{
    // m_two com.eprosima.idl.parser.typecode.BitmaskTypeCode@657c8ad9
    m_two = static_cast<bitmodule::MyBitMask>(0);
    // m_mylong com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c153a1
    m_mylong = 0;
...
bitmodule::BM2::BM2(
        BM2&& x)    : bitmodule::BitsetBitmask(std::move(x)) 
{
    m_two = x.m_two;
    m_mylong = x.m_mylong;
}
...
{
    // m_charUnion com.eprosima.idl.parser.typecode.UnionTypeCode@6580cfdd

    // m_octetUnion com.eprosima.idl.parser.typecode.UnionTypeCode@7e0b85f9

    // m_int8Union com.eprosima.idl.parser.typecode.UnionTypeCode@63355449

    // m_myStructBits com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@9353778
...
StructTest::StructTest(
        StructTest&& x)    : NewAliases(std::move(x)) 
{
