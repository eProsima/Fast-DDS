...
namespace bitmodule
{
    ...
    /*!
     * @brief This class represents the structure NoBitset defined by the user in the IDL file.
     * @ingroup NEW_FEATURES_4_2
     */
    class NoBitset
    {
    public:
         ...
         * @brief Default constructor.
         */
        eProsima_user_DllExport NoBitset();

        /*!
         * @brief Default destructor.
         */
        eProsima_user_DllExport virtual ~NoBitset();

        /*!
         * @brief Copy constructor.
         * @param x Reference to the object bitmodule::NoBitset that will be copied.
         */
        eProsima_user_DllExport NoBitset(const NoBitset &x);

        /*!
         * @brief Move constructor.
         * @param x Reference to the object bitmodule::NoBitset that will be copied.
         */
        eProsima_user_DllExport NoBitset(NoBitset &&x);

        /*!
         * @brief Copy assignment.
         * @param x Reference to the object bitmodule::NoBitset that will be copied.
         */
        eProsima_user_DllExport NoBitset& operator=(const NoBitset &x);

        /*!
         * @brief Move assignment.
         * @param x Reference to the object bitmodule::NoBitset that will be copied.
         */
        eProsima_user_DllExport NoBitset& operator=(NoBitset &&x);
         ...
         * @return Serialized size.
         */
        eProsima_user_DllExport static size_t getCdrSerializedSize(const bitmodule::NoBitset& data, size_t current_alignment = 0);
...
/*!
 * @brief This class represents the structure NoBitsetStructTest defined by the user in the IDL file.
 * @ingroup NEW_FEATURES_4_2
 */
class NoBitsetStructTest : public NewAliases 
{
public:
     ...
     * @brief Default constructor.
     */
    eProsima_user_DllExport NoBitsetStructTest();

    /*!
     * @brief Default destructor.
     */
    eProsima_user_DllExport virtual ~NoBitsetStructTest();

    /*!
     * @brief Copy constructor.
     * @param x Reference to the object NoBitsetStructTest that will be copied.
     */
    eProsima_user_DllExport NoBitsetStructTest(const NoBitsetStructTest &x);

    /*!
     * @brief Move constructor.
     * @param x Reference to the object NoBitsetStructTest that will be copied.
     */
    eProsima_user_DllExport NoBitsetStructTest(NoBitsetStructTest &&x);

    /*!
     * @brief Copy assignment.
     * @param x Reference to the object NoBitsetStructTest that will be copied.
     */
    eProsima_user_DllExport NoBitsetStructTest& operator=(const NoBitsetStructTest &x);

    /*!
     * @brief Move assignment.
     * @param x Reference to the object NoBitsetStructTest that will be copied.
     */
    eProsima_user_DllExport NoBitsetStructTest& operator=(NoBitsetStructTest &&x);
     ...
     * @param _myStructBits New value to be copied in member myStructBits
     */
    eProsima_user_DllExport void myStructBits(const bitmodule::NoBitset &_myStructBits);

    /*!
     * @brief This function moves the value in member myStructBits
     * @param _myStructBits New value to be moved in member myStructBits
     */
    eProsima_user_DllExport void myStructBits(bitmodule::NoBitset &&_myStructBits);

    /*!
     * @brief This function returns a constant reference to member myStructBits
     * @return Constant reference to member myStructBits
     */
    eProsima_user_DllExport const bitmodule::NoBitset& myStructBits() const;

    /*!
     * @brief This function returns a reference to member myStructBits
     * @return Reference to member myStructBits
     */
    eProsima_user_DllExport bitmodule::NoBitset& myStructBits();
     ...
     * @return Serialized size.
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const NoBitsetStructTest& data, size_t current_alignment = 0);
...
private:
    ...
    OctetUnion m_octetUnion;
    Int8Union m_int8Union;
    bitmodule::NoBitset m_myStructBits;
};
