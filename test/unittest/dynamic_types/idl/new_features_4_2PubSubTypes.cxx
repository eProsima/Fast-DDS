...
namespace bitmodule
{
    ...
    NoBitsetPubSubType::NoBitsetPubSubType()
    {
        setName("bitmodule::NoBitset");
        m_typeSize = static_cast<uint32_t>(NoBitset::getMaxCdrSerializedSize()) + 4 /*encapsulation*/;
        m_isGetKeyDefined = NoBitset::isKeyDefined();
        size_t keyLength = NoBitset::getKeyMaxCdrSerializedSize()>16 ? NoBitset::getKeyMaxCdrSerializedSize() : 16;
        m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
        memset(m_keyBuffer, 0, keyLength);
    }
    ...
    bool NoBitsetPubSubType::serialize(void *data, SerializedPayload_t *payload)
    {
        NoBitset *p_type = static_cast<NoBitset*>(data);
        eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->max_size); // Object that manages the raw buffer.
        eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
                eprosima::fastcdr::Cdr::DDS_CDR); // Object that serializes the data.
        payload->encapsulation = ser.endianness() == eprosima::fastcdr::Cdr::BIG_ENDIANNESS ? CDR_BE : CDR_LE;
    ...
    bool NoBitsetPubSubType::deserialize(SerializedPayload_t* payload, void* data)
    {
        NoBitset* p_type = static_cast<NoBitset*>(data); //Convert DATA to pointer of your type
        eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->length); // Object that manages the raw buffer.
        eprosima::fastcdr::Cdr deser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
                eprosima::fastcdr::Cdr::DDS_CDR); // Object that deserializes the data.
        // Deserialize encapsulation.
    ...
    std::function<uint32_t()> NoBitsetPubSubType::getSerializedSizeProvider(void* data)
    {
        return [data]() -> uint32_t
        {
            return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<NoBitset*>(data))) + 4 /*encapsulation*/;
        };
    }

    void* NoBitsetPubSubType::createData()
    {
        return reinterpret_cast<void*>(new NoBitset());
    }

    void NoBitsetPubSubType::deleteData(void* data)
    {
        delete(reinterpret_cast<NoBitset*>(data));
    }

    bool NoBitsetPubSubType::getKey(void *data, InstanceHandle_t* handle, bool force_md5)
    {
        if(!m_isGetKeyDefined)
            return false;
        NoBitset* p_type = static_cast<NoBitset*>(data);
        eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),NoBitset::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
        eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
        p_type->serializeKey(ser);
        if(force_md5 || NoBitset::getKeyMaxCdrSerializedSize()>16)    {
            m_md5.init();
            m_md5.update(m_keyBuffer, static_cast<unsigned int>(ser.getSerializedDataLength()));
            m_md5.finalize();
            for(uint8_t i = 0;i<16;++i)        {
...
NoBitsetStructTestPubSubType::NoBitsetStructTestPubSubType()
{
    setName("NoBitsetStructTest");
    m_typeSize = static_cast<uint32_t>(NoBitsetStructTest::getMaxCdrSerializedSize()) + 4 /*encapsulation*/;
    m_isGetKeyDefined = NoBitsetStructTest::isKeyDefined();
    size_t keyLength = NoBitsetStructTest::getKeyMaxCdrSerializedSize()>16 ? NoBitsetStructTest::getKeyMaxCdrSerializedSize() : 16;
    m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
    memset(m_keyBuffer, 0, keyLength);
}
...
bool NoBitsetStructTestPubSubType::serialize(void *data, SerializedPayload_t *payload)
{
    NoBitsetStructTest *p_type = static_cast<NoBitsetStructTest*>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->max_size); // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
            eprosima::fastcdr::Cdr::DDS_CDR); // Object that serializes the data.
    payload->encapsulation = ser.endianness() == eprosima::fastcdr::Cdr::BIG_ENDIANNESS ? CDR_BE : CDR_LE;
...
bool NoBitsetStructTestPubSubType::deserialize(SerializedPayload_t* payload, void* data)
{
    NoBitsetStructTest* p_type = static_cast<NoBitsetStructTest*>(data); //Convert DATA to pointer of your type
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->length); // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr deser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
            eprosima::fastcdr::Cdr::DDS_CDR); // Object that deserializes the data.
    // Deserialize encapsulation.
...
std::function<uint32_t()> NoBitsetStructTestPubSubType::getSerializedSizeProvider(void* data)
{
    return [data]() -> uint32_t
    {
        return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<NoBitsetStructTest*>(data))) + 4 /*encapsulation*/;
    };
}

void* NoBitsetStructTestPubSubType::createData()
{
    return reinterpret_cast<void*>(new NoBitsetStructTest());
}

void NoBitsetStructTestPubSubType::deleteData(void* data)
{
    delete(reinterpret_cast<NoBitsetStructTest*>(data));
}

bool NoBitsetStructTestPubSubType::getKey(void *data, InstanceHandle_t* handle, bool force_md5)
{
    if(!m_isGetKeyDefined)
        return false;
    NoBitsetStructTest* p_type = static_cast<NoBitsetStructTest*>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),NoBitsetStructTest::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
    if(force_md5 || NoBitsetStructTest::getKeyMaxCdrSerializedSize()>16)    {
        m_md5.init();
        m_md5.update(m_keyBuffer, static_cast<unsigned int>(ser.getSerializedDataLength()));
        m_md5.finalize();
        for(uint8_t i = 0;i<16;++i)        {
