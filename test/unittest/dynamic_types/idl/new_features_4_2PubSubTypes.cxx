...
void NewAliasesPubSubType::register_type_object_representation() const
{
...
namespace bitmodule {
    ...
    void BitsetBitmaskPubSubType::register_type_object_representation() const
    {
        register_new_features_4_2_type_objects();
    }
    ...
    void BM2PubSubType::register_type_object_representation() const
    {
        register_new_features_4_2_type_objects();
    }
...
void StructTestPubSubType::register_type_object_representation() const
{
    register_new_features_4_2_type_objects();
}
