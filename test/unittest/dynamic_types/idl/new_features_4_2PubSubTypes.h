...
public:
    ...
    eProsima_user_DllExport virtual ~NewAliasesPubSubType();
...
namespace bitmodule
{
    ...
    public:
        ...
        eProsima_user_DllExport virtual ~BitsetBitmaskPubSubType();
    ...
    public:
        ...
        eProsima_user_DllExport virtual ~BM2PubSubType();
...
public:
    ...
    eProsima_user_DllExport virtual ~StructTestPubSubType();
