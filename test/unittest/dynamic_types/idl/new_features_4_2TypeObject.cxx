 ...
 *
 * This file was generated by the tool fastddsgen (version: 3.3.3).
 */
...
namespace bitmodule {
    ...
    {
        const TypeIdentifier* c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("bitmodule::ParentBitset", complete);
        if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
        {
            return c_identifier;
        }
        ...
        return TypeObjectFactory::get_instance()->get_type_identifier("bitmodule::ParentBitset", complete);
    }

    const TypeObject* GetParentBitsetObject(bool complete)
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::ParentBitset", complete);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
    ...
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::ParentBitset", false);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
        ...
        TypeObjectFactory::get_instance()->add_type_object("bitmodule::ParentBitset", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("bitmodule::ParentBitset", false);
    }

    const TypeObject* GetCompleteParentBitsetObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::ParentBitset", true);
        if (c_type_object != nullptr && c_type_object->_d() == EK_COMPLETE)
        {
            return c_type_object;
        }
        ...
        type_object->complete().bitset_type().header().detail().type_name("bitmodule::ParentBitset");
        ...
        TypeObjectFactory::get_instance()->add_type_object("bitmodule::ParentBitset", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("bitmodule::ParentBitset", true);
    }

    const TypeIdentifier* GetMyBitsetIdentifier(bool complete)
    {
        const TypeIdentifier* c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("bitmodule::MyBitset", complete);
        if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
        {
            return c_identifier;
        }
        ...
        return TypeObjectFactory::get_instance()->get_type_identifier("bitmodule::MyBitset", complete);
    }

    const TypeObject* GetMyBitsetObject(bool complete)
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::MyBitset", complete);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
    ...
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::MyBitset", false);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
        ...
        TypeObjectFactory::get_instance()->add_type_object("bitmodule::MyBitset", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("bitmodule::MyBitset", false);
    }

    const TypeObject* GetCompleteMyBitsetObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::MyBitset", true);
        if (c_type_object != nullptr && c_type_object->_d() == EK_COMPLETE)
        {
            return c_type_object;
        }
        ...
        type_object->complete().bitset_type().header().detail().type_name("bitmodule::MyBitset");
        ...
        TypeObjectFactory::get_instance()->add_type_object("bitmodule::MyBitset", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("bitmodule::MyBitset", true);
    }

    const TypeIdentifier* GetMyBitMaskIdentifier(bool complete)
    {
        const TypeIdentifier* c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("bitmodule::MyBitMask", complete);
        if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
        {
            return c_identifier;
        }
        ...
        return TypeObjectFactory::get_instance()->get_type_identifier("bitmodule::MyBitMask", complete);
    }

    const TypeObject* GetMyBitMaskObject(bool complete)
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::MyBitMask", complete);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
    ...
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::MyBitMask", false);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
        ...
        TypeObjectFactory::get_instance()->add_type_object("bitmodule::MyBitMask", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("bitmodule::MyBitMask", false);
    }

    const TypeObject* GetCompleteMyBitMaskObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::MyBitMask", true);
        if (c_type_object != nullptr && c_type_object->_d() == EK_COMPLETE)
        {
            return c_type_object;
        }
        ...
        {
            AppliedAnnotation ann;
            //ann.annotation_typeid(Getbit_boundIdentifier(true));
            ann.annotation_typeid(*TypeObjectFactory::get_instance()->get_type_identifier_trying_complete("bit_bound"));
            {
                AppliedAnnotationParameter annParam;
                MD5 message_hash("value");
        ...
        type_object->complete().bitmask_type().header().detail().type_name("bitmodule::MyBitMask");
        ...
        TypeObjectFactory::get_instance()->add_type_object("bitmodule::MyBitMask", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("bitmodule::MyBitMask", true);
    }
    ...
    {
        const TypeIdentifier * c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("bitmodule::BitsetBitmask", complete);
        if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
        {
            return c_identifier;
        }
        ...
        return TypeObjectFactory::get_instance()->get_type_identifier("bitmodule::BitsetBitmask", complete);
    }

    const TypeObject* GetBitsetBitmaskObject(bool complete)
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::BitsetBitmask", complete);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
    ...
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::BitsetBitmask", false);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
        ...
        TypeObjectFactory::get_instance()->add_type_object("bitmodule::BitsetBitmask", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("bitmodule::BitsetBitmask", false);
    }

    const TypeObject* GetCompleteBitsetBitmaskObject()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::BitsetBitmask", true);
        if (c_type_object != nullptr && c_type_object->_d() == EK_COMPLETE)
        {
            return c_type_object;
        }
        ...
        // Header
        type_object->complete().struct_type().header().detail().type_name("bitmodule::BitsetBitmask");
        // TODO inheritance
        TypeIdentifier identifier;
        identifier._d(EK_COMPLETE);
        ...
        TypeObjectFactory::get_instance()->add_type_object("bitmodule::BitsetBitmask", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("bitmodule::BitsetBitmask", true);
    }
    ...
    {
        const TypeIdentifier * c_identifier = TypeObjectFactory::get_instance()->get_type_identifier("bitmodule::BM2", complete);
        if (c_identifier != nullptr && (!complete || c_identifier->_d() == EK_COMPLETE))
        {
            return c_identifier;
        }
        ...
        return TypeObjectFactory::get_instance()->get_type_identifier("bitmodule::BM2", complete);
    }

    const TypeObject* GetBM2Object(bool complete)
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::BM2", complete);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
    ...
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::BM2", false);
        if (c_type_object != nullptr)
        {
            return c_type_object;
        }
        ...
        TypeObjectFactory::get_instance()->add_type_object("bitmodule::BM2", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("bitmodule::BM2", false);
    }

    const TypeObject* GetCompleteBM2Object()
    {
        const TypeObject* c_type_object = TypeObjectFactory::get_instance()->get_type_object("bitmodule::BM2", true);
        if (c_type_object != nullptr && c_type_object->_d() == EK_COMPLETE)
        {
            return c_type_object;
        }
        ...
        // Header
        type_object->complete().struct_type().header().detail().type_name("bitmodule::BM2");
        // TODO inheritance
        ...
        TypeObjectFactory::get_instance()->add_type_object("bitmodule::BM2", &identifier, type_object);
        delete type_object;
        return TypeObjectFactory::get_instance()->get_type_object("bitmodule::BM2", true);
    }
