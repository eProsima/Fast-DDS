...
#define StructTest_max_cdr_typesize 88ULL;
...
size_t ParentBitset::getCdrSerializedSize(
        const ParentBitset&,
        size_t current_alignment)
{
    size_t initial_alignment = current_alignment;

    current_alignment += sizeof(helper::FindType<17>::type) +
...
void ParentBitset::serialize(
        eprosima::fastcdr::Cdr& scdr) const
{
    using namespace bitmodule;

    helper::FindType<17>::type bits = static_cast<helper::FindType<17>::type>(bitset().to_ullong());
    scdr << bits;
}

void ParentBitset::deserialize(
        eprosima::fastcdr::Cdr& dcdr)
{
    using namespace bitmodule;

    helper::FindType<17>::type bits;
    dcdr >> bits;
    bitset(std::bitset<17>(bits));
}
        ...
        size_t current_alignment)
{
    ...
    current_alignment += sizeof(helper::FindType<50>::type) +
        eprosima::fastcdr::Cdr::alignment(current_alignment, sizeof(helper::FindType<50>::type));
        ...
        eprosima::fastcdr::Cdr& scdr) const
{
    ...
    helper::FindType<50>::type bits = static_cast<helper::FindType<50>::type>(bitset().to_ullong());
    scdr << bits;
}
        ...
        eprosima::fastcdr::Cdr& dcdr)
{
    ...
    helper::FindType<50>::type bits;
    dcdr >> bits;
    bitset(std::bitset<50>(bits));
}
...
size_t BitsetBitmask::getMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
...
size_t BitsetBitmask::getCdrSerializedSize(
        const BitsetBitmask& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void BitsetBitmask::deserialize(
        eprosima::fastcdr::Cdr& dcdr)
{
    dcdr >> m_mybitset;
...
bool BitsetBitmask::isKeyDefined()
{
    return false;
}

void BitsetBitmask::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
}
...
size_t BM2::getMaxCdrSerializedSize(
        size_t current_alignment)
{
    static_cast<void>(current_alignment);
...
size_t BM2::getCdrSerializedSize(
        const BM2& data,
        size_t current_alignment)
{
    (void)data;
