...
class LogMacrosNoWarningTests : public ::testing::Test
{
public:
...
std::vector<Log::Entry> LogMacrosNoWarningTests::HELPER_WaitForEntries(
        uint32_t amount)
{
    size_t entries = 0;
...
TEST_F(LogMacrosNoWarningTests, no_warning)
{
