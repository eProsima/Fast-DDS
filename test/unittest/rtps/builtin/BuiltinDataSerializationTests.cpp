...
{
    WriterProxyData wpd_in(max_unicast_locators, max_multicast_locators), wpd_out(max_unicast_locators, max_multicast_locators);
    ReaderProxyData rpd_in(max_unicast_locators, max_multicast_locators), rpd_out(max_unicast_locators, max_multicast_locators);
