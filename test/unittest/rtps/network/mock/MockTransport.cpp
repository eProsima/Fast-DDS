...
bool MockTransport::IsOutputChannelOpen(const Locator_t& locator, SenderResource*) const
{
...
bool MockTransport::OpenOutputChannel(Locator_t& locator, SenderResource*)
{  
