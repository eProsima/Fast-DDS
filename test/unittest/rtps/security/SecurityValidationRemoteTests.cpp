...
TEST_F(SecurityTestParticipantLimit, discovered_participant_limit_rejects_unknown)
{
    ...
    fill_participant_key(participant_data_a.m_guid);
    ...
    info_a.guid = participant_data_a.m_guid;
    ...
    participant_data_b.m_guid.guidPrefix.value[0] = 0xAA;
    participant_data_b.m_guid.guidPrefix.value[1] = 0xBB;
