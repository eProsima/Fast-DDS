...
TEST_F(LivelinessManagerTests, WriterCanAlwaysBeAdded)
{
    ...
    EXPECT_EQ(liveliness_manager.add_writer(guid, fastdds::dds::MANUAL_BY_PARTICIPANT_LIVELINESS_QOS, Duration_t(1)), true);
...
TEST_F(LivelinessManagerTests, WriterCannotBeRemovedTwice)
{
    ...
    EXPECT_EQ(liveliness_manager.add_writer(guid, fastdds::dds::MANUAL_BY_PARTICIPANT_LIVELINESS_QOS, Duration_t(1)), true);
    EXPECT_EQ(liveliness_manager.remove_writer(guid, fastdds::dds::MANUAL_BY_PARTICIPANT_LIVELINESS_QOS, Duration_t(1)), true);
    EXPECT_EQ(liveliness_manager.remove_writer(guid, fastdds::dds::MANUAL_BY_PARTICIPANT_LIVELINESS_QOS, Duration_t(1)), false);

    EXPECT_EQ(liveliness_manager.add_writer(guid, fastdds::dds::MANUAL_BY_TOPIC_LIVELINESS_QOS, Duration_t(1)), true);
    EXPECT_EQ(liveliness_manager.remove_writer(guid, fastdds::dds::MANUAL_BY_TOPIC_LIVELINESS_QOS, Duration_t(1)), true);
    EXPECT_EQ(liveliness_manager.remove_writer(guid, fastdds::dds::MANUAL_BY_TOPIC_LIVELINESS_QOS, Duration_t(1)), false);
}
...
TEST_F(LivelinessManagerTests, AssertLivelinessByKind)
{
    ...
    EXPECT_TRUE(liveliness_manager.assert_liveliness(fastdds::dds::AUTOMATIC_LIVELINESS_QOS));
    ...
    EXPECT_TRUE(liveliness_manager.assert_liveliness(fastdds::dds::MANUAL_BY_PARTICIPANT_LIVELINESS_QOS));
    ...
    EXPECT_TRUE(liveliness_manager.assert_liveliness(fastdds::dds::MANUAL_BY_TOPIC_LIVELINESS_QOS));
    liveliness_data = liveliness_manager.get_liveliness_data();
    EXPECT_EQ(liveliness_data[0].status, LivelinessData::WriterStatus::ALIVE);
    EXPECT_EQ(liveliness_data[1].status, LivelinessData::WriterStatus::ALIVE);
    EXPECT_EQ(liveliness_data[2].status, LivelinessData::WriterStatus::ALIVE);
...
TEST_F(LivelinessManagerTests, TimerExpired_ManualByParticipant)
{
    ...
    liveliness_manager.add_writer(GUID_t(guidP, 1), fastdds::dds::MANUAL_BY_PARTICIPANT_LIVELINESS_QOS, Duration_t(0.1));
    liveliness_manager.add_writer(GUID_t(guidP, 2), fastdds::dds::MANUAL_BY_PARTICIPANT_LIVELINESS_QOS, Duration_t(0.5));

    // Assert liveliness
    liveliness_manager.assert_liveliness(GUID_t(guidP, 2), fastdds::dds::MANUAL_BY_PARTICIPANT_LIVELINESS_QOS, Duration_t(0.5));
    num_writers_recovered = 0u;
    ...
    // Assert first writer
    liveliness_manager.assert_liveliness(GUID_t(guidP, 1), fastdds::dds::MANUAL_BY_PARTICIPANT_LIVELINESS_QOS, Duration_t(0.1));
    wait_liveliness_recovered(2u);
    EXPECT_EQ(num_writers_recovered, 2u);
}
...
TEST_F(LivelinessManagerTests, TimerExpired_ManualByTopic)
{
    ...
    // Assert first writer
    liveliness_manager.assert_liveliness(GUID_t(guidP, 1), fastdds::dds::MANUAL_BY_TOPIC_LIVELINESS_QOS, Duration_t(0.1));
    ...
    liveliness_manager.assert_liveliness(GUID_t(guidP, 2), fastdds::dds::MANUAL_BY_TOPIC_LIVELINESS_QOS, Duration_t(0.2));
    wait_liveliness_recovered(2u);
    num_writers_lost = 0u;
...
TEST_F(LivelinessManagerTests, TimerOwnerCalculation)
{
    ...
    liveliness_manager.assert_liveliness(fastdds::dds::AUTOMATIC_LIVELINESS_QOS);
