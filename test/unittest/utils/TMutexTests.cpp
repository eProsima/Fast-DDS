...
TEST(TMutexTests, record_mutexes)
{
    ...
    ASSERT_TRUE(&mutex_1 == tmutex_get_mutex(0));
    ASSERT_TRUE(&mutex_2 == tmutex_get_mutex(1));
    ASSERT_TRUE(&mutex_3 == tmutex_get_mutex(2));
    ASSERT_TRUE(&mutex_4 == tmutex_get_mutex(3));
}
