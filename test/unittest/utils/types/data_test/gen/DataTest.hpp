...
/*!
 * @brief This class represents the structure PrimitivesStruct_TypeIntrospectionExample defined by the user in the IDL file.
 * @ingroup DataTest
 */
class PrimitivesStruct_TypeIntrospectionExample
{
public:
     ...
     */
    eProsima_user_DllExport PrimitivesStruct_TypeIntrospectionExample()
    {
    }
     ...
     * @param x Reference to the object PrimitivesStruct_TypeIntrospectionExample that will be copied.
     */
    eProsima_user_DllExport PrimitivesStruct_TypeIntrospectionExample(
            const PrimitivesStruct_TypeIntrospectionExample& x)
    {
     ...
     */
    eProsima_user_DllExport PrimitivesStruct_TypeIntrospectionExample(
            PrimitivesStruct_TypeIntrospectionExample&& x) noexcept
    {
        m_my_bool = x.m_my_bool;
        m_my_octet = x.m_my_octet;
        m_my_char = x.m_my_char;
     ...
     * @param x Reference to the object PrimitivesStruct_TypeIntrospectionExample that will be copied.
     */
    eProsima_user_DllExport PrimitivesStruct_TypeIntrospectionExample& operator =(
            const PrimitivesStruct_TypeIntrospectionExample& x)
    {
     ...
     * @param x PrimitivesStruct_TypeIntrospectionExample object to compare.
     */
    eProsima_user_DllExport bool operator ==(
            const PrimitivesStruct_TypeIntrospectionExample& x) const
    {
...
public:
    ...
    eProsima_user_DllExport void first(
            const PrimitivesStruct_TypeIntrospectionExample& _first)
    {
        first_() = _first;
        m__d = 0;
    }
     ...
     */
    eProsima_user_DllExport void first(
            PrimitivesStruct_TypeIntrospectionExample&& _first)
    {
        first_() = _first;
        m__d = 0;
    }
     ...
     */
    eProsima_user_DllExport const PrimitivesStruct_TypeIntrospectionExample& first() const
    {
        if (0x00000010 != selected_member_)
        {
     ...
     * @exception eprosima::fastcdr::exception::BadParamException This exception is thrown if the requested union member is not the current selection.
     */
    eProsima_user_DllExport PrimitivesStruct_TypeIntrospectionExample& first()
    {
        if (0x00000010 != selected_member_)
        {
            throw eprosima::fastcdr::exception::BadParamException("This member has not been selected");
...
private:
            ...
            PrimitivesStruct_TypeIntrospectionExample& first_()
            {
                if (0x00000010 != selected_member_)
                {
                    if (member_destructor_)
                    ...
                    member_destructor_ = [&]() {m_first.~PrimitivesStruct_TypeIntrospectionExample();};
                    new(&m_first) PrimitivesStruct_TypeIntrospectionExample();
    ;
                }
    ...
    union
    {
        PrimitivesStruct_TypeIntrospectionExample m_first;
        int64_t m_second;
    };
...
/*!
 * @brief This class represents the structure AllStruct_TypeIntrospectionExample defined by the user in the IDL file.
 * @ingroup DataTest
 */
class AllStruct_TypeIntrospectionExample : public PrimitivesStruct_TypeIntrospectionExample
{
public:
     ...
     * @brief Default constructor.
     */
    eProsima_user_DllExport AllStruct_TypeIntrospectionExample()
        : PrimitivesStruct_TypeIntrospectionExample()
    {
    }
    ...
    /*!
     * @brief Copy constructor.
     * @param x Reference to the object AllStruct_TypeIntrospectionExample that will be copied.
     */
    eProsima_user_DllExport AllStruct_TypeIntrospectionExample(
            const AllStruct_TypeIntrospectionExample& x)
        : PrimitivesStruct_TypeIntrospectionExample(x)
    {
     ...
     */
    eProsima_user_DllExport AllStruct_TypeIntrospectionExample(
            AllStruct_TypeIntrospectionExample&& x) noexcept
        : PrimitivesStruct_TypeIntrospectionExample(std::move(x))
     ...
     * @param x Reference to the object AllStruct_TypeIntrospectionExample that will be copied.
     */
    eProsima_user_DllExport AllStruct_TypeIntrospectionExample& operator =(
            const AllStruct_TypeIntrospectionExample& x)
    {
        PrimitivesStruct_TypeIntrospectionExample::operator =(x);
    ...
    eProsima_user_DllExport AllStruct_TypeIntrospectionExample& operator =(
            AllStruct_TypeIntrospectionExample&& x) noexcept
    {
        PrimitivesStruct_TypeIntrospectionExample::operator =(std::move(x));
    ...
    /*!
     * @brief Comparison operator.
     * @param x AllStruct_TypeIntrospectionExample object to compare.
     */
    eProsima_user_DllExport bool operator ==(
            const AllStruct_TypeIntrospectionExample& x) const
    {
        if (PrimitivesStruct_TypeIntrospectionExample::operator !=(x))
                {
                    return false;
                }
...
/*!
 * @brief This class represents the structure DataTest_TypeIntrospectionExample defined by the user in the IDL file.
 * @ingroup DataTest
 */
class DataTest_TypeIntrospectionExample
{
public:
     ...
     * @brief Default constructor.
     */
    eProsima_user_DllExport DataTest_TypeIntrospectionExample()
    {
    }
    ...
    /*!
     * @brief Copy constructor.
     * @param x Reference to the object DataTest_TypeIntrospectionExample that will be copied.
     */
    eProsima_user_DllExport DataTest_TypeIntrospectionExample(
            const DataTest_TypeIntrospectionExample& x)
    {
                    m_index = x.m_index;
     ...
     */
    eProsima_user_DllExport DataTest_TypeIntrospectionExample(
            DataTest_TypeIntrospectionExample&& x) noexcept
    {
        m_index = x.m_index;
     ...
     * @param x Reference to the object DataTest_TypeIntrospectionExample that will be copied.
     */
    eProsima_user_DllExport DataTest_TypeIntrospectionExample& operator =(
            const DataTest_TypeIntrospectionExample& x)
    {
    ...
    /*!
     * @brief Comparison operator.
     * @param x DataTest_TypeIntrospectionExample object to compare.
     */
    eProsima_user_DllExport bool operator ==(
            const DataTest_TypeIntrospectionExample& x) const
    {
    ...
    eProsima_user_DllExport void inner_struct(
            const AllStruct_TypeIntrospectionExample& _inner_struct)
    {
     ...
     */
    eProsima_user_DllExport void inner_struct(
            AllStruct_TypeIntrospectionExample&& _inner_struct)
    {
     ...
     */
    eProsima_user_DllExport const AllStruct_TypeIntrospectionExample& inner_struct() const
    {
     ...
     */
    eProsima_user_DllExport AllStruct_TypeIntrospectionExample& inner_struct()
    {
        return m_inner_struct;
    }
    ...
    eProsima_user_DllExport void complex_sequence(
            const std::vector<AllStruct_TypeIntrospectionExample>& _complex_sequence)
    {
     ...
     */
    eProsima_user_DllExport void complex_sequence(
            std::vector<AllStruct_TypeIntrospectionExample>&& _complex_sequence)
    {
     ...
     */
    eProsima_user_DllExport const std::vector<AllStruct_TypeIntrospectionExample>& complex_sequence() const
    {
     ...
     */
    eProsima_user_DllExport std::vector<AllStruct_TypeIntrospectionExample>& complex_sequence()
    {
        return m_complex_sequence;
    }
    ...
    eProsima_user_DllExport void complex_array(
            const std::array<AllStruct_TypeIntrospectionExample, 2>& _complex_array)
    {
     ...
     */
    eProsima_user_DllExport void complex_array(
            std::array<AllStruct_TypeIntrospectionExample, 2>&& _complex_array)
    {
     ...
     */
    eProsima_user_DllExport const std::array<AllStruct_TypeIntrospectionExample, 2>& complex_array() const
    {
     ...
     */
    eProsima_user_DllExport std::array<AllStruct_TypeIntrospectionExample, 2>& complex_array()
    {
        return m_complex_array;
    }
    ...
    eProsima_user_DllExport void complex_map(
            const std::map<int16_t, AllStruct_TypeIntrospectionExample>& _complex_map)
    {
     ...
     */
    eProsima_user_DllExport void complex_map(
            std::map<int16_t, AllStruct_TypeIntrospectionExample>&& _complex_map)
    {
     ...
     */
    eProsima_user_DllExport const std::map<int16_t, AllStruct_TypeIntrospectionExample>& complex_map() const
    {
     ...
     */
    eProsima_user_DllExport std::map<int16_t, AllStruct_TypeIntrospectionExample>& complex_map()
    {
        return m_complex_map;
    }
...
private:
    ...
    uint32_t m_index{0};
    AllStruct_TypeIntrospectionExample m_inner_struct;
    std::vector<AllStruct_TypeIntrospectionExample> m_complex_sequence;
    std::array<AllStruct_TypeIntrospectionExample, 2> m_complex_array;
    std::map<int16_t, AllStruct_TypeIntrospectionExample> m_complex_map;
