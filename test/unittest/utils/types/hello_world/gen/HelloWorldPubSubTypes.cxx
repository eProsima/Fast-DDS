...
HelloWorld_TypeIntrospectionExamplePubSubType::HelloWorld_TypeIntrospectionExamplePubSubType()
{
    ...
    uint32_t type_size =
        ...
        static_cast<uint32_t>(HelloWorld_TypeIntrospectionExample::getMaxCdrSerializedSize());
#else
        HelloWorld_TypeIntrospectionExample_max_cdr_typesize;
#endif
    type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    m_typeSize = type_size + 4; /*encapsulation*/
    m_isGetKeyDefined = false;
    uint32_t keyLength = HelloWorld_TypeIntrospectionExample_max_key_cdr_typesize > 16 ? HelloWorld_TypeIntrospectionExample_max_key_cdr_typesize : 16;
    ...
    return [data, data_representation]() -> uint32_t
           {
               ...
               try
               {
                   ...
                   return static_cast<uint32_t>(calculator.calculate_serialized_size(
                               *static_cast<HelloWorld_TypeIntrospectionExample*>(data), current_alignment)) +
                           4u /*encapsulation*/;
               }
               catch (eprosima::fastcdr::exception::Exception& /*exception*/)
               {
        ...
        bool force_md5)
{
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
            HelloWorld_TypeIntrospectionExample_max_key_cdr_typesize);
...
#endif // FASTCDR_VERSION_MAJOR == 1
    if (force_md5 || HelloWorld_TypeIntrospectionExample_max_key_cdr_typesize > 16)
    {
        m_md5.init();
#if FASTCDR_VERSION_MAJOR == 1
...
void HelloWorld_TypeIntrospectionExamplePubSubType::register_type_object_representation() const
{
