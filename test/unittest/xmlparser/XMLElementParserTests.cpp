...
TEST_F(XMLParserTests, getXMLDiscoverySettingsStaticEDP)
{
    ...
    const char* xml =
            ...
            <discovery_config>\
                <EDP>STATIC</EDP>\
                <static_edp_xml_content>file://my_static_edp.xml</static_edp_xml_content>\
            </discovery_config>\
            ";
    ...
    EXPECT_STREQ(settings.static_edp_xml_content(), "file://my_static_edp.xml");
}
