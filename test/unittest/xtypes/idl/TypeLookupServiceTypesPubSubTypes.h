...
public:
    ...
    eProsima_user_DllExport ~InheritanceStructPubSubType() override;
...
public:
    ...
    eProsima_user_DllExport ~AnotherBasicStructPubSubType() override;
...
public:
    ...
    eProsima_user_DllExport ~AnotherInheritanceStructPubSubType() override;
