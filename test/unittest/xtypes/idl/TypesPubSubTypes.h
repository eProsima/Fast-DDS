...
namespace detail {
    ...
    inline size_t constexpr MyEnumStruct_offset_of() {
...
private:
    ...
    {
        return 4ULL == (detail::MyEnumStruct_offset_of<MyEnumStruct, detail::MyEnumStruct_f>() + sizeof(MyEnum));
...
namespace detail {
    ...
    template <typename T, typename Tag>
    inline size_t constexpr MyBadEnumStruct_offset_of() {
        return ((::size_t) &reinterpret_cast<char const volatile&>((((T*)0)->*get(Tag()))));
    }
}
#endif
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 4ULL == (detail::MyBadEnumStruct_offset_of<MyBadEnumStruct, detail::MyBadEnumStruct_f>() + sizeof(MyBadEnum));
...
namespace detail {
    ...
    template <typename T, typename Tag>
    inline size_t constexpr MyAliasEnumStruct_offset_of() {
        return ((::size_t) &reinterpret_cast<char const volatile&>((((T*)0)->*get(Tag()))));
    }
}
#endif
...
private:
    ...
    static constexpr bool is_plain_impl()
    {
        return 4ULL == (detail::MyAliasEnumStruct_offset_of<MyAliasEnumStruct, detail::MyAliasEnumStruct_f>() + sizeof(MyAliasEnum));
