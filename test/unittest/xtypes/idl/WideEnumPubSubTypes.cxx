...
void MyEnumWideStructPubSubType::register_type_object_representation() const
{
...
void SimpleWideUnionStructPubSubType::register_type_object_representation() const
{
    register_WideEnum_type_objects();
}
