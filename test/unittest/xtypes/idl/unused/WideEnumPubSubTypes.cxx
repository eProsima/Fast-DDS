...
MyEnumWideStructPubSubType::MyEnumWideStructPubSubType()
{
    ...
    size_t keyLength = MyEnumWideStruct::getKeyMaxCdrSerializedSize() >
            16 ? MyEnumWideStruct::getKeyMaxCdrSerializedSize() : 16;
        ...
        bool force_md5)
{
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
            MyEnumWideStruct::getKeyMaxCdrSerializedSize());                                                                           // Object that manages the raw buffer.
...
SimpleWideUnionStructPubSubType::SimpleWideUnionStructPubSubType()
{
    ...
    size_t keyLength = SimpleWideUnionStruct::getKeyMaxCdrSerializedSize() >
            16 ? SimpleWideUnionStruct::getKeyMaxCdrSerializedSize() : 16;
    m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
    memset(m_keyBuffer, 0, keyLength);
}
        ...
        bool force_md5)
{
    ...
    SimpleWideUnionStruct* p_type = static_cast<SimpleWideUnionStruct*>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),
            SimpleWideUnionStruct::getKeyMaxCdrSerializedSize());                                                                           // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
