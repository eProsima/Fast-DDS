...
#endif // ifndef BOOST_CONFIG_HPP
#
#if defined(BOOST_HAS_PRAGMA_ONCE)
#  pragma once
#endif // if defined(BOOST_HAS_PRAGMA_ONCE)

#if defined(BOOST_INTERPROCESS_FORCE_NATIVE_EMULATION) && defined(BOOST_INTERPROCESS_FORCE_GENERIC_EMULATION)
#error \
    "BOOST_INTERPROCESS_FORCE_NATIVE_EMULATION && BOOST_INTERPROCESS_FORCE_GENERIC_EMULATION can't be defined at the same time"
#endif // if defined(BOOST_INTERPROCESS_FORCE_NATIVE_EMULATION) && defined(BOOST_INTERPROCESS_FORCE_GENERIC_EMULATION)
...
//////////////////////////////////////////////////////
   ...
   #endif // if !defined(__QNXNTO__) && !defined(__ANDROID__) && !defined(__HAIKU__) && !(__VXWORKS__)
...
//////////////////////////////////////////////////////
   ...
   #endif // if defined(_XOPEN_UNIX) && ((_XOPEN_VERSION + 0) >= 500)
...
//If buggy _POSIX_THREAD_PROCESS_SHARED is detected avoid using it
      ...
      #endif // if defined(BOOST_INTERPROCESS_BUGGY_POSIX_PROCESS_SHARED)
   #endif // if defined(_POSIX_THREAD_PROCESS_SHARED) && ((_POSIX_THREAD_PROCESS_SHARED + 0) > 0)
...
//////////////////////////////////////////////////////
   ...
   #endif // if (_XOPEN_SOURCE >= 700 || _POSIX_C_SOURCE >= 200809L)
...
//and temporary file based shm is possible in those executions.
      ...
      #endif // if defined(__hpux) || defined(__osf__) || defined(__vms) || (defined(__FreeBSD__) && (__FreeBSD__ < 7))
   #endif // if ( defined(_POSIX_SHARED_MEMORY_OBJECTS) && ((_POSIX_SHARED_MEMORY_OBJECTS + 0) > 0)) || (defined(__vms) && __CRTL_VER >= 70200000)
...
//////////////////////////////////////////////////////
   ...
   #endif // if defined(_POSIX_MAPPED_FILES) && ((_POSIX_MAPPED_FILES + 0) > 0)
...
//MacOsX declares _POSIX_SEMAPHORES but sem_init returns ENOSYS
      ...
      #endif // if defined(__osf__) || defined(__vms)
   #endif // if ( defined(_POSIX_SEMAPHORES) && ((_POSIX_SEMAPHORES + 0) > 0)) || ( defined(__FreeBSD__) && (__FreeBSD__ >= 4)) || defined(__APPLE__)
...
//////////////////////////////////////////////////////
   ...
   #endif // if defined(_POSIX_BARRIERS) && ((_POSIX_BARRIERS + 0) >= 200112L)
...
//////////////////////////////////////////////////////
   ...
   #endif // if defined(_POSIX_TIMEOUTS) && ((_POSIX_TIMEOUTS + 0L) >= 200112L)
...
//#define BOOST_INTERPROCESS_HAS_KERNEL_BOOTTIME
      #endif // if defined(CTL_KERN) && defined (KERN_BOOTTIME)
   #endif // if defined(__FreeBSD__) || defined(__NetBSD__) || defined(__OpenBSD__) || defined(__APPLE__)
...
//////////////////////////////////////////////////////
   ...
   #endif // if (defined (_V6_ILP32_OFFBIG)  && (_V6_ILP32_OFFBIG   - 0 > 0)) || (defined (_V6_LP64_OFF64)    && (_V6_LP64_OFF64     - 0 > 0)) || (defined (_V6_LPBIG_OFFBIG)  && (_V6_LPBIG_OFFBIG   - 0 > 0)) || (defined (_XBS5_ILP32_OFFBIG) && (_XBS5_ILP32_OFFBIG - 0 > 0)) || (defined (_XBS5_LP64_OFF64)  && (_XBS5_LP64_OFF64   - 0 > 0)) || (defined (_XBS5_LPBIG_OFFBIG) && (_XBS5_LPBIG_OFFBIG - 0 > 0)) || (defined (_FILE_OFFSET_BITS) && (_FILE_OFFSET_BITS  - 0 >= 64)) || (defined (_FILE_OFFSET_BITS) && (_FILE_OFFSET_BITS  - 0 >= 64))
...
#endif // if defined(BOOST_INTERPROCESS_WINDOWS) || defined(BOOST_INTERPROCESS_POSIX_MAPPED_FILES)
...
#endif // if defined(BOOST_INTERPROCESS_POSIX_NAMED_SEMAPHORES) && !defined(BOOST_INTERPROCESS_POSIX_SEMAPHORES_NO_UNLINK)
...
#endif // ifndef BOOST_INTERPROCESS_TIMEOUT_WHEN_LOCKING_DURATION_MS
...
#endif // ifndef BOOST_INTERPROCESS_MANAGED_OPEN_OR_CREATE_INITIALIZE_MAX_TRIES
...
#endif // ifndef BOOST_INTERPROCESS_MANAGED_OPEN_OR_CREATE_INITIALIZE_TIMEOUT_SEC
...
#else
   #define BOOST_INTERPROCESS_FORCEINLINE BOOST_FORCEINLINE
#endif // if defined(BOOST_INTERPROCESS_DISABLE_FORCEINLINE)
...
#  endif // if defined(_MSC_VER) || defined(__MWERKS__) || defined(__MINGW32__) ||  defined(__BORLANDC__)
#endif // if defined(BOOST_HAS_THREADS)
