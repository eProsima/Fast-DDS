...
Usage: Fast-Server-d -id {0-255} [optional parameters]
General options:
...
Examples:
      ...
      $ Fast-Server-d -i 1 -l 127.0.0.1 -p 14520
      ...
      $ Fast-Server-d -i 1 -l 192.168.36.34 -p 14520 -l 172.20.96.1 -p 51083
      ...
      $ Fast-Server-d -i 1 -l 172.30.144.1 -p 12345 -b
