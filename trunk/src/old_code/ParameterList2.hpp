...
inline void ParameterList2_t::get_QosMsg(CDRMessage_t** msg,Endianness_t endian)
{
...
inline void ParameterList2_t::get_inlineQosMsg(CDRMessage_t** msg,Endianness_t endian)
{
...
inline bool ParameterList2::addParameterLocator(ParameterList_t* plist,ParameterId_t pid, rtps::Locator_t* loc) {
...
inline bool ParameterList2::addParameterString(ParameterList_t* plist,ParameterId_t pid, std::string& in_str)
{
...
inline bool ParameterList2::addParameterPort(ParameterList_t* plist,ParameterId_t pid, uint32_t port) {
...
inline bool ParameterList2::updateQosMsg(ParameterList_t* plist,Endianness_t endian)
{
...
inline bool ParameterList2::updateInlineQosMsg(ParameterList_t* plist,Endianness_t endian)
{
