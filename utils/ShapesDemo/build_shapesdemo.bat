...
set QTDIR=C:\Qt\5.4\msvc2010_opengl
...
copy "%QTDIR%\bin\icudt53.dll" "files\bin\icudt53.dll"
copy "%QTDIR%\bin\icuin53.dll" "files\bin\icuin53.dll"
copy "%QTDIR%\bin\icuuc53.dll" "files\bin\icuuc53.dll"
