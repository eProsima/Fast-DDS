...
rm ./examples/cpp/rtps_entities/HelloWorld*.cxx
rm ./examples/cpp/rtps_entities/HelloWorld*.ipp
find ./examples/cpp/rtps_entities/ -name 'HelloWorld*.hpp' ! -name 'HelloWorld.hpp' -exec rm {} +
